...
const CONCEPT_BODY = L({
  ru: 'В прошлом занятии Es fácil значило «это легко». Чтобы возразить, испанский добавляет одно слово перед связкой: No es fácil — «это не легко». No встаёт прямо перед es и переворачивает смысл на противоположный, больше ничего в фразе не меняется. Испанское отрицание проще английского: одно слово на своём месте, никаких дополнительных глаголов-помощников.',
  uk: 'На минулому занятті Es fácil означало «це легко». Щоб заперечити, іспанська додає одне слово перед зв’язкою: No es fácil — «це не легко». No стає прямо перед es і перевертає сенс на протилежний, більше нічого у фразі не змінюється. Іспанське заперечення простіше за англійське: одне слово на своєму місці, жодних додаткових допоміжних дієслів.',
  es: 'In the previous session, Es fácil meant "it is easy". To disagree, Spanish adds one word before the linking word: No es fácil — "it is not easy". No goes right before es and flips the meaning to its opposite; nothing else in the phrase changes. Spanish negation is simpler than English: one word in its place, no extra helper verbs needed.',
  'pt-BR': 'Na sessão anterior, Es fácil significava "é fácil". Para discordar, o espanhol adiciona uma palavra antes da ligação: No es fácil — "não é fácil". No fica bem antes de es e vira o sentido para o oposto; mais nada na frase muda. A negação em espanhol é mais simples que em inglês: uma palavra no seu lugar, sem verbos auxiliares extras.',
  vi: 'Ở buổi học trước, Es fácil nghĩa là "điều này dễ". Để phản đối, tiếng Tây Ban Nha thêm một từ trước từ nối: No es fácil — "điều này không dễ". No đứng ngay trước es và đảo ngược ý nghĩa, không có gì khác trong câu thay đổi. Phủ định tiếng Tây Ban Nha đơn giản hơn tiếng Anh: một từ đúng chỗ, không cần động từ trợ giúp thêm.',
  id: 'Pada sesi sebelumnya, Es fácil berarti "ini mudah". Untuk tidak setuju, bahasa Spanyol menambahkan satu kata sebelum kata penghubung: No es fácil — "ini tidak mudah". No berada tepat sebelum es dan membalikkan makna menjadi kebalikannya; tidak ada yang lain dalam kalimat yang berubah. Penyangkalan bahasa Spanyol lebih sederhana daripada bahasa Inggris: satu kata pada tempatnya, tanpa kata kerja bantu tambahan.',
  tr: 'Önceki oturumda Es fácil "bu kolay" demekti. Karşı çıkmak için İspanyolca bağlayıcıdan önce bir kelime ekler: No es fácil — "bu kolay değil". No tam olarak es\'ten önce gelir ve anlamı tersine çevirir; cümlede başka hiçbir şey değişmez. İspanyolca olumsuzlama İngilizceden daha basittir: yerinde tek bir kelime, ekstra yardımcı fiil gerekmez.',
  pl: 'W poprzedniej sesji Es fácil znaczyło „to jest łatwe”. Żeby się nie zgodzić, hiszpański dodaje jedno słowo przed łącznikiem: No es fácil — „to nie jest łatwe”. No stoi tuż przed es i odwraca sens na przeciwny; nic więcej w zdaniu się nie zmienia. Hiszpańskie przeczenie jest prostsze niż angielskie: jedno słowo na swoim miejscu, bez dodatkowych czasowników posiłkowych.',
});

const FORMULA_BODY = L({
  ru: 'Формула проста: no + связка + признак. No всегда стоит первым, перед es, soy или другой формой ser — никогда после. No es verdad — «это неправда»: то же самое правило работает с любой уже знакомой фразой. Слово no не меняется никогда: ни по лицу, ни по роду, ни по числу — единственная неизменная форма во всей фразе.',
  uk: 'Формула проста: no + зв’язка + ознака. No завжди стоїть першим, перед es, soy чи іншою формою ser — ніколи після. No es verdad — «це неправда»: те саме правило працює з будь-якою вже знайомою фразою. Слово no не змінюється ніколи: ні за особою, ні за родом, ні за числом — єдина незмінна форма в усій фразі.',
  es: 'The formula is simple: no + linking word + quality. No always comes first, before es, soy, or another form of ser — never after. No es verdad — "that is not true": the same rule works with any phrase already known. The word no never changes: not for person, not for gender, not for number — the one invariable form in the whole phrase.',
  'pt-BR': 'A fórmula é simples: no + ligação + qualidade. No vem sempre primeiro, antes de es, soy ou outra forma de ser — nunca depois. No es verdad — "não é verdade": a mesma regra funciona com qualquer frase já conhecida. A palavra no nunca muda: nem por pessoa, nem por gênero, nem por número — a única forma invariável em toda a frase.',
  vi: 'Công thức đơn giản: no + từ nối + đặc điểm. No luôn đứng đầu tiên, trước es, soy hoặc dạng khác của ser — không bao giờ đứng sau. No es verdad — "điều đó không đúng": quy tắc tương tự áp dụng cho bất kỳ câu nào đã biết. Từ no không bao giờ đổi: không theo ngôi, không theo giống, không theo số — dạng bất biến duy nhất trong cả câu.',
  id: 'Rumusnya sederhana: no + kata penghubung + sifat. No selalu berada di depan, sebelum es, soy, atau bentuk ser lainnya — tidak pernah di belakang. No es verdad — "itu tidak benar": aturan yang sama berlaku untuk kalimat apa pun yang sudah dikenal. Kata no tidak pernah berubah: tidak menurut orang, tidak menurut gender, tidak menurut jumlah — satu-satunya bentuk yang tidak berubah dalam seluruh kalimat.',
  tr: 'Formül basittir: no + bağlayıcı + nitelik. No her zaman önce gelir, es, soy ya da başka bir ser biçiminden önce — asla sonra değil. No es verdad — "bu doğru değil": aynı kural zaten bilinen herhangi bir cümlede işler. No sözcüğü asla değişmez: ne kişiye, ne cinsiyete, ne sayıya göre — tüm cümledeki tek değişmez biçimdir.',
  pl: 'Formuła jest prosta: no + łącznik + cecha. No zawsze stoi pierwsze, przed es, soy lub inną formą ser — nigdy po. No es verdad — „to nieprawda”: ta sama zasada działa z każdym już znanym zdaniem. Słowo no nigdy się nie zmienia: ani przez osobę, ani przez rodzaj, ani przez liczbę — jedyna niezmienna forma w całym zdaniu.',
});
...
export const ES_EPISODE_01_SESSION_02_WORD_FIRST_INTRO: readonly [
...
] = [
  {
    ...
    body: CONCEPT_BODY,
    bodyRuns: {
      ru: R({ text: 'В прошлом занятии ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' значило «это легко». Чтобы возразить, испанский добавляет одно слово перед связкой: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — «это не легко». ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' встаёт прямо перед ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' и переворачивает смысл на противоположный, больше ничего в фразе не меняется. Испанское отрицание проще английского: одно слово на своём месте, никаких дополнительных глаголов-помощников.', semantic: 'explanation' }),
      uk: R({ text: 'На минулому занятті ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' означало «це легко». Щоб заперечити, іспанська додає одне слово перед зв’язкою: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — «це не легко». ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' стає прямо перед ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' і перевертає сенс на протилежний, більше нічого у фразі не змінюється. Іспанське заперечення простіше за англійське: одне слово на своєму місці, жодних додаткових допоміжних дієслів.', semantic: 'explanation' }),
      es: R({ text: 'In the previous session, ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' meant "it is easy". To disagree, Spanish adds one word before the linking word: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — "it is not easy". ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' goes right before ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' and flips the meaning to its opposite; nothing else in the phrase changes. Spanish negation is simpler than English: one word in its place, no extra helper verbs needed.', semantic: 'explanation' }),
      'pt-BR': R({ text: 'Na sessão anterior, ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' significava "é fácil". Para discordar, o espanhol adiciona uma palavra antes da ligação: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — "não é fácil". ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' fica bem antes de ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' e vira o sentido para o oposto; mais nada na frase muda. A negação em espanhol é mais simples que em inglês: uma palavra no seu lugar, sem verbos auxiliares extras.', semantic: 'explanation' }),
      vi: R({ text: 'Ở buổi học trước, ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' nghĩa là "điều này dễ". Để phản đối, tiếng Tây Ban Nha thêm một từ trước từ nối: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — "điều này không dễ". ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' đứng ngay trước ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' và đảo ngược ý nghĩa, không có gì khác trong câu thay đổi. Phủ định tiếng Tây Ban Nha đơn giản hơn tiếng Anh: một từ đúng chỗ, không cần động từ trợ giúp thêm.', semantic: 'explanation' }),
      id: R({ text: 'Pada sesi sebelumnya, ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' berarti "ini mudah". Untuk tidak setuju, bahasa Spanyol menambahkan satu kata sebelum kata penghubung: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — "ini tidak mudah". ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' berada tepat sebelum ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' dan membalikkan makna menjadi kebalikannya; tidak ada yang lain dalam kalimat yang berubah. Penyangkalan bahasa Spanyol lebih sederhana daripada bahasa Inggris: satu kata pada tempatnya, tanpa kata kerja bantu tambahan.', semantic: 'explanation' }),
      tr: R({ text: 'Önceki oturumda ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' "bu kolay" demekti. Karşı çıkmak için İspanyolca bağlayıcıdan önce bir kelime ekler: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — "bu kolay değil". ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' tam olarak ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: '\'ten önce gelir ve anlamı tersine çevirir; cümlede başka hiçbir şey değişmez. İspanyolca olumsuzlama İngilizceden daha basittir: yerinde tek bir kelime, ekstra yardımcı fiil gerekmez.', semantic: 'explanation' }),
      pl: R({ text: 'W poprzedniej sesji ', semantic: 'explanation' }, { text: 'Es fácil', semantic: 'targetCorrect' }, { text: ' znaczyło „to jest łatwe”. Żeby się nie zgodzić, hiszpański dodaje jedno słowo przed łącznikiem: ', semantic: 'explanation' }, { text: 'No es fácil', semantic: 'targetCorrect' }, { text: ' — „to nie jest łatwe”. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' stoi tuż przed ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ' i odwraca sens na przeciwny; nic więcej w zdaniu się nie zmienia. Hiszpańskie przeczenie jest prostsze niż angielskie: jedno słowo na swoim miejscu, bez dodatkowych czasowników posiłkowych.', semantic: 'explanation' }),
    },
    question: {
      prompt: L({
  ...
  },
  {
    ...
    body: FORMULA_BODY,
    bodyRuns: {
      ru: R({ text: 'Формула проста: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + связка + признак. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' всегда стоит первым, перед ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' или другой формой ser — никогда после. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — «это неправда»: то же самое правило работает с любой уже знакомой фразой. Слово ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' не меняется никогда: ни по лицу, ни по роду, ни по числу — единственная неизменная форма во всей фразе.', semantic: 'explanation' }),
      uk: R({ text: 'Формула проста: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + зв’язка + ознака. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' завжди стоїть першим, перед ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' чи іншою формою ser — ніколи після. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — «це неправда»: те саме правило працює з будь-якою вже знайомою фразою. Слово ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' не змінюється ніколи: ні за особою, ні за родом, ні за числом — єдина незмінна форма в усій фразі.', semantic: 'explanation' }),
      es: R({ text: 'The formula is simple: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + linking word + quality. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' always comes first, before ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ', or another form of ser — never after. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — "that is not true": the same rule works with any phrase already known. The word ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' never changes: not for person, not for gender, not for number — the one invariable form in the whole phrase.', semantic: 'explanation' }),
      'pt-BR': R({ text: 'A fórmula é simples: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + ligação + qualidade. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' vem sempre primeiro, antes de ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' ou outra forma de ser — nunca depois. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — "não é verdade": a mesma regra funciona com qualquer frase já conhecida. A palavra ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' nunca muda: nem por pessoa, nem por gênero, nem por número — a única forma invariável em toda a frase.', semantic: 'explanation' }),
      vi: R({ text: 'Công thức đơn giản: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + từ nối + đặc điểm. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' luôn đứng đầu tiên, trước ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' hoặc dạng khác của ser — không bao giờ đứng sau. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — "điều đó không đúng": quy tắc tương tự áp dụng cho bất kỳ câu nào đã biết. Từ ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' không bao giờ đổi: không theo ngôi, không theo giống, không theo số — dạng bất biến duy nhất trong cả câu.', semantic: 'explanation' }),
      id: R({ text: 'Rumusnya sederhana: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + kata penghubung + sifat. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' selalu berada di depan, sebelum ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ', atau bentuk ser lainnya — tidak pernah di belakang. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — "itu tidak benar": aturan yang sama berlaku untuk kalimat apa pun yang sudah dikenal. Kata ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' tidak pernah berubah: tidak menurut orang, tidak menurut gender, tidak menurut jumlah — satu-satunya bentuk yang tidak berubah dalam seluruh kalimat.', semantic: 'explanation' }),
      tr: R({ text: 'Formül basittir: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + bağlayıcı + nitelik. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' her zaman önce gelir, ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' ya da başka bir ser biçiminden önce — asla sonra değil. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — "bu doğru değil": aynı kural zaten bilinen herhangi bir cümlede işler. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' sözcüğü asla değişmez: ne kişiye, ne cinsiyete, ne sayıya göre — tüm cümledeki tek değişmez biçimdir.', semantic: 'explanation' }),
      pl: R({ text: 'Formuła jest prosta: ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' + łącznik + cecha. ', semantic: 'explanation' }, { text: 'No', semantic: 'targetCorrect' }, { text: ' zawsze stoi pierwsze, przed ', semantic: 'explanation' }, { text: 'es', semantic: 'targetCorrect' }, { text: ', ', semantic: 'explanation' }, { text: 'soy', semantic: 'targetCorrect' }, { text: ' lub inną formą ser — nigdy po. ', semantic: 'explanation' }, { text: 'No es verdad', semantic: 'targetCorrect' }, { text: ' — „to nieprawda”: ta sama zasada działa z każdym już znanym zdaniem. Słowo ', semantic: 'explanation' }, { text: 'no', semantic: 'targetCorrect' }, { text: ' nigdy się nie zmienia: ani przez osobę, ani przez rodzaj, ani przez liczbę — jedyna niezmienna forma w całym zdaniu.', semantic: 'explanation' }),
    },
    question: {
      prompt: L({
