...
const copyFor = (lang: Lang) => triLang(lang, {
  ru: { title: 'Работа над ошибками', back: 'Назад', ready: 'готовы', corrected: 'исправлено', map30: 'За 30 дней', mistakes: { one: "ошибка", few: "ошибки", many: "ошибок" }, sources: 'Откуда приходят', all: 'Все', start: 'Разобрать', startAll: 'Разобрать все', list: 'Мои ошибки', empty: 'Всё исправлено', emptyBody: 'Новые ошибки из уроков, арены и карточек появятся здесь сами.', shelf: 'Смотреть исправленные', noData: 'Ошибок пока нет' },
  uk: { title: 'Робота над помилками', back: 'Назад', ready: 'готові', corrected: 'виправлено', map30: 'За 30 днів', mistakes: { one: "помилка", few: "помилки", many: "помилок" }, sources: 'Звідки приходять', all: 'Усі', start: 'Розібрати', startAll: 'Розібрати всі', list: 'Мої помилки', empty: 'Усе виправлено', emptyBody: 'Нові помилки з уроків, арени та карток з’являться тут самі.', shelf: 'Дивитися виправлені', noData: 'Помилок поки немає' },
  en: { title: 'Mistake practice', back: 'Back', ready: 'ready', corrected: 'fixed', map30: 'Last 30 days', mistakes: { one: "mistake", few: "mistakes", many: "mistakes" }, sources: 'Where they come from', all: 'All', start: 'Practise', startAll: 'Practise all', list: 'My mistakes', empty: 'Everything is fixed', emptyBody: 'New mistakes from lessons, the arena and cards will show up here on their own.', shelf: 'See fixed mistakes', noData: 'No mistakes yet' },
  es: { title: 'Trabajo con errores', back: 'Atrás', ready: 'listos', corrected: 'corregidos', map30: 'Últimos 30 días', mistakes: { one: "error", few: "errores", many: "errores" }, sources: 'De dónde vienen', all: 'Todos', start: 'Practicar', startAll: 'Practicar todos', list: 'Mis errores', empty: 'Todo corregido', emptyBody: 'Los nuevos errores de lecciones, arena y tarjetas aparecerán aquí solos.', shelf: 'Ver corregidos', noData: 'Aún no hay errores' },
  'pt-BR': { title: 'Trabalho com erros', back: 'Voltar', ready: 'prontos', corrected: 'corrigidos', map30: 'Últimos 30 dias', mistakes: { one: "erro", few: "erros", many: "erros" }, sources: 'De onde vêm', all: 'Todos', start: 'Praticar', startAll: 'Praticar todos', list: 'Meus erros', empty: 'Tudo corrigido', emptyBody: 'Novos erros de lições, arena e cartões vão aparecer aqui sozinhos.', shelf: 'Ver corrigidos', noData: 'Ainda não há erros' },
  vi: { title: 'Luyện lỗi sai', back: 'Quay lại', ready: 'sẵn sàng', corrected: 'đã sửa', map30: '30 ngày qua', mistakes: { one: "lỗi", few: "lỗi", many: "lỗi" }, sources: 'Lỗi đến từ đâu', all: 'Tất cả', start: 'Luyện', startAll: 'Luyện tất cả', list: 'Lỗi của tôi', empty: 'Đã sửa hết', emptyBody: 'Lỗi mới từ bài học, đấu trường và thẻ sẽ tự xuất hiện ở đây.', shelf: 'Xem lỗi đã sửa', noData: 'Chưa có lỗi nào' },
  id: { title: 'Latihan kesalahan', back: 'Kembali', ready: 'siap', corrected: 'diperbaiki', map30: '30 hari terakhir', mistakes: { one: "kesalahan", few: "kesalahan", many: "kesalahan" }, sources: 'Asal kesalahan', all: 'Semua', start: 'Latih', startAll: 'Latih semua', list: 'Kesalahanku', empty: 'Semua sudah diperbaiki', emptyBody: 'Kesalahan baru dari pelajaran, arena, dan kartu akan muncul di sini.', shelf: 'Lihat yang diperbaiki', noData: 'Belum ada kesalahan' },
  tr: { title: 'Hata çalışması', back: 'Geri', ready: 'hazır', corrected: 'düzeltildi', map30: 'Son 30 gün', mistakes: { one: "hata", few: "hata", many: "hata" }, sources: 'Nereden geliyor', all: 'Tümü', start: 'Çalış', startAll: 'Tümünü çalış', list: 'Hatalarım', empty: 'Hepsi düzeltildi', emptyBody: 'Ders, arena ve kartlardan gelen yeni hatalar burada kendiliğinden görünür.', shelf: 'Düzeltilenleri gör', noData: 'Henüz hata yok' },
  pl: { title: 'Praca nad błędami', back: 'Wstecz', ready: 'gotowe', corrected: 'poprawione', map30: 'Ostatnie 30 dni', mistakes: { one: "błąd", few: "błędy", many: "błędów" }, sources: 'Skąd pochodzą', all: 'Wszystkie', start: 'Przećwicz', startAll: 'Przećwicz wszystkie', list: 'Moje błędy', empty: 'Wszystko poprawione', emptyBody: 'Nowe błędy z lekcji, areny i fiszek pojawią się tu same.', shelf: 'Zobacz poprawione', noData: 'Nie ma jeszcze błędów' },
});
            ...
            <>
              ...
              <View style={[styles.card, { backgroundColor: t.bgCard }]}>
                <Text style={[styles.cardTitle, { color: t.textPrimary, fontSize: f.bodyLg }]}>
                  {loaded ? `${copy.map30} · ${facetTotal} ${pluralWord(lang, facetTotal, copy.mistakes)}` : copy.map30}
                </Text>
