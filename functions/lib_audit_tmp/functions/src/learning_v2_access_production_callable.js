...
exports.finalizeLearningV2AccessPurchase = (0, https_1.onCall)({ enforceAppCheck: true }, async (request) => {
    ...
    const binding = await (0, progress_event_callable_1.readProgressAccountBinding)(db, request.auth.uid);
    (0, learning_v2_access_callable_1.assertV2AccessStableIdentity)(input, binding);
