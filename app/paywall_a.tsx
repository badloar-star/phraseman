...
export function PaywallAView({ entry }: { readonly entry: PaywallEntry }) {
...
export default function PaywallARoute() {
  return <DirectPaywallRoute render={(entry) => <PaywallAView entry={entry} />} />;
}
