...
export const EPISODE_01_SESSION_03_SOURCE = {
  ...
  introPages: [
    ...
    },
    {
      ...
      body: {
        ru: 'На такой вопрос не отвечают целой фразой. Говорят коротко: Yes, I am или No, I am not — связку повторяют, а признак нет. Просто «Yes» звучит суховато, поэтому носители почти всегда добавляют «I am». А чтобы разговор не оборвался, сразу возвращают вопрос собеседнику двумя словами: And you? Это и есть самый простой способ поддержать беседу.',
