(function (global) {
  ...
  const TESTS = deepFreeze({
    en: { bcp47: 'en-US', bankUrl: './data/questions.en.json?v=20260801-2', nativeLabel: 'English', filenameSlug: 'english', filenameSlugs: { ru: 'angliyskiy-yazyk', en: 'english' }, certificateNames: { ru: 'английского языка', en: 'English' }, resultNames: { ru: 'английского языка', en: 'English' }, names: { ru: { nominative: 'английский язык', genitive: 'английского языка', subject: 'английскому языку' }, en: { nominative: 'English', genitive: 'English', subject: 'English' } } },
    de: { bcp47: 'de-DE', bankUrl: './data/questions.de.json?v=20260801-2', nativeLabel: 'Deutsch', filenameSlug: 'german', filenameSlugs: { ru: 'nemetskiy-yazyk', en: 'german' }, certificateNames: { ru: 'немецкого языка', en: 'German' }, resultNames: { ru: 'немецкого языка', en: 'German' }, names: { ru: { nominative: 'немецкий язык', genitive: 'немецкого языка', subject: 'немецкому языку' }, en: { nominative: 'German', genitive: 'German', subject: 'German' } } },
    fr: { bcp47: 'fr-FR', bankUrl: './data/questions.fr.json?v=20260801-2', nativeLabel: 'Français', filenameSlug: 'french', filenameSlugs: { ru: 'frantsuzskiy-yazyk', en: 'french' }, certificateNames: { ru: 'французского языка', en: 'French' }, resultNames: { ru: 'французского языка', en: 'French' }, names: { ru: { nominative: 'французский язык', genitive: 'французского языка', subject: 'французскому языку' }, en: { nominative: 'French', genitive: 'French', subject: 'French' } } },
    it: { bcp47: 'it-IT', bankUrl: './data/questions.it.json?v=20260801-2', nativeLabel: 'Italiano', filenameSlug: 'italian', filenameSlugs: { ru: 'italyanskiy-yazyk', en: 'italian' }, certificateNames: { ru: 'итальянского языка', en: 'Italian' }, resultNames: { ru: 'итальянского языка', en: 'Italian' }, names: { ru: { nominative: 'итальянский язык', genitive: 'итальянского языка', subject: 'итальянскому языку' }, en: { nominative: 'Italian', genitive: 'Italian', subject: 'Italian' } } },
    es: { bcp47: 'es-ES', bankUrl: './data/questions.es.json?v=20260801-2', nativeLabel: 'Español', filenameSlug: 'spanish', filenameSlugs: { ru: 'ispanskiy-yazyk', en: 'spanish' }, certificateNames: { ru: 'испанского языка', en: 'Spanish' }, resultNames: { ru: 'испанского языка', en: 'Spanish' }, names: { ru: { nominative: 'испанский язык', genitive: 'испанского языка', subject: 'испанскому языку' }, en: { nominative: 'Spanish', genitive: 'Spanish', subject: 'Spanish' } } },
  });
