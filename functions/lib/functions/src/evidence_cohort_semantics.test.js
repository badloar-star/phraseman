...
const evidence_cohort_semantics_1 = require("./evidence_cohort_semantics");
describe('evidence cohort semantics', () => {
    ...
    it('separates exact-day from rolling retention and excludes immature cohorts', () => {
        const result = (0, evidence_cohort_semantics_1.summarizeFirstTouchCohorts)([
            {
    ...
    it('keeps activation milestones ordered within the first-touch cohort', () => {
        const result = (0, evidence_cohort_semantics_1.summarizeActivationCohort)([
    ...
    it('skips early invalid events and selects the first later event after each milestone', () => {
        ...
        const result = (0, evidence_cohort_semantics_1.resolveOrderedActivationMilestones)({
            firstTouchMs: 0,
...
//# sourceMappingURL=evidence_cohort_semantics.test.js.map