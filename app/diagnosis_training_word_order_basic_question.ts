...
export const WORD_ORDER_BASIC_QUESTION_TRAINING: DiagnosisTraining = {
  ...
  examples: [
    { en: 'Do you work here?', ru: 'Ты здесь работаешь?', uk: 'Ти тут працюєш?', es: 'Do you work here?', why: tri('Work - обычное действие. С you вопрос начинается с do.', 'Work - звичайна дія. З you питання починається з do.', 'Normal action with you uses do.') },
    { en: 'Does she speak English?', ru: 'Она говорит по-английски?', uk: 'Вона говорить англійською?', es: 'Does she speak English?', why: tri('Does уже показывает he/she/it, поэтому speak остается без -s.', 'Does уже показує he/she/it, тому speak лишається без -s.', 'Does carries the third-person signal, so speak has no -s.') },
    { en: 'Did you call him?', ru: 'Ты позвонил ему?', uk: 'Ти подзвонив йому?', es: 'Did you call him?', why: tri('Did показывает прошлое, поэтому call не превращается в called.', 'Did показує минуле, тому call не перетворюється на called.', 'Did carries the past signal, so call stays simple.') },
    { en: 'Are you ready?', ru: 'Ты готов?', uk: 'Ти готовий?', es: 'Are you ready?', why: tri('Ready работает с are. Do здесь не нужен.', 'Ready працює з are. Do тут не потрібне.', 'Ready uses are here.') },
    { en: 'Is he at home?', ru: 'Он дома?', uk: 'Він удома?', es: 'Is he at home?', why: tri('At home описывает место/состояние, поэтому вопрос начинается с is.', 'At home описує місце/стан, тому питання починається з is.', 'At home uses is here.') },
    { en: 'Can you help me?', ru: 'Ты можешь мне помочь?', uk: 'Ти можеш мені допомогти?', es: 'Can you help me?', why: tri('Can само выходит вперед. Do добавлять не надо.', 'Can саме виходить уперед. Do додавати не треба.', 'Can moves forward by itself.') },
    { en: 'Where do you live?', ru: 'Где ты живешь?', uk: 'Де ти живеш?', es: 'Where do you live?', why: tri('Where стоит первым, но внутри вопроса все равно нужен do.', 'Where стоїть першим, але всередині питання все одно потрібне do.', 'Where goes first, but do is still needed.') },
    { en: 'What did you buy?', ru: 'Что ты купил?', uk: 'Що ти купив?', es: 'What did you buy?', why: tri('What ставим вперед. Did показывает прошлое. Buy остается простым.', 'What ставимо вперед. Did показує минуле. Buy лишається простим.', 'What goes first. Did carries the past signal.') },
  ],
  introBlocks: [
    {
      id: 'intro_problem',
