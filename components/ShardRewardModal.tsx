...
const TEXTS = {
  ru: {
    ...
    body: 'Твой репорт проверили и баг починили. Это настоящая работа — монета заслужена.',
    bodySuggestion: 'Команда начислила тебе монету. Твоя помощь делает Phraseman лучше — спасибо.',
    bodyAdmin: 'Команда начислила тебе монету — это наш способ сказать спасибо.',
  ...
  uk: {
    ...
    bodySuggestion: 'Команда нарахувала тобі монету. Дякуємо, що допомагаєш Phraseman ставати кращим.',
    bodyAdmin: 'Команда нарахувала тобі монету. Невеликий жест великої вдячності.',
  ...
  es: {
    kicker: 'RECOMPENSA',
    title: 'Tus monedas',
    subtitle: (n: number) => (n > 1 ? `+${n} monedas de conocimiento` : '+1 fragmento de conocimiento'),
    body: 'Confirmaron tu informe y ya corrigieron el fallo. Mereces el botín del detective.',
    bodySuggestion: 'El equipo te abonó monedas. Gracias por ayudar a mejorar Phraseman.',
    bodyAdmin: 'El equipo te abonó monedas. Gracias por quedarte con nosotros.',
  ...
  'pt-BR': {
    kicker: 'RECOMPENSA',
    title: 'Monedas recebidos',
    subtitle: (n: number) => (n > 1 ? `+${n} monedas de conhecimento` : '+1 fragmento de conhecimento'),
    body: 'Seu relatório foi verificado e o bug foi corrigido. Recompensa merecida por uma investigação de verdade.',
    bodySuggestion: 'A equipe creditou monedas para você. Obrigado por ajudar o Phraseman a melhorar.',
    bodyAdmin: 'A equipe creditou monedas para você. É nosso jeito de agradecer pelo seu apoio.',
    label: 'Pela correção:',
