...
describe('monthly decision pack Firestore aggregate projection', () => {
    test('exports only aggregate counts for both scopes', () => {
        const projection = (0, monthly_decision_pack_firestore_sources_1.buildOperationalAggregateProjection)(counts('reporting_month'), counts('baseline_12m'), 2000, 1999);
    ...
    test('marks a source partial instead of converting a failed query to zero', () => {
        ...
        const projection = (0, monthly_decision_pack_firestore_sources_1.buildOperationalAggregateProjection)(month, counts('baseline_12m'), 2000, 1999);
...
//# sourceMappingURL=monthly_decision_pack_firestore_sources.test.js.map