...
const SECTION_META: Record<string, { chapter: AdminChapterId; keywords: string }> = {
  ...
  labs_hub: { chapter: 'labs', keywords: 'лаборатории speaking referral интро celebration anim delivery повтор review compass итог дня day closing custom seed очередь стек модалки swipe preview' },
  compass: { chapter: 'system', keywords: 'компас compass брифинг день briefing итог дня day closing custom seed ии голос обновление дней сброс маркер показ' },
