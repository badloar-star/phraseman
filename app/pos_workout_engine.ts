...
const METHOD_INSTRUCTIONS: Record<PosDrillMethod, PosWorkoutLocaleCopy> = {
  form_agreement: {
    ...
    en: 'Choose the form that matches the subject, tense, and meaning.',
  ...
  missing_slot: {
    ...
    en: 'Insert the missing word into the exact spot in the phrase.',
  ...
  semantic_anchor: {
    ...
    en: 'First anchor the meaning to the translation, then pick the word.',
  ...
  connector_bridge: {
    ...
    en: 'Work out how the two parts of the phrase connect in meaning.',
  ...
  rule_contrast: {
    ...
    en: 'Compare the options: either the rule or the meaning of the action changes here.',
...
const CATEGORY_FOCUS_CHIPS: Record<Exclude<WordCategory, 'other'>, PosWorkoutLocaleChips> = {
  syntax: {
    ...
    en: ['word order', 'person + thing', 'it to me'],
  ...
  adjective: {
    ...
    en: ['quality', 'comparison', 'description'],
  ...
  modifier: {
    ...
    en: ['too/enough', 'very/really', 'quite'],
  ...
  article: {
    ...
    en: ['new/known', 'one/general', 'a/an/the'],
  ...
  determiner: {
    ...
    en: ['some/any', 'no/not any', 'quantity'],
  ...
  existential: {
    ...
    en: ['there is/are', 'singular/plural', 'existence'],
  ...
  modal: {
    ...
    en: ['possibility', 'obligation', 'advice'],
...
const PROFILES: Record<Exclude<WordCategory, 'other'>, PosWorkoutProfile> = {
  syntax: {
    ...
    accent: '#7C3AED',
    title: { ru: 'Syntax', uk: 'Syntax', en: 'Syntax', es: 'Sintaxis', 'pt-BR': "Sintaxe", vi: "Cú pháp", id: "Sintaksis", tr: "Sözdizimi", pl: "Składnia" },
    drillLabel: { ru: 'word order', uk: 'word order', en: 'word order', es: 'orden de palabras', 'pt-BR': "ordem das palavras", vi: "trật tự từ", id: "urutan kata", tr: "kelime sırası", pl: "szyk słów" },
    coachLine: {
      ...
      en: 'Find the two objects: person and thing. Then choose person + thing or thing + to/for + person.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to object order after verbs like give, send, show, tell, buy, or make.',
    ...
    nextStep: {
      ...
      en: 'We will contrast give me the book, give it to me, send it to her, and buy it for me.',
  ...
  verb: {
    ...
    icon: 'flash-outline',
    accent: '#F97316',
    title: { ru: 'Глаголы', uk: 'Дієслова', en: 'Verbs', es: 'Verbos', 'pt-BR': "Verbos", vi: "Động từ", id: "Kata kerja", tr: "Fiiller", pl: "Czasowniki" },
    drillLabel: { ru: 'форма и время', uk: 'форма і час', en: 'form and tense', es: 'forma y tiempo', 'pt-BR': "forma e tempo", vi: "dạng và thì", id: "bentuk dan tense", tr: "biçim ve zaman", pl: "forma i czas" },
    coachLine: {
      ru: 'Тренируем формы глагола в контексте фразы.',
      uk: 'Тренуємо форми дієслова в контексті фрази.',
      en: 'We practice verb forms in the context of the phrase.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake looks like a mix-up of verb form or tense.',
    ...
    nextStep: {
      ...
      en: 'The next pool will give more contrast between similar forms.',
  ...
  noun: {
    ...
    icon: 'cube-outline',
    accent: '#22C55E',
    title: { ru: 'Существительные', uk: 'Іменники', en: 'Nouns', es: 'Sustantivos', 'pt-BR': "Substantivos", vi: "Danh từ", id: "Kata benda", tr: "İsimler", pl: "Rzeczowniki" },
    drillLabel: { ru: 'предмет и число', uk: 'предмет і число', en: 'thing and number', es: 'objeto y número', 'pt-BR': "objeto e número", vi: "đồ vật và số", id: "objek dan jumlah", tr: "nesne ve sayı", pl: "przedmiot i liczba" },
    coachLine: {
      ru: 'Привяжи слово к объекту, человеку, месту или времени.',
      uk: 'Прив\'яжи слово до об\'єкта, людини, місця або часу.',
      en: 'Link the word to an object, a person, a place, or a time.',
    ...
    mistakeWhy: {
      ...
      en: 'What matters here is the exact link between the word and the object or amount.',
    ...
    nextStep: {
      ...
      en: 'Next the trainer will mix close nouns together to rule out guessing.',
  ...
  pronoun: {
    ...
    icon: 'person-outline',
    accent: '#38BDF8',
    title: { ru: 'Местоимения', uk: 'Займенники', en: 'Pronouns', es: 'Pronombres', 'pt-BR': "Pronomes", vi: "Đại từ", id: "Kata ganti", tr: "Zamirler", pl: "Zaimki" },
    drillLabel: { ru: 'кто кому принадлежит', uk: 'хто кому належить', en: 'who owns what', es: 'quién y de quién', 'pt-BR': "quem e de quem", vi: "ai và của ai", id: "siapa dan milik siapa", tr: "kim ve kimin", pl: "kto i czyje" },
    coachLine: {
      ru: 'Проверь лицо: кто делает действие и кому принадлежит объект.',
      uk: 'Перевір особу: хто робить дію й кому належить об\'єкт.',
      en: 'Check the person: who is doing the action and who owns the object.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to a mix-up of person, object, or possession.',
    ...
    nextStep: {
      ...
      en: 'The pool will give short pairs like my/me/mine, he/him/his, and similar contrasts.',
  ...
  adjective: {
    ...
    accent: '#EC4899',
    title: { ru: 'Прилагательные', uk: 'Прикметники', en: 'Adjectives', es: 'Adjetivos', 'pt-BR': "Adjetivos", vi: "Tính từ", id: "Kata sifat", tr: "Sıfatlar", pl: "Przymiotniki" },
    drillLabel: { ru: 'качество и сравнение', uk: 'якість і порівняння', en: 'quality and comparison', es: 'cualidad y comparación', 'pt-BR': "qualidade e comparação", vi: "phẩm chất và so sánh", id: "kualitas dan perbandingan", tr: "nitelik ve karşılaştırma", pl: "cecha i porównanie" },
    coachLine: {
      ru: 'Спроси: какое это? Если есть сравнение, ищи степень.',
      uk: 'Запитай: яке це? Якщо є порівняння, шукай ступінь.',
      en: 'Ask: what is it like? If there is a comparison, look for the degree.',
    ...
    mistakeWhy: {
      ...
      en: 'This looks like an error in quality, description, or degree of comparison.',
    ...
    nextStep: {
      ...
      en: 'Next comes more contrast between adjective/adverb and comparative forms.',
  ...
  adverb: {
    ...
    accent: '#A3E635',
    title: { ru: 'Наречия', uk: 'Прислівники', en: 'Adverbs', es: 'Adverbios', 'pt-BR': "Advérbios", vi: "Trạng từ", id: "Kata keterangan", tr: "Zarflar", pl: "Przysłówki" },
    drillLabel: { ru: 'как, где, когда', uk: 'як, де, коли', en: 'how, where, when', es: 'cómo, dónde, cuándo', 'pt-BR': "como, onde, quando", vi: "như thế nào, ở đâu, khi nào", id: "bagaimana, di mana, kapan", tr: "nasıl, nerede, ne zaman", pl: "jak, gdzie, kiedy" },
    coachLine: {
      ru: 'Найди, что слово уточняет: действие, место, время или частоту.',
      uk: 'Знайди, що слово уточнює: дію, місце, час або частоту.',
      en: 'Find what the word describes: the action, place, time, or frequency.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake looks like a missing detail: how, where, when, or how often.',
    ...
    nextStep: {
      ...
      en: 'The next pool will lock in adverb position in short phrases.',
  ...
  modifier: {
    ...
    accent: '#F59E0B',
    title: { ru: 'Modifiers', uk: 'Modifiers', en: 'Modifiers', es: 'Modificadores', 'pt-BR': "Modificadores", vi: "Từ bổ nghĩa", id: "Modifier", tr: "Niteleyiciler", pl: "Modyfikatory" },
    drillLabel: { ru: 'degree modifiers', uk: 'degree modifiers', en: 'degree modifiers', es: 'modificadores de grado', 'pt-BR': "modificadores de grau", vi: "từ chỉ mức độ", id: "modifier derajat", tr: "derece belirteçleri", pl: "modyfikatory stopnia" },
    coachLine: {
      ...
      en: 'Check meaning first: too is excess, enough is sufficient, very is neutral strength, really is emotional, quite is softer.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to degree modifier meaning or position before an adjective/adverb.',
    ...
    nextStep: {
      ...
      en: 'We will contrast too hot, good enough, very useful, really tired, and quite difficult.',
  ...
  preposition: {
    ...
    accent: '#14B8A6',
    title: { ru: 'Предлоги', uk: 'Прийменники', en: 'Prepositions', es: 'Preposiciones', 'pt-BR': "Preposições", vi: "Giới từ", id: "Preposisi", tr: "Edatlar", pl: "Przyimki" },
    drillLabel: { ru: 'связь и направление', uk: 'зв\'язок і напрям', en: 'link and direction', es: 'relación y dirección', 'pt-BR': "relação e direção", vi: "quan hệ và hướng", id: "relasi dan arah", tr: "ilişki ve yön", pl: "relacja i kierunek" },
    coachLine: {
      ...
      en: 'The preposition shows a link: place, direction, time, or cause.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to the link between words, not to the word itself.',
    ...
    nextStep: {
      ...
      en: 'Next come pairs like in/on/at, to/for/from, and short slot drills.',
  ...
  article: {
    ...
    icon: 'text-outline',
    accent: '#FACC15',
    title: { ru: 'Артикли', uk: 'Артиклі', en: 'Articles', es: 'Artículos', 'pt-BR': "Artigos", vi: "Mạo từ", id: "Artikel", tr: "Artikeller", pl: "Przedimki" },
    drillLabel: { ru: 'a, an, the или ноль', uk: 'a, an, the або нуль', en: 'a, an, the, or zero', es: 'a, an, the o cero', 'pt-BR': "a, an, the ou zero", vi: "a, an, the hoặc zero", id: "a, an, the atau nol", tr: "a, an, the ya da sıfır", pl: "a, an, the albo zero" },
    coachLine: {
      ru: 'Проверь: предмет новый или уже известный, один или общий.',
      uk: 'Перевір: предмет новий чи вже відомий, один чи загальний.',
      en: 'Check: is the thing new or already known, one specific item or general.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake is specifically in choosing definiteness: a/an, the, or no article.',
    ...
    nextStep: {
      ...
      en: 'The next pool will build micro-phrases around a single noun.',
  ...
  determiner: {
    ...
    icon: 'options-outline',
    accent: '#14B8A6',
    title: { ru: 'Determiners', uk: 'Determiners', en: 'Determiners', es: 'Determinantes', 'pt-BR': "Determinantes", vi: "Từ hạn định", id: "Determiner", tr: "Belirleyiciler", pl: "Określniki" },
    drillLabel: { ru: 'some, any, no', uk: 'some, any, no', en: 'some, any, no', es: 'some, any, no', 'pt-BR': "some, any, no", vi: "some, any, no", id: "some, any, no", tr: "some, any, no", pl: "some, any, no" },
    coachLine: {
      ...
      en: 'Check the sentence type: positive, negative, neutral question, offer, request, or free choice.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to quantity logic: some for positive amount, any for negative/question, some for offers and requests.',
    ...
    nextStep: {
      ...
      en: 'Next we contrast some/any/no in short slots and mixed review.',
  ...
  existential: {
    ...
    icon: 'albums-outline',
    accent: '#0EA5E9',
    title: { ru: 'There is / There are', uk: 'There is / There are', en: 'There is / There are', es: 'There is / There are', 'pt-BR': "There is / There are", vi: "There is / There are", id: "There is / There are", tr: "There is / There are", pl: "There is / There are" },
    drillLabel: { ru: 'existence and number', uk: 'existence and number', en: 'existence and number', es: 'existencia y numero', 'pt-BR': "existência e número", vi: "sự tồn tại và số", id: "keberadaan dan jumlah", tr: "varlık ve sayı", pl: "istnienie i liczba" },
    coachLine: {
      ru: 'Look after there: one/uncountable uses is, plural uses are.',
      uk: 'Look after there: one/uncountable uses is, plural uses are.',
      en: 'Look after there: one/uncountable uses is, plural uses are.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points to existence grammar: there is for one or uncountable, there are for plural.',
    ...
    nextStep: {
      ...
      en: 'We will contrast there is, there are, questions, negatives, and uncountable nouns.',
  ...
  'to-be': {
    ...
    accent: '#818CF8',
    title: { ru: 'Глагол to be', uk: 'Дієслово to be', en: 'The verb to be', es: 'Verbo to be', 'pt-BR': "Verbo to be", vi: "Động từ to be", id: "Kata kerja to be", tr: "to be fiili", pl: "Czasownik to be" },
    drillLabel: { ru: 'am, is, are, was, were', uk: 'am, is, are, was, were', en: 'am, is, are, was, were', es: 'am, is, are, was, were', 'pt-BR': "am, is, are, was, were", vi: "am, is, are, was, were", id: "am, is, are, was, were", tr: "am, is, are, was, were", pl: "am, is, are, was, were" },
    coachLine: {
      ru: 'Сначала выбери подлежащее и время, потом форму to be.',
      uk: 'Спочатку обери підмет і час, потім форму to be.',
      en: 'First pick the subject and the tense, then the form of to be.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake looks like mixing up person or tense in to be.',
    ...
    nextStep: {
      ...
      en: 'Next the trainer will give quick pairs like I am, he is, they are, was/were.',
  ...
  conjunction: {
    ...
    icon: 'link-outline',
    accent: '#06B6D4',
    title: { ru: 'Союзы', uk: 'Сполучники', en: 'Conjunctions', es: 'Conjunciones', 'pt-BR': "Conjunções", vi: "Liên từ", id: "Konjungsi", tr: "Bağlaçlar", pl: "Spójniki" },
    drillLabel: { ru: 'связь частей фразы', uk: 'зв\'язок частин фрази', en: 'linking parts of a phrase', es: 'conectar ideas', 'pt-BR': "conectar ideias", vi: "nối ý", id: "menghubungkan ide", tr: "fikirleri bağlama", pl: "łączenie myśli" },
    coachLine: {
      ru: 'Союз объясняет, как две части фразы связаны по смыслу.',
      uk: 'Сполучник пояснює, як дві частини фрази пов\'язані за змістом.',
      en: 'The conjunction explains how the two parts of the phrase are linked in meaning.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake looks like a wrong link: reason, contrast, condition, or addition.',
    ...
    nextStep: {
      ...
      en: 'The pool will give short connectors like and/but/because/if in a mini context.',
  ...
  modal: {
    ...
    icon: 'options-outline',
    accent: '#C084FC',
    title: { ru: 'Модальные глаголы', uk: 'Модальні дієслова', en: 'Modal verbs', es: 'Verbos modales', 'pt-BR': "Verbos modais", vi: "Động từ modal", id: "Kata kerja modal", tr: "Modal fiiller", pl: "Czasowniki modalne" },
    drillLabel: { ru: 'можно, нужно, стоит', uk: 'можна, треба, варто', en: 'possibility, obligation, advice', es: 'posibilidad y obligación', 'pt-BR': "possibilidade e obrigação", vi: "khả năng và nghĩa vụ", id: "kemungkinan dan kewajiban", tr: "olasılık ve zorunluluk", pl: "możliwość i obowiązek" },
    coachLine: {
      ...
      en: 'The modal sets an attitude: possibility, obligation, advice, or prohibition.',
    ...
    mistakeWhy: {
      ...
      en: 'The signal points not to the action itself, but to the attitude toward it.',
    ...
    nextStep: {
      ...
      en: 'Next comes the contrast between can/could, must/should, may/might.',
  ...
  phrasal_particle: {
    ...
    icon: 'swap-horizontal-outline',
    accent: '#F43F5E',
    title: { ru: 'Фразовые частицы', uk: 'Фразові частки', en: 'Phrasal particles', es: 'Partículas verbales', 'pt-BR': "Partículas frasais", vi: "Particle trong phrasal verb", id: "Partikel frasal", tr: "Phrasal parçacıklar", pl: "Partykuły frazowe" },
    drillLabel: { ru: 'глагол плюс частица', uk: 'дієслово плюс частка', en: 'verb plus particle', es: 'verbo más partícula', 'pt-BR': "verbo mais partícula", vi: "động từ cộng particle", id: "kata kerja plus partikel", tr: "fiil artı parçacık", pl: "czasownik plus partykuła" },
    coachLine: {
      ru: 'Частица меняет смысл глагола: смотри на пару целиком.',
      uk: 'Частка змінює сенс дієслова: дивись на пару повністю.',
      en: 'The particle changes the meaning of the verb: look at the pair as a whole.',
    ...
    mistakeWhy: {
      ...
      en: 'The mistake looks like picking the familiar verb without the right particle.',
    ...
    nextStep: {
      ...
      en: 'The pool will drill pick up, turn on, get off, and similar pairs as whole chunks.',
