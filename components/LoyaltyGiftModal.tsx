...
const COPY: Record<'ru' | 'uk' | 'es', ModalCopy> & Partial<Record<PlannedInterfaceLang, ModalCopy>> = {
  ru: {
    ...
    highlights: [
      ...
      { icon: 'bulb', title: 'Понятно объясняет промахи', body: 'Если промахнулся — приложение спокойно покажет, почему. А если что-то всё ещё непонятно, одна кнопка объяснит совсем простыми словами.' },
