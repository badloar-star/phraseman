...
describe('product analytics learning outcome warehouse contract', () => {
    const sql = (0, admin_product_analytics_1.buildProductAnalyticsAggregateQuery)('`demo.analytics.events_*`');
...
//# sourceMappingURL=admin_product_analytics_learning.test.js.map