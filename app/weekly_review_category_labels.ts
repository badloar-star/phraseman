...
export const CATEGORY_LABEL_COPY: Record<string, AnalyticsLocaleCopy> = {
  ...
  syntax: { ru: 'Порядок слов', uk: 'Порядок слів', en: 'Word order', es: 'Sintaxis', ptBR: 'Sintaxe', 'pt-BR': 'Sintaxe', vi: 'Cú pháp', id: 'Sintaksis', tr: 'Söz dizimi', pl: 'Składnia' },
  ...
  'to-be': { ru: 'Глагол to be', uk: 'Дієслово to be', en: 'Verb to be', es: 'Verbo to be', ptBR: 'Verbo to be', 'pt-BR': 'Verbo to be', vi: 'Động từ to be', id: 'Kata kerja to be', tr: 'to be fiili', pl: 'Czasownik to be' },
  ...
  modifier: { ru: 'Усилители (modifiers)', uk: 'Підсилювачі (modifiers)', en: 'Modifiers', es: 'Modificadores', ptBR: 'Modificadores', 'pt-BR': 'Modificadores', vi: 'Từ bổ nghĩa', id: 'Modifier', tr: 'Niteleyiciler', pl: 'Modyfikatory' },
  determiner: { ru: 'Определители (determiners)', uk: 'Визначники (determiners)', en: 'Determiners', es: 'Determinantes', ptBR: 'Determinantes', 'pt-BR': 'Determinantes', vi: 'Từ hạn định', id: 'Determiner', tr: 'Belirleyiciler', pl: 'Określniki' },
