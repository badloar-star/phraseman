...
const COLLECTION_GROUP_QUERY_SPECS: AccountDeleteCollectionGroupSpec[] = [
  ...
  { collectionGroup: 'idea_likes_sent', field: 'targetAuthorUid', values: 'stable' },
  { collectionGroup: 'user_ideas', field: 'uid', values: 'stable' },
  { collectionGroup: 'idea_reports', field: 'reporterUid', values: 'stable' },
  { collectionGroup: 'idea_reports', field: 'authorUid', values: 'stable' },
  { collectionGroup: 'user_idea_report_rate_limits', field: 'stableUid', values: 'stable' },
