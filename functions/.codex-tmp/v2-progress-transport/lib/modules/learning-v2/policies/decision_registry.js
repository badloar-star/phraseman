...
exports.resolveDecisionRegistry = exports.DecisionRegistryValidationError = exports.validateDecisionRegistry = exports.validateDecisionRegistryRecord = exports.decisionRegistryObjectPath = exports.hashCanonicalBody = exports.sha256Utf8 = exports.utf8ByteLengthV1 = exports.canonicalJsonV1 = exports.CanonicalJsonError = exports.V2_DECISION_IDS = void 0;
...
const hashCanonicalBody = (body) => (0, exports.sha256Utf8)((0, exports.canonicalJsonV1)(body));
exports.hashCanonicalBody = hashCanonicalBody;
const decisionRegistryObjectPath = (registryId, version, contentHash) => `content-studio/decision-registries/${(0, exports.sha256Utf8)(registryId)}/v${version}/${contentHash}.json`;
...
exports.validateDecisionRegistryRecord = validateDecisionRegistryRecord;
...
const validateDecisionRegistry = (input) => {
    ...
    if (bodyResult.valid && recordResult.valid && bodyResult.body && recordResult.record) {
        ...
        const bodyHash = (0, exports.sha256Utf8)(canonical);
