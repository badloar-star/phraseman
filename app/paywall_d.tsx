...
export default function PaywallD() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      // некритично
      DebugLogger.error('paywall_d:tags', e instanceof Error ? e : new Error(String(e)), 'warning');
    }
      try {
      ...
      // некритично
      DebugLogger.error('paywall_d:m', e instanceof Error ? e : new Error(String(e)), 'warning');
    }
      try {
      ...
      // некритично
      DebugLogger.error('paywall_d:prof', e instanceof Error ? e : new Error(String(e)), 'warning');
    }
    })();
    ...
    try {
      ...
      // некритично
      DebugLogger.error('paywall_d:dayHash', e instanceof Error ? e : new Error(String(e)), 'warning');
    }
    return () => { dead = true; };
  }, [source, ctx, lang]);
