 ...
 * по одной/соседним кнопкам. 45 мс — достаточно короткий, чтобы отклик
 * ощущался при быстрых последовательных тапах (раньше 80 мс «глотал» вибро,
 * из-за чего казалось, что кнопка не нажалась), но всё ещё режет реальный дребезг.
 */
export const HAPTIC_TAP_COOLDOWN_MS = 45;
/**
