...
| Target localized items | 26207 |
| Target item share | 0.1884 |
| Field coverage gap files | 0 |
| Item coverage gap files | 1 |
...
## Item Coverage Gaps
| File | Surface | Reason |
| app/quiz_source_locale_payloads.ts | quizzes | Extracted 20650 non-HTML source localized item(s), but no es extracted items. |
