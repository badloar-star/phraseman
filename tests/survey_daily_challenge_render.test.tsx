...
const mockOskolokImageForPackShards = jest.fn<any, [number]>(() => ({ uri: 'survey-shard' }));
jest.mock('../app/oskolok', () => ({
  oskolokImageForPackShards: (...args: unknown[]) => mockOskolokImageForPackShards(Number(args[0])),
}));
