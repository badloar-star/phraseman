...
export const DAILY_TASK_REWARD_TOAST_THEME_STYLES: Record<ThemeMode, DailyTaskRewardToastThemeStyle> = {
  ...
  vanilla: {
    cardColors: ['#FFFDF4', '#F4EBD4'],
    sheenColors: ['rgba(61,78,143,0.10)', 'rgba(61,78,143,0.04)', 'rgba(61,78,143,0)'],
    accentRailColor: '#3D4E8F',
    auraColor: 'rgba(61,78,143,0.10)',
    borderColor: 'rgba(61,78,143,0.26)',
    radius: 14,
    shadowColor: 'rgba(58,44,8,0.30)',
    iconName: 'sparkles-outline',
    iconBg: 'rgba(61,78,143,0.10)',
    iconBorderColor: 'rgba(61,78,143,0.26)',
    iconColor: '#3D4E8F',
    titleColor: '#2A2118',
    taskColor: '#6F6350',
    xpColor: '#D9A62E',
    claimBg: '#3D4E8F',
    claimText: '#FFFFFF',
    claimBorderColor: 'rgba(61,78,143,0.40)',
    buttonIconName: 'gift-outline',
  },
  midnight: {
