/**
 * Компас — сбор социальных событий для ненавязчивого глобального тоста.
 *
 ...
 * сигнатуры лежат в AsyncStorage. collect/markSeen гарантируют, что событие
...
/**
 * Помечает события показанными, чтобы они больше не всплыли в тосте.
 * Кольцевой буфер хранит последние MAX_STORED_SIGNATURES.
 */
