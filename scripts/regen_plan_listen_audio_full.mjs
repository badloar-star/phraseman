 ...
 *
 * FULL fix for the "ÐÐ° ÑÐ»ÑƒÑ…" (listen-choose) audio desync.
 *
 * Problem this fixes:
 ...
 *   wrong sentence on ~2682 of 2730 phrases (98%) â€” the spoken audio never matched
 *   any answer card. See CONTENT_QUALITY_AUDIT.
 *
 * What this script does:
 *   1. Generates ONE dedicated mp3 per (plan, day, phrase 1-5) â€” 2730 files total â€”
...
// â”€â”€ dev-spend guard (skipped in --dry) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ load OPENAI_TTS_API_KEY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ load current authored content â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ simple bounded-concurrency runner â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// durationMs > 0 is REQUIRED by validatePlanAudioAsset for productionReady â€” without
...
function writeRegistry(targets) {
  ...
  const header = `import type { PlanAudioAsset } from './personal_plan_audio_asset_readiness';\n\n` +
    `// AUTO-GENERATED by scripts/regen_plan_listen_audio_full.mjs â€” do not edit by hand.\n` +
...
// â”€â”€ verify modules file shape before overwriting (keep existing export style) â”€
...
(async () => {
  ...
  if (!modulesInfo.hasGetter) {
    console.error('Existing modules file does not have the expected getter export â€” aborting to avoid breaking the import contract.');
    process.exit(5);
  }
