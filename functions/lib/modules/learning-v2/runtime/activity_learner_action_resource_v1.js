...
function parseEntry(value, sessionOrdinal) {
    ...
    const prompt = exactText(value.report.prompt, 4000, "learning_v2_activity_action_report_invalid");
    ...
    const responseOptions = value.report.responseOptions.map((raw) => {
        ...
        return Object.freeze({
            responseId,
            text: exactText(raw.text, 1000, "learning_v2_activity_action_response_option_invalid"),
        });
    });
    const accessibilityLabel = exactText(value.report.accessibilityLabel, 4000, "learning_v2_activity_action_report_invalid");
    ...
    if (value.save.resolution === "learner_visible_prompt") {
        const targetText = exactText(value.save.targetText, 4000, "learning_v2_activity_action_save_invalid");
