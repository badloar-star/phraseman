...
- **КФ-8 Трансляция VIP 📺** — фаза 2. Зрители видят таблицу live + ход раундов; реакции-эмодзи летящие; **прогноз «кто победит» за 5 💎, выплата ×3 — ставки принимаются ТОЛЬКО на этапе сбора (лобби зрителей), после старта прогнозы закрыты**; пуш всем не играющим: «VIP-турнир начался, банк N 💎 — смотри live».
...
- **Фаза 1 (MVP):** слоты 3×/день, комнаты 16, боты-персонажи, 4 раунда (все режимы v2, голосовые ×1.5), таблица-плашки, билеты (все источники + 1 free/нед), призы 50/25/10, сезон недельный, КФ-4 банк, КФ-5 шер, КФ-7 серии, админ-пул заданий, пуши. Remote Config гейт + внутренний QA + cost-логирование.
