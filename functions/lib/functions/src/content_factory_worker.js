...
exports.claimContentFactoryV2Stage = claimContentFactoryV2Stage;
exports.finishContentFactoryV2Stage = finishContentFactoryV2Stage;
...
const v2_stage_claim_adapter_1 = require("./content_factory/v2_stage_claim_adapter");
 ...
 */
function claimContentFactoryV2Stage(db, input) {
    return (0, v2_stage_claim_adapter_1.claimNextV2Stage)(db, input);
}
function finishContentFactoryV2Stage(db, lease, outcome) {
    return (0, v2_stage_claim_adapter_1.finishV2StageLease)(db, lease, outcome);
}
