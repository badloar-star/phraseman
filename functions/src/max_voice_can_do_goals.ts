...
export const CAN_DO_GOALS: readonly CanDoGoal[] = Object.freeze([
  ...
  G('a1_family', 'A1', 'Talk about family', 'Рассказать о семье', 'Розповісти про сім’ю',
    ...
    ['I have a sister.', 'This is my mother.', 'My brother is ten.', 'We live together.'], 'to-have', ['new_colleague_family']),
  G('a1_numbers_age', 'A1', 'Numbers, age and phone', 'Числа, возраст, телефон', 'Числа, вік, телефон',
    ...
    ["I'm twenty-five.", "It's five dollars.", 'My number is …', 'Two, please.'], 'numbers', ['gym_signup_form']),
  G('a1_time_days', 'A1', 'Time and days', 'Время и дни недели', 'Час і дні тижня',
    'ask and tell the time and name days of the week',
    ['What time is it?', "It's half past three.", 'On Monday.', 'At seven in the morning.'], 'prepositions-time', ['class_schedule_talk']),
  G('a1_daily_routine', 'A1', 'My daily routine', 'Мой день', 'Мій день',
    'describe a simple daily routine in the present simple',
    ['I get up at seven.', 'I go to work by bus.', 'I have lunch at one.', 'I go to bed late.'], 'present-simple', ['neighbour_morning_routine']),
  ...
  G('a1_home', 'A1', 'My home', 'Мой дом', 'Мій дім',
    ...
    ['I live in a flat.', 'There are two rooms.', 'There is a big kitchen.', 'My room is small.'], 'there-is', ['flatmate_room_tour']),
  G('a1_can_cant', 'A1', 'What I can do', 'Что я умею', 'Що я вмію',
    'say what they can and cannot do and ask others',
    ['I can swim.', "I can't drive.", 'Can you cook?', 'I can speak a little English.'], 'modals', ['club_skills_chat']),
  ...
  G('a2_past_day', 'A2', 'Talk about yesterday', 'Рассказать о вчерашнем дне', 'Розповісти про вчорашній день',
    ...
    ['Yesterday I went to work.', 'I watched a film.', 'We had dinner with friends.', 'It was great.'], 'past-simple-regular', ['monday_catchup']),
  G('a2_past_irregular', 'A2', 'Past with irregular verbs', 'Прошедшее с неправильными глаголами', 'Минуле з неправильними дієсловами',
    ...
    ['I went to the cinema.', 'I saw my friend.', 'We ate pizza.', 'I took a taxi.'], 'past-simple-irregular', ['trip_story_swap']),
  ...
  G('a2_now', 'A2', 'What is happening now', 'Что происходит сейчас', 'Що відбувається зараз',
    ...
    ["I'm working from home today.", "She's talking on the phone.", 'What are you doing?', "It's raining right now."], 'present-continuous', ['video_call_now']),
  ...
  G('b1_experience', 'B1', 'Talk about experiences', 'Рассказать об опыте', 'Розповісти про досвід',
    ...
    ['Have you ever been to London?', "I've never tried sushi.", "I've worked here for two years.", "I've just finished."], 'present-perfect', ['interview_experience']),
  ...
  G('b1_plans_future', 'B1', 'Future plans and predictions', 'Планы и прогнозы', 'Плани й прогнози',
    ...
    ["I'm meeting Anna on Friday.", "I'll probably move next year.", "By then I'll have finished.", "It's going to be busy."], 'future-simple', ['plans_next_year']),
  ...
  G('b1_phrasal', 'B1', 'Everyday phrasal verbs', 'Фразовые глаголы', 'Фразові дієслова',
    ...
    ['I need to pick up my kids.', 'Can you turn it down?', 'We ran out of milk.', "Let's put it off till Monday."], 'phrasal-verbs', ['moving_day_help']),
