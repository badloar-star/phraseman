...
//
// Владелец выбрал базу 100 000 и шаг 10 000: комната ботов сама набирает лишь
// половину цели, остальное обязаны добрать живые игроки — сундук снова
// достижение, а не выдача по расписанию.
const LEAGUE_CHEST_BASE_GOAL = 100_000;
