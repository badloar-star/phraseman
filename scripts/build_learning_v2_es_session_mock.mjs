...
function htmlDocument(inlineDataJson, sessionOrdinal) {
  return `<!doctype html>
<html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Learning V2 · Испанский · Урок 1 · сессия ${sessionOrdinal}</title>
<style>
...
<header class="top"><div class="topline"><div class="brand"><strong>Испанский · Урок 1 · Ser</strong><span>Сессия ${sessionOrdinal} — играбельный макет</span></div><select id="locale" class="control" aria-label="Язык объяснения"></select><select id="theme" class="control" aria-label="Тема интерфейса"><option value="indigo">Индиго</option><option value="sage">Нефрит</option><option value="olive">Олива</option><option value="midnight">Полночь</option></select></div></header>
...
export async function buildEsSessionMock(args = process.argv.slice(2)) {
  ...
  writeFileSync(outputPath, htmlDocument(dataJson, sessionOrdinal), 'utf8');
