...
export const PEARL_ICONS: Record<ThemeMode, ImageSourcePropType> = {
  dark: require('../assets/images/currency/pearl_dark.webp'), gold: require('../assets/images/currency/pearl_gold.webp'), olive: require('../assets/images/currency/pearl_olive.webp'), minimalDark: require('../assets/images/currency/pearl_indigo.webp'), midnight: require('../assets/images/currency/pearl_midnight.webp'), ember: require('../assets/images/currency/pearl_ember.webp'), aurora: require('../assets/images/currency/pearl_aurora.webp'), volt: require('../assets/images/currency/pearl_volt.webp'), business: require('../assets/images/currency/pearl_business.webp'), businessLight: require('../assets/images/currency/pearl_businessLight.webp'), sagePorcelain: require('../assets/images/currency/pearl_sagePorcelain.webp'), candyBlue: require('../assets/images/currency/pearl_indigo.webp'), indigo: require('../assets/images/currency/pearl_indigo.webp'),
} as const;
