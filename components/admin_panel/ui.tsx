...
const SECTION_META: Record<string, { chapter: AdminChapterId; keywords: string }> = {
  ...
  trainer_debug: { chapter: 'gameplay', keywords: 'тренер trainer сессии ошибки srs лог weak smart mix' },
  ...
  onboarding: { chapter: 'system', keywords: 'онбординг интро full access энергия welcome ended' },
