...
export const ES_EPISODE_01_SESSION_34_MODE_NATIVE_PRACTICE_V1 = Object.freeze<readonly SessionModeNativePracticeSourceV1[]>([
  ...
  { family: 'phrase_builder', purpose: 'near_transfer', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 2 }, modePayload: phraseBuilder(2) },
  { family: 'listen_build_dictation', purpose: 'guided_practice', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 3 }, modePayload: listenBuildPhrase(3) },
  { family: 'context_gap_grammar', purpose: 'near_transfer', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 4 }, modePayload: contextGapLastWord(4) },
  { family: 'listen_choose', purpose: 'near_transfer', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 5 }, modePayload: listenChoosePhrase(5, 6) },
  { family: 'context_gap_grammar', purpose: 'near_transfer', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 7 }, modePayload: contextGapLastWord(7) },
  { family: 'listen_choose', purpose: 'near_transfer', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 9 }, modePayload: listenChoosePhrase(9, 10) },
  { family: 'context_gap_grammar', purpose: 'independent_check', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 11 }, modePayload: contextGapLastWord(11) },
  { family: 'listen_choose', purpose: 'independent_check', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 12 }, modePayload: listenChoosePhrase(12, 9) },
  { family: 'phrase_builder', purpose: 'independent_check', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 8 }, modePayload: phraseBuilder(8) },
  { family: 'listen_build_dictation', purpose: 'independent_check', learningStage: 'apply_in_phrase', target: { kind: 'phrase', sourcePhraseIndex: 14 }, modePayload: listenBuildPhrase(14) },
]);
