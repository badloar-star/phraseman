...
export const DAILY_PHRASE_CHROME: Record<ThemeMode, DailyPhraseChrome> = {
  ...
  ember: {
    ...
    border: 'rgba(255,162,69,0.42)',
    glow: 'rgba(255,138,42,0.16)',
    title: '#FFD9A8',
    phrase: '#FFFFFF',
    sub: '#C9B4A4',
    iconBg: 'rgba(255,162,69,0.15)',
    iconBorder: 'rgba(255,162,69,0.31)',
    ornament: '#FFA245',
    shadow: '#FFA245',
  },
  aurora: {
  ...
  volt: {
    ...
    border: 'rgba(214,255,61,0.42)',
    glow: 'rgba(184,242,34,0.16)',
    title: '#EFFF9E',
    phrase: '#FFFFFF',
    sub: '#BFC6A3',
    iconBg: 'rgba(214,255,61,0.15)',
    iconBorder: 'rgba(214,255,61,0.31)',
    ornament: '#D6FF3D',
    shadow: '#D6FF3D',
  },
};
