...
export const LESSON31_THEORY: { titleRu: string; titleUk: string; sections: L1Section[] } = {
    ...
    // ───────────────────────── 01 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'I want you to stay.', ru: 'Я хочу, чтобы ты остался.', uk: 'Я хочу, щоб ти лишився.', hi: 'you to' },
            { en: 'She made me laugh.', ru: 'Она рассмешила меня.', uk: 'Вона розсмішила мене.', hi: 'me laugh' },
            { en: 'I asked her to help me.', ru: 'Я попросил её помочь мне.', uk: 'Я попросив її допомогти мені.', hi: 'her to' },
            { en: 'Let him speak.', ru: 'Дай ему сказать.', uk: 'Дай йому сказати.', hi: 'him speak' },
          ],
        },
        {
          kind: 'tip',
    ...
    // ───────────────────────── 02 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'I want you to stay.', ru: 'Я хочу, чтобы ты остался.', uk: 'Я хочу, щоб ти лишився.', hi: 'you to stay' },
            { en: 'Let him speak.', ru: 'Дай ему сказать.', uk: 'Дай йому сказати.', hi: 'him speak' },
          ],
        },
        {
          ...
          drill: {
            type: 'word_bank',
            prompt: { ru: 'Я хочу, чтобы ты остался.' },
            answer: ['I', 'want', 'you', 'to', 'stay'],
            slotLabels: [{ ru: 'кто' }, { ru: 'глагол' }, { ru: 'объект' }, { ru: 'to' }, { ru: 'действие' }],
    ...
    // ───────────────────────── 03 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'I want you to stay.', ru: 'Я хочу, чтобы ты остался.', uk: 'Я хочу, щоб ти лишився.', hi: 'to stay' },
            { en: 'She expects him to call.', ru: 'Она ждёт, что он позвонит.', uk: 'Вона очікує, що він подзвонить.', hi: 'to call' },
            { en: 'I asked her to help me.', ru: 'Я попросил её помочь мне.', uk: 'Я попросив її допомогти мені.', hi: 'to help' },
            { en: 'He told me to stop.', ru: 'Он велел мне остановиться.', uk: 'Він сказав мені зупинитися.', hi: 'to stop' },
            { en: 'She allowed me to go.', ru: 'Она разрешила мне уйти.', uk: 'Вона дозволила мені піти.', hi: 'to go' },
            { en: 'I need you to understand.', ru: 'Мне нужно, чтобы ты понял.', uk: 'Мені треба, щоб ти зрозумів.', hi: 'to understand' },
          ],
        },
        {
          kind: 'tip',
        ...
        },
        {
          ...
          drill: {
            ...
            options: ['to', '—', 'for'],
            answer: 'to',
            why: { ru: 'После ask + объект идёт to + глагол: I asked her to help me.' },
          },
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          examples: [
            { en: 'She made me laugh.', ru: 'Она рассмешила меня.', uk: 'Вона розсмішила мене.', hi: 'me laugh' },
            { en: 'Let him speak.', ru: 'Дай ему сказать.', uk: 'Дай йому сказати.', hi: 'him speak' },
            { en: 'I heard him sing.', ru: 'Я слышал, как он пел.', uk: 'Я чув, як він співав.', hi: 'him sing' },
            { en: 'I saw him running.', ru: 'Я видел, как он бежал.', uk: 'Я бачив, як він біг.', hi: 'him running' },
            { en: 'She watched them play.', ru: 'Она смотрела, как они играют.', uk: 'Вона дивилася, як вони грають.', hi: 'them play' },
          ],
        },
        {
          kind: 'tip',
        ...
        },
        {
          ...
          drill: {
            ...
            correct: 'B',
            explain: { ru: 'После make действие идёт без to: She made me laugh.' },
          },
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          drill: {
            ...
            fix: { ru: 'После let действие идёт без to: Let him speak.' },
          },
        },
      ],
    },
