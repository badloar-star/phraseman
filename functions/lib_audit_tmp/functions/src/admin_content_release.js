...
function roleFromToken(token) { return /* зачем: adminRole в проекте никем не выдаётся (setCustomUserClaims нет) — флага admin достаточно, роль по умолчанию owner */ (0, roles_1.hasAdminRole)(token.adminRole) ? token.adminRole : 'owner'; }
