...
describe('level Spin reward catalog v3', () => {
  ...
  test('uses integer intervals rather than percentages or a sum of 100', () => {
    expect(LEVEL_SPIN_REWARD_TOTAL_WEIGHT).toBe(205_681);
    expect(6_170 / LEVEL_SPIN_REWARD_TOTAL_WEIGHT).toBeCloseTo(0.029997909, 9);
    ...
    expect(pickLevelSpinRewardByTicket(189_999).id).toBe('xp_2x_24h');
    expect(pickLevelSpinRewardByTicket(190_000).id).toBe('xp_10000');
    expect(pickLevelSpinRewardByTicket(198_999).id).toBe('xp_2x_48h');
    expect(pickLevelSpinRewardByTicket(199_000).id).toBe('xp_50000');
    expect(pickLevelSpinRewardByTicket(199_499).id).toBe('stars_1000');
    expect(pickLevelSpinRewardByTicket(199_500).id).toBe('plus_days_3');
    expect(pickLevelSpinRewardByTicket(199_509).id).toBe('plus_days_3');
    expect(pickLevelSpinRewardByTicket(199_510).id).toBe('plus_days_7');
    expect(pickLevelSpinRewardByTicket(199_511).id).toBe('cosmetic_avatar_aura');
    expect(pickLevelSpinRewardByTicket(205_680).id).toBe('cosmetic_avatar_aura');
  });
