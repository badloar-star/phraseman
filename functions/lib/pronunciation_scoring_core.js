...
exports.PRONUNCIATION_PASS_THRESHOLD = void 0;
exports.scorePronunciationTranscript = scorePronunciationTranscript;
exports.PRONUNCIATION_PASS_THRESHOLD = 90;
...
function scorePronunciationTranscript(input) {
    ...
    const threshold = Math.max(1, Math.min(100, Math.round(input.threshold ?? exports.PRONUNCIATION_PASS_THRESHOLD)));
...
//# sourceMappingURL=pronunciation_scoring_core.js.map