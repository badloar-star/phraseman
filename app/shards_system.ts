...
export type ShardSource =
  ...
  | 'daily_tasks_all'       // +5 Все 3 дневных задания (кнопка «Забрать» на экране заданий)
...
/**
 * +5 осколков за выполнение всех 3 ежедневных заданий за день (ручной «Забрать» на экране заданий).
