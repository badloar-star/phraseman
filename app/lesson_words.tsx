...
const WORDS_BY_LESSON: Record<number, Word[]> = {
  ...
  3: [
    // Present Simple: Affirmative (common vocabulary from lesson)
    ...
    { en: 'teach', ru: 'Учить', uk: 'Навчати', pos: 'verbs' },
    { en: 'study', ru: 'Учиться', uk: 'Вчитися', pos: 'verbs' },
    { en: 'go', ru: 'Идти', uk: 'Йти', pos: 'verbs' },
    { en: 'love', ru: 'Любить', uk: 'Любити', pos: 'verbs' },
    { en: 'like', ru: 'Нравиться', uk: 'Подобатися', pos: 'verbs' },
    { en: 'swim', ru: 'Плавать', uk: 'Плавати', pos: 'verbs' },
    { en: 'play', ru: 'Играть', uk: 'Грати', pos: 'verbs' },
    { en: 'coffee', ru: 'Кофе', uk: 'Кава', pos: 'nouns' },
    { en: 'London', ru: 'Лондон', uk: 'Лондон', pos: 'nouns' },
    { en: 'news', ru: 'Новости', uk: 'Новини', pos: 'nouns' },
    { en: 'school', ru: 'Школа', uk: 'Школа', pos: 'nouns' },
    { en: 'teacher', ru: 'Учитель', uk: 'Учитель', pos: 'nouns' },
  ...
  4: [
    // Present Simple: Negation (common vocabulary from lesson)
    { en: 'drink', ru: 'Пить', uk: 'Пити', pos: 'verbs' },
  ...
  5: [
    // Present Simple: Questions (common vocabulary from lesson)
    { en: 'drink', ru: 'Пить', uk: 'Пити', pos: 'verbs' },
    { en: 'live', ru: 'Жить', uk: 'Жити', pos: 'verbs' },
    { en: 'work', ru: 'Работать', uk: 'Працювати', pos: 'verbs' },
    { en: 'understand', ru: 'Понимать', uk: 'Розуміти', pos: 'verbs' },
    ...
    { en: 'English', ru: 'Английский', uk: 'Англійська', pos: 'nouns' },
    { en: 'time', ru: 'Время', uk: 'Час', pos: 'nouns' },
