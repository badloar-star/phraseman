...
import { assertAiOutputLanguage, resolveAiOutputLang, resolveStudyTarget } from './ai_language_contract';
  ...
  return [
    {
      role: 'system',
      content:
        'You are "Компас", a warm, gentle Phraseman tutor explaining ONE tiny English word mistake to a ' +
