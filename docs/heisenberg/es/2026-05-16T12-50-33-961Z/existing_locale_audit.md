...
| Metric | Value |
| Files scanned | 1534 |
| Localized items | 80507 |
| Target localized items | 12931 |
| Target item share | 0.1606 |
| Field coverage gap files | 18 |
| Item coverage gap files | 30 |
...
## Field Coverage Gaps
| File | Surface | Reason |
| app/flashcards/bundles/official_peaky_blinders_en.json | app-other | Has 120 localized source-language field marker(s), but no ES field marker. |
...
| functions/lib/friend_gifts.js | app-other | Extracted 3 source localized item(s), but no es extracted items. |
| functions/src/friend_gifts.ts | app-other | Extracted 3 source localized item(s), but no es extracted items. |
| app/community_packs/communityPackDraftStorage.ts | app-other | Extracted 1 source localized item(s), but no es extracted items. |
