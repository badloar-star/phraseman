...
exports.V2_FIREBASE_ACTIVITY_SERVER_EVALUATOR_RELEASE_SUMMARY_SCHEMA_V1 = void 0;
exports.isV2FirebaseActivityServerEvaluatorReleaseHandleV1 = isV2FirebaseActivityServerEvaluatorReleaseHandleV1;
exports.getV2FirebaseActivityServerEvaluatorReleaseSummaryV1 = getV2FirebaseActivityServerEvaluatorReleaseSummaryV1;
exports.createFirebaseAdminV2ActivityServerEvaluatorReleaseAdapterV1 = createFirebaseAdminV2ActivityServerEvaluatorReleaseAdapterV1;
const node_crypto_1 = require("node:crypto");
const release_manifest_1 = require("../../../modules/learning-v2/content/release_manifest");
const decision_registry_1 = require("../../../modules/learning-v2/policies/decision_registry");
const v2_activity_server_evaluator_release_v1_1 = require("./v2_activity_server_evaluator_release_v1");
...
exports.V2_FIREBASE_ACTIVITY_SERVER_EVALUATOR_RELEASE_SUMMARY_SCHEMA_V1 = "v2-firebase-activity-server-evaluator-release-summary.v1";
...
async function readJson(storage, pin, maximumBytes, contentTypes) {
...
function isV2FirebaseActivityServerEvaluatorReleaseHandleV1(value) {
    return typeof value === "object" && value !== null && handles.has(value);
}
function getV2FirebaseActivityServerEvaluatorReleaseSummaryV1(handle) {
    const found = materials.get(handle);
    if (!found)
        fail();
    return found.summary;
}
function createFirebaseAdminV2ActivityServerEvaluatorReleaseAdapterV1() {
    ...
    return Object.freeze({
        resolveSession: async (handle, sessionOrdinal) => {
            ...
            if (!session || session.sessionOrdinal !== sessionOrdinal)
                fail();
            const sidecarRaw = await readJson(io.storage, session.sidecar, v2_activity_session_projection_1.V2_ACTIVITY_SESSION_SIDECAR_MAX_BYTES, [v2_firebase_repository_persistence_v1_1.V2_REPOSITORY_IMMUTABLE_JSON_CONTENT_TYPE_V1]);
            ...
            if (!record(sidecar) ||
                ...
                (0, decision_registry_1.hashCanonicalBody)(sidecar) !== session.sidecarFingerprint)
                fail();
            return Object.freeze({
        ...
        loadPinned: async (activeHandle, episodeId) => {
            ...
            const indexRaw = await readJson(io.storage, input.indexObject, v2_activity_server_evaluator_release_v1_1.V2_ACTIVITY_SERVER_EVALUATOR_RELEASE_INDEX_MAX_BYTES_V1, [v2_firebase_repository_persistence_v1_1.V2_REPOSITORY_IMMUTABLE_JSON_CONTENT_TYPE_V1]);
            const index = (0, v2_activity_server_evaluator_release_v1_1.parseV2ActivityServerEvaluatorReleaseIndexV1)(indexRaw);
            if ((0, decision_registry_1.sha256Utf8)(indexRaw) !== input.indexObject.contentHash ||
                ...
                fail();
            const summaryBody = {
                schemaVersion: exports.V2_FIREBASE_ACTIVITY_SERVER_EVALUATOR_RELEASE_SUMMARY_SCHEMA_V1,
            ...
            const handle = Object.freeze({
                kind: "v2_firebase_activity_server_evaluator_release_handle",
            });
            handles.add(handle);
        ...
        load: async (input) => {
            ...
            const manifestRaw = await readJson(io.storage, manifestPin(recordValue), 2 * 1024 * 1024, ["application/json", v2_firebase_repository_persistence_v1_1.V2_REPOSITORY_IMMUTABLE_JSON_CONTENT_TYPE_V1]);
            ...
            if (lessonUnits.length !== 1 ||
                ...
                fail();
            const pointerDocumentPath = (0, v2_activity_server_evaluator_release_v1_1.v2ActivityServerEvaluatorReleasePointerDocumentPathV1)({
            ...
            const pointerRead = await io.readCanonicalDocumentExact({
                ...
                maximumBytes: v2_activity_server_evaluator_release_v1_1.V2_ACTIVITY_SERVER_EVALUATOR_RELEASE_POINTER_MAX_BYTES_V1,
            });
            const pointerRaw = unwrap(pointerRead.canonicalRaw);
            const structuralPointer = (0, v2_activity_server_evaluator_release_v1_1.parseV2ActivityServerEvaluatorReleasePointerV1)(pointerRaw);
            if (structuralPointer.environment !== input.environment ||
                ...
                fail();
            const indexRaw = await readJson(io.storage, structuralPointer.indexObject, v2_activity_server_evaluator_release_v1_1.V2_ACTIVITY_SERVER_EVALUATOR_RELEASE_INDEX_MAX_BYTES_V1, [v2_firebase_repository_persistence_v1_1.V2_REPOSITORY_IMMUTABLE_JSON_CONTENT_TYPE_V1]);
            const index = (0, v2_activity_server_evaluator_release_v1_1.parseV2ActivityServerEvaluatorReleaseIndexV1)(indexRaw);
            const pointer = (0, v2_activity_server_evaluator_release_v1_1.parseV2ActivityServerEvaluatorReleasePointerV1)(pointerRaw, index);
            if ((0, decision_registry_1.sha256Utf8)(indexRaw) !== pointer.indexObject.contentHash ||
            ...
            const summaryBody = Object.freeze({
                ...
                indexObjectFingerprint: (0, decision_registry_1.hashCanonicalBody)(pointer.indexObject),
                sessionCount: 12,
                objectCount: 12,
                serverOnly: true,
                clientDelivery: "forbidden",
...
//# sourceMappingURL=v2_firebase_activity_server_evaluator_release_adapter_v1.js.map