...
const CONTROL_PANEL_WORKFLOWS = Object.freeze([
  ...
  { title: 'Plus-доступ и уроки', description: 'Глобальные возможности Plus, бесплатные лимиты и поурочное открытие 1–32.', primary: '#application', primaryLabel: 'Открыть доступ Free / Plus', fallback: 'control-panel', risk: 'Защищённая публикация', coverage: '5 старых кнопок', guarded: true },
