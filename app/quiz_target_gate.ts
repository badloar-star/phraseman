...
export function frenchQuizGateCopy(sourceLocale?: string) {
  ...
  return {
    title: uk ? 'Французькі квізи ще готуються' : 'Французские квизы ещё готовятся',
    body: uk
      ? 'Англійський банк квізів приховано в режимі French. Квізи відкриються тільки після окремого французького банку завдань, перевірених за джерелами, дистракторами й підказками українською/російською.'
      : 'Английский банк квизов скрыт в режиме French. Квизы откроются только после отдельного французского банка заданий, проверенных по источникам, дистракторам и подсказкам на русском/украинском.',
