...
// VERIFIED_COURSE_PACK_REMOTE_ENABLED is false, every path returns the bundled
...
function isCorruptPackRow(value: unknown): value is { corrupt: true } {
  return Boolean(value && typeof value === 'object' && (value as { corrupt?: unknown }).corrupt === true);
}
