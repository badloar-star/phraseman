...
export const MEDAL_TOAST_THEME_STYLES: Record<ThemeMode, MedalToastThemeStyle> = {
  ...
  business: {
    signature: 'graphite-mono-steel',
    cardBgColors: ['rgba(28,28,28,0.97)', 'rgba(10,10,10,0.97)'],
    borderColor: 'rgba(255,255,255,0.12)',
    titleColor: '#F2F2F2',
    subtitleColor: 'rgba(154,154,154,0.76)',
    surfaceAccent: '#FFFFFF',
    badgeDownColor: '#9A9A9A',
    topShineColors: ['rgba(255,255,255,0)', 'rgba(255,255,255,0.40)', 'rgba(255,255,255,0)'],
    topShineOpacity: 0.68,
    haloOpacity: 0.22,
    auraColor: 'rgba(255,255,255,0.08)',
    medalPlateBg: 'rgba(255,255,255,0.06)',
    medalPlateBorder: 'rgba(255,255,255,0.12)',
