...
export const WEEKLY_COMPASS_ICON_DALLE_PROMPTS: Record<ThemeMode, string> = {
  ...
  business: 'Centered 3D compass icon for a language learning app, serious executive monochrome style, graphite-black shell, brushed gunmetal, polished silver highlights, precise corporate geometry, premium object cutout, transparent background, no text, no letters, no logo, no hands, no map, no colored glow, no colored accents, only black white and grayscale tones, soft studio rim light, 1024 square.',
