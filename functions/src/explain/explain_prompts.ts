...
export interface JudgeOutputLanguageSample {
  text: string;
  maskedFragmentCount: number;
}
 ...
 */
export function buildJudgeOutputLanguageSample(text: string): JudgeOutputLanguageSample {
