...
3. **Reward Stack (агрегация)** — если в очереди ≥2 наград за один триггер, показывается ОДНА карточка-пейджер: стопка карточек, точки «1 из 3», свайп между наградами, CTA «Забрать всё». Убивает «парад модалок».
