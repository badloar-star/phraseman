...
test('representative meanings preserve person, question, negation, and a location in every locale', () => {
  ...
  const samples = [EPISODE_01_SESSION_11_SOURCE.phrases[0], EPISODE_01_SESSION_12_SOURCE.phrases[0], EPISODE_01_SESSION_13_SOURCE.phrases[12], EPISODE_01_SESSION_14_SOURCE.phrases[0]];
