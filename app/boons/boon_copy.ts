...
const BOON_COPY: Record<BoonId, BoonCopySource> = {
  ...
  arena_saturday: {
    ...
    detail: {
      ru: [
        'Арена — это короткие дуэли на знание фраз с другими игроками. Обычно за день можно сыграть ограниченное число боёв.',
        'Сегодня мы добавили тебе несколько дополнительных боёв сверху. Можешь сыграть больше обычного и подняться в рейтинге.',
        'Бонусные бои уже начислены — просто заходи на Арену и сражайся. Отличный день, чтобы позвать друзей.',
      ],
      uk: [
        'Арена — це короткі дуелі на знання фраз з іншими гравцями. Зазвичай за день можна зіграти обмежену кількість боїв.',
        'Сьогодні ми додали тобі кілька додаткових боїв понад норму. Можеш зіграти більше, ніж зазвичай, і піднятися в рейтингу.',
        'Бонусні бої вже нараховано — просто заходь на Арену й бийся. Чудовий день, щоб покликати друзів.',
      ],
      es: [
        'La Arena son duelos rápidos de frases contra otros jugadores. Normalmente al día puedes jugar un número limitado de combates.',
        'Hoy te sumamos varios combates extra. Puedes jugar más de lo normal y subir en el ranking.',
        'Los combates extra ya están cargados: solo entra a la Arena y pelea. Gran día para llamar a tus amigos.',
      ],
      'pt-BR': [
        'A Arena são duelos rápidos de frases contra outros jogadores. Normalmente dá pra jogar um número limitado de batalhas por dia.',
        'Hoje adicionamos algumas batalhas extras pra você. Dá pra jogar mais que o normal e subir no ranking.',
        'As batalhas extras já estão creditadas: é só entrar na Arena e lutar. Ótimo dia pra chamar os amigos.',
      ],
      vi: [
        'Đấu trường là những trận đấu nhanh về cụm từ với người chơi khác. Bình thường mỗi ngày bạn chỉ chơi được một số trận nhất định.',
        'Hôm nay chúng tôi cộng thêm vài trận nữa cho bạn. Bạn có thể chơi nhiều hơn thường lệ và leo hạng.',
        'Số trận thưởng đã được cộng — cứ vào Đấu trường và chiến thôi. Ngày tuyệt để rủ bạn bè.',
      ],
      id: [
        'Arena adalah duel cepat soal frasa melawan pemain lain. Biasanya dalam sehari kamu hanya bisa main sejumlah duel terbatas.',
        'Hari ini kami tambahkan beberapa duel ekstra untukmu. Kamu bisa main lebih banyak dari biasanya dan naik peringkat.',
        'Duel bonus sudah masuk — tinggal buka Arena dan bertarung. Hari yang pas untuk mengajak teman.',
      ],
      tr: [
        'Arena, diğer oyuncularla yapılan kısa ifade düellolarıdır. Normalde günde belli sayıda maç oynayabilirsin.',
        'Bugün sana birkaç ekstra maç ekledik. Her zamankinden çok oynayıp sıralamada yükselebilirsin.',
        'Bonus maçlar zaten tanımlandı — Arena’ya gir ve dövüş. Arkadaşlarını çağırmak için harika bir gün.',
      ],
      pl: [
        'Arena to krótkie pojedynki na znajomość fraz z innymi graczami. Zwykle w ciągu dnia możesz rozegrać ograniczoną liczbę walk.',
        'Dziś dorzuciliśmy ci kilka dodatkowych walk. Możesz zagrać więcej niż zwykle i podskoczyć w rankingu.',
        'Bonusowe walki są już naliczone — po prostu wejdź na Arenę i walcz. Świetny dzień, żeby zwołać znajomych.',
      ],
    },
  },
  speaking_saturday: {
