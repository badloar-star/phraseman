...
import { validateTopicArtifact } from './challenge_artifacts';
import { validateQuestionBatchArtifact, validateQuestionReplacementArtifact } from './challenge_artifacts';
...
type TopicKind = 'challenge_topic';
