...
Generated at: 2026-07-28T17:40:58.397Z

## Summary

- Files scanned: 3773
- Records: 3434
- Unique literal keys: 549
- Key patterns: 58
- Unknown expressions: 941
- Cloud sync keys observed: 143
- Learning-state records: 513
- Target namespace required: 57
- Blockers: 0
- High risks: 56
- Unknown-scope records: 165
...
- `high` lessonIds.map((id: app/daily_tasks.ts:2302 (unknown, multiGet)
- `high` ids.map((id: app/daily_tasks.ts:2645 (unknown, multiGet)
- `high` ids.map((id: app/daily_tasks.ts:2646 (unknown, multiGet)
...
- tournament_weekly_prize_seen:${last.weekId} at app/(tabs)/tournaments.tsx:285
...
- lessonIds.map((id at app/daily_tasks.ts:2302
- ids.map((id at app/daily_tasks.ts:2645
- ids.map((id at app/daily_tasks.ts:2646
- daily_polyglot_v1 at app/daily_tasks.ts:3115
- daily_polyglot_v1 at app/daily_tasks.ts:3121
- daily_polyglot_v1 at app/daily_tasks.ts:3137
