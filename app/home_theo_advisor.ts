...
const ROTATION: readonly HomeTheoAdvice[] = [
  ...
  { id: 'league_visible', priority: 380, action: 'stats', copy: fallbackCopy('Лига ожила. Хочешь подняться без выгорания — сделай 2 коротких захода вместо одного длинного.', 'Ліга ожила. Хочеш піднятися без вигорання — зроби 2 короткі підходи замість одного довгого.', 'La liga se movió. Para subir sin agotarte, haz 2 sesiones cortas en vez de una larga.', 'A liga se mexeu. Pra subir sem se esgotar, faça 2 sessões curtas em vez de uma longa.', 'Giải đấu đã chạy. Muốn lên mà không kiệt sức, làm 2 lượt ngắn thay vì một lượt dài.', 'Liga bergerak. Mau naik tanpa kelelahan, lakukan 2 sesi pendek daripada satu yang panjang.', 'Lig hareketlendi. Tükenmeden yükselmek için bir uzun yerine 2 kısa oturum yap.', 'Liga ruszyła. Chcesz iść w górę bez wypalenia — zrób 2 krótkie sesje zamiast jednej długiej.') },
  ...
  { id: 'level_early', priority: 360, action: 'lessons', copy: fallbackCopy('На ранних уровнях важнее частота, чем марафон. Один раунд плюс одно повторение — идеальная связка.', 'На ранніх рівнях важливіша частота, ніж марафон. Один раунд плюс одне повторення — ідеальна зв’язка.', 'En los niveles iniciales, la frecuencia gana al maratón. Una ronda más un repaso es la pareja ideal.', 'Nos níveis iniciais, a frequência vence a maratona. Uma rodada mais um repasso é o par ideal.', 'Ở mức đầu, đều đặn quan trọng hơn học dài. Một vòng cộng một lượt ôn là cặp đôi lý tưởng.', 'Di level awal, frekuensi mengalahkan maraton. Satu ronde plus satu pengulangan itu pas.', 'İlk seviyelerde sıklık maratonu yener. Bir tur artı bir tekrar, ideal ikili.', 'Na wczesnych poziomach częstotliwość wygrywa z maratonem. Runda plus powtórka to idealny zestaw.') },
  { id: 'level_mid', priority: 350, action: 'trainer', copy: fallbackCopy('Уровень растёт. Самый быстрый рост теперь в слабых местах: это почти-готовые фразы, им нужен один шаг.', 'Рівень росте. Найшвидший ріст тепер у слабких місцях: це майже-готові фрази, їм потрібен один крок.', 'Tu nivel sube. El avance más rápido ahora está en los puntos débiles: son frases casi listas, les falta un paso.', 'Seu nível sobe. O avanço mais rápido agora está nos pontos fracos: são frases quase prontas, falta um passo.', 'Cấp độ đang lên. Tiến nhanh nhất giờ ở điểm yếu: đó là những câu gần thuộc, chỉ thiếu một bước.', 'Levelmu naik. Pertumbuhan tercepat sekarang di titik lemah: itu frasa yang hampir bisa, tinggal satu langkah.', 'Seviyen yükseliyor. En hızlı gelişim artık zayıf noktalarda: bunlar neredeyse hazır ifadeler, bir adım kaldı.', 'Twój poziom rośnie. Najszybszy postęp jest teraz w słabych miejscach: to prawie gotowe frazy, brakuje im kroku.') },
  { id: 'level_high', priority: 340, action: 'aiDialog', copy: fallbackCopy('На твоём уровне чаще доставай язык из памяти. Разговор лучше всего переносит знание в речь.', 'На твоєму рівні частіше діставай мову з пам’яті. Розмова найкраще переносить знання в мовлення.', 'A tu nivel, saca el idioma de la memoria más seguido. La conversación es lo que mejor lo lleva al habla.', 'No seu nível, tire o idioma da memória com mais frequência. A conversa é o que melhor leva isso pra fala.', 'Ở mức của bạn, hãy kéo ngôn ngữ từ trí nhớ ra nhiều hơn. Hội thoại chuyển kiến thức sang lời nói tốt nhất.', 'Di levelmu, ambil bahasa dari memori lebih sering. Percakapan paling baik membawanya jadi ucapan.', 'Senin seviyende dili hafızadan daha sık çağır. Konuşma, bilgiyi konuşmaya en iyi taşır.', 'Na twoim poziomie częściej wyciągaj język z pamięci. Rozmowa najlepiej przenosi go w mowę.') },
  { id: 'lessons_3_done', priority: 330, action: 'trainer', copy: fallbackCopy('После нескольких раундов полезно притормозить и собрать слабые места. Так база станет плотнее.', 'Після кількох раундів корисно пригальмувати й зібрати слабкі місця. Так база стане щільнішою.', 'Tras varias rondas conviene frenar y juntar los puntos débiles. Así la base queda más firme.', 'Depois de algumas rodadas vale frear e juntar os pontos fracos. Assim a base fica mais firme.', 'Sau vài vòng, hãy chậm lại và gom điểm yếu. Nền tảng sẽ chắc hơn.', 'Setelah beberapa ronde, ada baiknya melambat dan kumpulkan titik lemah. Dasarnya jadi lebih kuat.', 'Birkaç turdan sonra yavaşlayıp zayıf noktaları toplamak iyi olur. Temel daha sağlam olur.', 'Po kilku rundach warto zwolnić i zebrać słabe miejsca. Baza będzie mocniejsza.') },
  { id: 'lessons_8_done', priority: 320, action: 'stats', copy: fallbackCopy('Раундов уже достаточно, чтобы видеть закономерности. Твои результаты подскажут, что повторить первым.', 'Раундів уже достатньо, щоб бачити закономірності. Твої результати підкажуть, що повторити першим.', 'Ya hay rondas suficientes para ver patrones. Tus resultados te dicen qué repasar primero.', 'Já há rodadas suficientes para ver padrões. Seus resultados dizem o que repassar primeiro.', 'Đã đủ vòng để thấy quy luật. Kết quả của bạn sẽ gợi ý nên ôn gì trước.', 'Sudah cukup ronde untuk melihat pola. Hasilmu menunjukkan apa yang perlu diulang dulu.', 'Desenleri görmek için yeterince tur var. Sonuçların önce neyi tekrar edeceğini söyler.', 'Masz już dość rund, by widzieć wzorce. Twoje wyniki podpowiedzą, co powtórzyć najpierw.') },
  { id: 'flashcards_soft', priority: 300, action: 'flashcards', copy: fallbackCopy('Не хочется раунд сегодня? Открой карточки. Это мягкий вход, а память всё равно работает.', 'Не хочеться раунду сьогодні? Відкрий картки. Це м’який вхід, а пам’ять усе одно працює.', '¿Hoy no te apetece una ronda? Abre las tarjetas. Es una entrada suave y la memoria igual trabaja.', 'Hoje não está a fim de uma rodada? Abra os cartões. É uma entrada leve e a memória trabalha do mesmo jeito.', 'Hôm nay không muốn một vòng? Mở thẻ ghi nhớ. Vào nhẹ nhàng mà trí nhớ vẫn hoạt động.', 'Hari ini malas satu ronde? Buka kartu. Masuknya halus tapi memori tetap bekerja.', 'Bugün tur istemiyor musun? Kartları aç. Yumuşak bir giriş, hafıza yine de çalışır.', 'Nie chce ci się dziś rundy? Otwórz fiszki. To łagodny start, a pamięć i tak pracuje.') },
  { id: 'premium_multiplier', priority: 295, action: 'lesson', copy: fallbackCopy('Сейчас очки идут быстрее. Потрать это на содержательную практику, а не на быстрые клики.', 'Зараз очки йдуть швидше. Витрать це на змістовну практику, а не на швидкі кліки.', 'Ahora los puntos suman más rápido. Aprovéchalo en práctica de verdad, no en clics rápidos.', 'Agora os pontos sobem mais rápido. Aproveite em prática de verdade, não em cliques rápidos.', 'Bây giờ điểm cộng nhanh hơn. Dùng cho luyện tập thật sự, đừng chỉ bấm nhanh.', 'Sekarang poin bertambah lebih cepat. Pakai untuk latihan sungguhan, bukan klik cepat.', 'Şu an puanlar daha hızlı geliyor. Bunu gerçek pratiğe harca, hızlı tıklara değil.', 'Teraz punkty lecą szybciej. Wykorzystaj to na sensowną praktykę, nie na szybkie kliki.') },
  { id: 'new_premium', priority: 290, action: 'stats', copy: fallbackCopy('Полный доступ уже у тебя. Сначала загляни в свои результаты и слабые места, чтобы не учиться вслепую.', 'Повний доступ уже в тебе. Спершу зазирни у свої результати й слабкі місця, щоб не вчитися наосліп.', 'Ya tienes acceso completo. Primero mira tus resultados y tus puntos débiles para no estudiar a ciegas.', 'Você já tem acesso completo. Primeiro veja seus resultados e pontos fracos pra não estudar às cegas.', 'Bạn đã có toàn quyền truy cập. Trước tiên hãy xem kết quả và điểm yếu để khỏi học mò.', 'Akses penuh sudah di tanganmu. Pertama lihat hasil dan titik lemahmu agar tidak belajar buta.', 'Tam erişim artık sende. Önce sonuçlarına ve zayıf noktalarına bak ki körlemesine çalışmayasın.', 'Pełny dostęp już masz. Najpierw zajrzyj do swoich wyników i słabych miejsc, żeby nie uczyć się w ciemno.') },
];
