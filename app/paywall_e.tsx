...
export function PaywallEView({ entry }: { readonly entry: PaywallEntry }) {
...
export default function PaywallERoute() {
  return <DirectPaywallRoute render={(entry) => <PaywallEView entry={entry} />} />;
}
