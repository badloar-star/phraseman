...
const STR = {
  ...
  en: {
    title: 'Flashcards', empty: 'No cards', emptySub: 'Add cards or choose another category',
    done: 'All cards reviewed!', doneSub: 'Great work', restart: 'Start over',
    cardOf: (a: number, b: number) => `${a} / ${b}`,
    tapFlip: 'Tap to flip', delete: 'Delete',
    deleteConfirm: 'Delete card?', deleteConfirmSub: 'It will be deleted.',
    cancel: 'Cancel', back: 'Back',
    editFront: 'English side', editBack: 'Translation', next: 'Next →',
    save: 'Save', editCard: 'Edit card', newCard: 'New card',
    systemCannotDelete: 'System cards cannot be deleted',
    enterEN: 'Enter English text...', enterRU: 'Enter translation...',
    noDelete: 'This is a system card',
    source: { lesson: 'Lesson', word: 'Word', verb: 'Verb', dialog: 'Dialog' },
  },
  uk: {
