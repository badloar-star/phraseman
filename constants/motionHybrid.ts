...
export const MAX_CALL_HYBRID = {
  ...
  breathHalfMs: 1500,
  settleMs: 200,
  // Уровень аудио приходит раз в 250 мс. Переходы длиннее одного тика,
  // поэтому новая цель продолжает прежнее движение, а не выглядит ударом
  // на каждом слове. Амплитуда 8% оставляет ауру живой, но не дёргает героя.
  micPulseMax: 0.08,
  micAttackMs: 480,
  micReleaseMs: 720,
  micResetMs: 160,
