...
interface LeagueArenaSceneProps {
  lang: Lang;
  ...
  return (
    ...
    >
      ...
      <Animated.View style={{ transform: [{ translateY: floatY }] }}>
        <View style={styles.emblemSlot} testID="league-arena-emblem">
          {leagueIcon}
        </View>
      </Animated.View>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Text numberOfLines={1} style={[styles.personName, { color: palette.text }]}>{displayName}</Text>
...
export const LeagueArenaScene = memo(LeagueArenaSceneComponent);
