...
export const MEDAL_TOAST_THEME_STYLES: Record<ThemeMode, MedalToastThemeStyle> = {
  ...
  compass: {
    signature: 'compass-onboarding-warm',
    cardBgColors: ['rgba(23,20,16,0.97)', 'rgba(2,3,4,0.97)'],
    borderColor: 'rgba(242,196,141,0.28)',
    titleColor: '#FFF8E8',
    subtitleColor: 'rgba(188,216,210,0.76)',
    surfaceAccent: '#F2C48D',
    badgeDownColor: '#F2C48D',
    topShineColors: ['rgba(242,196,141,0)', 'rgba(242,196,141,0.56)', 'rgba(242,196,141,0)'],
    topShineOpacity: 0.72,
    haloOpacity: 0.24,
    auraColor: 'rgba(242,196,141,0.13)',
    medalPlateBg: 'rgba(242,196,141,0.07)',
    medalPlateBorder: 'rgba(242,196,141,0.22)',
    textureColor: 'rgba(167,255,242,0.055)',
    textureOpacity: 0.52,
    tierAccents: {
      bronze: '#F2C48D',
      silver: '#8FEFE1',
    ...
    tierGlows: {
      bronze: 'rgba(242,196,141,0.30)',
      silver: 'rgba(143,239,225,0.30)',
      gold: 'rgba(242,196,141,0.34)',
    },
  },
  midnight: {
  ...
  ember: {
    ...
    borderColor: 'rgba(255,162,69,0.28)',
    titleColor: '#FFFFFF',
    subtitleColor: 'rgba(255,255,255,0.74)',
    surfaceAccent: '#FFA245',
    badgeDownColor: '#FFA245',
    topShineColors: ['rgba(255,162,69,0)', 'rgba(255,162,69,0.56)', 'rgba(255,162,69,0)'],
    topShineOpacity: 0.72,
    haloOpacity: 0.24,
    auraColor: 'rgba(255,138,42,0.14)',
    medalPlateBg: 'rgba(255,162,69,0.07)',
    medalPlateBorder: 'rgba(255,162,69,0.22)',
  ...
  volt: {
    ...
    titleColor: '#FFFFFF',
    subtitleColor: 'rgba(255,255,255,0.74)',
    surfaceAccent: '#D6FF3D',
    badgeDownColor: '#D6FF3D',
    topShineColors: ['rgba(214,255,61,0)', 'rgba(214,255,61,0.56)', 'rgba(214,255,61,0)'],
    topShineOpacity: 0.72,
    haloOpacity: 0.24,
    auraColor: 'rgba(184,242,34,0.14)',
    medalPlateBg: 'rgba(214,255,61,0.07)',
    medalPlateBorder: 'rgba(214,255,61,0.22)',
    ...
    tierGlows: {
      bronze: 'rgba(168,212,20,0.3)',
      silver: 'rgba(234,255,140,0.3)',
