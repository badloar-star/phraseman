...
Generated: 2026-05-17T14:43:05.709Z
Activation ready: no
...
- Files scanned: 580
- triLang calls: 1511
- Static triLang calls: 1493
- Dynamic triLang calls: 18
- triLang missing locale units: 2060
- triLang calls missing all planned locales: 412
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 412
- dynamic-trilang-copy: 18
...
- components/LeagueBonusAvailableModal.tsx: 9 findings, 45 missing locale units
- components/LeagueChestOpenModal.tsx: 9 findings, 45 missing locale units
...
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:321 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Топ-100 арени', ru: 'Топ-100 арены', es: 'Top 100 de la Arena', }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:350 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Оновити', ru: 'Обновить', es: 'Actualizar' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:358 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Рейтинг доступний лише з увімкненою синхронізацією.', ru: 'Рейтинг доступен только при включённой синхронизации.', es: 'La clasificación solo está disponible con la sincroni
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:393 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Поки що порожньо. Зіграй дуелі, щоб з\'явитися в рейтингу.', ru: 'Пока пусто. Сыграй дуэли, чтобы попасть в рейтинг.', es: 'Por ahora la clasificación está vacía. Juega part
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:415 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Учасник', ru: 'Участник', es: 'Participante' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:429 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Звання', ru: 'Звание', es: 'Rango' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:533 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Місце', ru: 'Место', es: 'Puesto' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:533 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'рів.', ru: 'ур.', es: 'nv.' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:539 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Ви', ru: 'Вы', es: 'Tú' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:626 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Ви', ru: 'Вы', es: 'Tú' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:634 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Ви', ru: 'Вы', es: 'Tú' }
- [warning] trilang-missing-all-planned-locales app/arena_leaderboard.tsx:647 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: `Топ ${100 - arenaXpPercentile}% в арене`, uk: `Топ ${100 - arenaXpPercentile}% в арені`, es: `Top ${100 - arenaXpPercentile}% en arena`, }
- [warning] trilang-missing-all-planned-locales app/arena_rating.tsx:47 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: RANK_NAMES[tier], uk: RANK_NAMES_UK[tier], es: RANK_NAMES_ES[tier] }
- [warning] trilang-missing-all-planned-locales app/arena_rating.tsx:84 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: match.won ? 'Победа' : 'Поражение', uk: match.won ? 'Перемога' : 'Поразка', es: match.won ? 'Victoria' : 'Derrota', }
- [warning] trilang-missing-all-planned-locales app/arena_rating.tsx:228 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: 'Арена', uk: 'Арена', es: 'Arena' }
- [warning] trilang-missing-all-planned-locales app/arena_rating.tsx:249 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: 'Все ранги арены', uk: 'Усі ранги арени', es: 'Todos los rangos de la arena', }
- [warning] trilang-missing-all-planned-locales app/arena_rating.tsx:284 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: `${myXP} XP · ${n} игр`, uk: `${myXP} XP · ${n} ігор`, es: `${myXP} XP · ${n} ${n === 1 ? 'duelo' : 'duelos'}`, }
