...
<div class="wrap">
  ...
  <b>114 правок в коде</b> — помечены «сделано», включая 7 находок самопроверки:
  перечитал свою же ночную работу и нашёл обрезающуюся кнопку, вводящий в
  заблуждение заголовок тоста и семь пропущенных «Дальше». Ещё 21 мест
  разобраны и оставлены как есть — там указано почему. 5 ждут: файл главного
  экрана правит другая сессия. Ошибок типов по всему проекту: ноль.</p>
