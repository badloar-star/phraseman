...
function personalPlanSetupMinutes(lang: Lang): PersonalPlanSetupMinuteChoice[] {
  return [
    {
      id: 5,
      title: triLang(lang, { ru: '5 минут в день', uk: '5 хвилин на день', es: '5 minutos al día', en: '5 minutes a day', 'pt-BR': '5 minutos por dia', vi: '5 phút mỗi ngày', id: '5 menit sehari', tr: 'Günde 5 dakika', pl: '5 minut dziennie' }),
      subtitle: triLang(lang, { ru: '2–4 задания. Лёгкий старт, без давления. Хорошо, если часто пропускаешь.', uk: '2–4 завдання. Легкий старт, без тиску. Добре, якщо часто пропускаєш.', es: '2–4 tareas. Inicio suave, sin presión. Ideal si sueles saltarte días.', en: '2–4 tasks. An easy start, no pressure. Good if you often skip days.', 'pt-BR': '2–4 tarefas. Início leve, sem pressão. Ideal se você costuma pular dias.', vi: '2–4 nhiệm vụ. Khởi đầu nhẹ nhàng, không áp lực. Tốt nếu bạn hay bỏ lỡ.', id: '2–4 tugas. Awal yang ringan, tanpa tekanan. Cocok jika sering terlewat.', tr: '2–4 görev. Baskısız, hafif bir başlangıç. Sık atlıyorsan iyi bir seçim.', pl: '2–4 zadania. Lekki start, bez presji. Dobre, jeśli często pomijasz dni.' }),
      icon: 'flash-outline',
      emoji: '⚡',
    },
    {
      id: 10,
      title: triLang(lang, { ru: '10 минут в день', uk: '10 хвилин на день', es: '10 minutos al día', en: '10 minutes a day', 'pt-BR': '10 minutos por dia', vi: '10 phút mỗi ngày', id: '10 menit sehari', tr: 'Günde 10 dakika', pl: '10 minut dziennie' }),
      subtitle: triLang(lang, { ru: '3–5 заданий. Баланс между прогрессом и нагрузкой. Хороший выбор на старте.', uk: '3–5 завдань. Баланс між прогресом і навантаженням. Гарний вибір на старті.', es: '3–5 tareas. Equilibrio entre progreso y esfuerzo. Buena opción para empezar.', en: '3–5 tasks. A balance of progress and effort. A good choice to start with.', 'pt-BR': '3–5 tarefas. Equilíbrio entre progresso e esforço. Boa opção para começar.', vi: '3–5 nhiệm vụ. Cân bằng giữa tiến độ và khối lượng. Lựa chọn tốt để bắt đầu.', id: '3–5 tugas. Keseimbangan progres dan beban. Pilihan bagus untuk memulai.', tr: '3–5 görev. İlerleme ve yük arasında denge. Başlamak için iyi bir seçim.', pl: '3–5 zadań. Równowaga między postępem a obciążeniem. Dobry wybór na start.' }),
      icon: 'book-outline',
      emoji: '📖',
    },
    {
      id: 15,
      title: triLang(lang, { ru: '15 минут в день', uk: '15 хвилин на день', es: '15 minutos al día', en: '15 minutes a day', 'pt-BR': '15 minutos por dia', vi: '15 phút mỗi ngày', id: '15 menit sehari', tr: 'Günde 15 dakika', pl: '15 minut dziennie' }),
      subtitle: triLang(lang, { ru: '4–5 заданий. Плотная ежедневная тренировка с ощутимым прогрессом.', uk: '4–5 завдань. Щільне щоденне тренування з відчутним прогресом.', es: '4–5 tareas. Entrenamiento diario intenso con progreso notable.', en: '4–5 tasks. A solid daily workout with noticeable progress.', 'pt-BR': '4–5 tarefas. Treino diário intenso com progresso notável.', vi: '4–5 nhiệm vụ. Luyện tập hàng ngày dày dặn với tiến bộ rõ rệt.', id: '4–5 tugas. Latihan harian yang padat dengan progres nyata.', tr: '4–5 görev. Belirgin ilerleme sağlayan yoğun günlük antrenman.', pl: '4–5 zadań. Intensywny codzienny trening z wyraźnym postępem.' }),
      icon: 'mic-outline',
      emoji: '🎯',
    },
    {
      id: 20,
      title: triLang(lang, { ru: '20 минут в день', uk: '20 хвилин на день', es: '20 minutos al día', en: '20 minutes a day', 'pt-BR': '20 minutos por dia', vi: '20 phút mỗi ngày', id: '20 menit sehari', tr: 'Günde 20 dakika', pl: '20 minut dziennie' }),
      subtitle: triLang(lang, { ru: '5–6 заданий. Полный дневной блок для тех, кто хочет расти быстро.', uk: '5–6 завдань. Повний денний блок для тих, хто хоче зростати швидко.', es: '5–6 tareas. Bloque diario completo para quienes quieren avanzar rápido.', en: '5–6 tasks. A full daily block for those who want to progress fast.', 'pt-BR': '5–6 tarefas. Bloco diário completo para quem quer avançar rápido.', vi: '5–6 nhiệm vụ. Khối luyện tập trọn ngày cho ai muốn tiến bộ nhanh.', id: '5–6 tugas. Blok harian penuh untuk yang ingin berkembang cepat.', tr: '5–6 görev. Hızlı ilerlemek isteyenler için tam günlük blok.', pl: '5–6 zadań. Pełny dzienny blok dla tych, którzy chcą szybko rosnąć.' }),
      icon: 'map-outline',
      emoji: '🚀',
    },
  ];
...
function planReason(planId: PersonalPlanId, lang: Lang): string {
  switch (planId) {
    case 'voyazh': return triLang(lang, { ru: 'Каждый день — живой диалог поездки: услышал, понял, ответил вслух.', uk: 'Кожен день — живий діалог подорожі: почув, зрозумів, відповів уголос.', es: 'Cada día, un diálogo real de viaje: escuchas, entiendes, respondes en voz alta.', en: 'Every day, a real travel dialogue: you hear it, understand it, answer out loud.', 'pt-BR': 'Todo dia, um diálogo real de viagem: você ouve, entende, responde em voz alta.', vi: 'Mỗi ngày — một đoạn hội thoại du lịch thật: nghe, hiểu, trả lời thành tiếng.', id: 'Setiap hari — dialog perjalanan nyata: mendengar, memahami, menjawab dengan suara.', tr: 'Her gün gerçek bir seyahat diyaloğu: duyarsın, anlarsın, sesli cevap verirsin.', pl: 'Każdego dnia — żywy dialog podróży: usłyszałeś, zrozumiałeś, odpowiedziałeś na głos.' });
    case 'mitap': return triLang(lang, { ru: 'Спокойный микс для себя: слова, слух и речь — понемногу каждый день.', uk: 'Спокійний мікс для себе: слова, слух і мова — потроху щодня.', es: 'Una mezcla tranquila para ti: palabras, oído y habla, poco a poco cada día.', en: 'A calm mix just for you: words, listening and speaking, a little every day.', 'pt-BR': 'Uma mistura tranquila para você: palavras, ouvido e fala, aos poucos todo dia.', vi: 'Sự kết hợp thư thái cho riêng bạn: từ vựng, nghe và nói — từng chút mỗi ngày.', id: 'Campuran santai untukmu: kata, pendengaran, dan bicara — sedikit demi sedikit setiap hari.', tr: 'Kendin için sakin bir karışım: kelimeler, dinleme ve konuşma — her gün azar azar.', pl: 'Spokojny mix dla siebie: słowa, słuch i mowa — po trochu każdego dnia.' });
    case 'gavan': return triLang(lang, { ru: 'Нужные слова на каждый день — и каждое сразу звучит вслух.', uk: 'Потрібні слова на кожен день — і кожне одразу звучить уголос.', es: 'Las palabras que necesitas cada día, y cada una suena en voz alta al instante.', en: 'The words you need every day — and each one is spoken out loud right away.', 'pt-BR': 'As palavras que você precisa todo dia, e cada uma soa em voz alta na hora.', vi: 'Những từ cần thiết mỗi ngày — và mỗi từ được nói to ngay lập tức.', id: 'Kata-kata yang dibutuhkan setiap hari — dan langsung diucapkan.', tr: 'Her gün için gerekli kelimeler — ve her biri hemen sesli söylenir.', pl: 'Potrzebne słowa na każdy dzień — i każde od razu wypowiadane na głos.' });
    case 'impuls': return triLang(lang, { ru: 'Понимаешь, но зависаешь перед ответом? Здесь тренируется речь вслух.', uk: 'Розумієш, але зависаєш перед відповіддю? Тут тренується мова вголос.', es: '¿Entiendes pero te bloqueas al responder? Aquí se entrena el habla en voz alta.', en: 'You understand but freeze up before answering? This trains speaking out loud.', 'pt-BR': 'Entende mas trava na hora de responder? Aqui se treina a fala em voz alta.', vi: 'Hiểu nhưng lại khựng lại trước khi trả lời? Ở đây luyện nói thành tiếng.', id: 'Mengerti tapi macet sebelum menjawab? Di sini melatih bicara dengan suara.', tr: 'Anlıyorsun ama cevap vermeden önce takılıyor musun? Burada sesli konuşma antrenmanı yapılır.', pl: 'Rozumiesz, ale zawieszasz się przed odpowiedzią? Tu trenuje się mowę na głos.' });
    case 'echo': return triLang(lang, { ru: 'Понимать живую речь с первого раза — и отвечать без долгой паузы.', uk: 'Розуміти живу мову з першого разу — і відповідати без довгої паузи.', es: 'Entender el habla real a la primera y responder sin largas pausas.', en: 'Understand real speech the first time — and reply without a long pause.', 'pt-BR': 'Entender a fala real de primeira e responder sem pausas longas.', vi: 'Hiểu lời nói thật ngay từ lần đầu — và trả lời không cần ngừng lâu.', id: 'Memahami percakapan nyata sejak awal — dan menjawab tanpa jeda lama.', tr: 'Gerçek konuşmayı ilk seferde anlamak — ve uzun duraklamadan cevap vermek.', pl: 'Rozumieć żywą mowę za pierwszym razem — i odpowiadać bez długiej pauzy.' });
    default: return triLang(lang, { ru: 'Подходит под выбранный старт и ближайшую цель.', uk: 'Підходить під обраний старт і найближчу ціль.', es: 'Se ajusta al punto de partida elegido y tu próximo objetivo.', en: 'Fits the starting point you chose and your nearest goal.', 'pt-BR': 'Se ajusta ao ponto de partida escolhido e ao seu próximo objetivo.', vi: 'Phù hợp với điểm khởi đầu đã chọn và mục tiêu gần nhất.', id: 'Sesuai dengan titik awal yang dipilih dan tujuan terdekat.', tr: 'Seçilen başlangıca ve en yakın hedefe uygundur.', pl: 'Pasuje do wybranego startu i najbliższego celu.' });
  }
}

function planTagline(planId: PersonalPlanId, lang: Lang): string {
  switch (planId) {
    case 'voyazh': return triLang(lang, { ru: '🗺️ Путешествия и дорога', uk: '🗺️ Подорожі та дорога', es: '🗺️ Viajes y camino', en: '🗺️ Travel and the road', 'pt-BR': '🗺️ Viagens e estrada', vi: '🗺️ Du lịch và trên đường', id: '🗺️ Perjalanan dan jalan', tr: '🗺️ Seyahat ve yol', pl: '🗺️ Podróże i droga' });
    case 'mitap': return triLang(lang, { ru: '🧠 Язык для ума', uk: '🧠 Мова для розуму', es: '🧠 Idioma para la mente', en: '🧠 Language for the mind', 'pt-BR': '🧠 Idioma para a mente', vi: '🧠 Ngôn ngữ cho trí óc', id: '🧠 Bahasa untuk pikiran', tr: '🧠 Zihin için dil', pl: '🧠 Język dla umysłu' });
    case 'gavan': return triLang(lang, { ru: '📦 Запас нужных слов', uk: '📦 Запас потрібних слів', es: '📦 Vocabulario esencial', en: '📦 Essential vocabulary', 'pt-BR': '📦 Vocabulário essencial', vi: '📦 Vốn từ cần thiết', id: '📦 Perbekalan kosakata', tr: '📦 Gerekli kelime dağarcığı', pl: '📦 Zapas potrzebnych słów' });
    case 'impuls': return triLang(lang, { ru: '💬 Живое общение', uk: '💬 Живе спілкування', es: '💬 Comunicación real', en: '💬 Real conversation', 'pt-BR': '💬 Comunicação real', vi: '💬 Giao tiếp thực tế', id: '💬 Komunikasi nyata', tr: '💬 Canlı iletişim', pl: '💬 Żywa komunikacja' });
    case 'echo': return triLang(lang, { ru: '🎬 Кино и сериалы', uk: '🎬 Кіно та серіали', es: '🎬 Cine y series', en: '🎬 Movies and shows', 'pt-BR': '🎬 Cinema e séries', vi: '🎬 Phim và series', id: '🎬 Film dan serial', tr: '🎬 Film ve diziler', pl: '🎬 Filmy i seriale' });
    default: return triLang(lang, { ru: '📚 Общее развитие', uk: '📚 Загальний розвиток', es: '📚 Desarrollo general', en: '📚 General development', 'pt-BR': '📚 Desenvolvimento geral', vi: '📚 Phát triển chung', id: '📚 Pengembangan umum', tr: '📚 Genel gelişim', pl: '📚 Ogólny rozwój' });
  }
}
...
// ─── Main screen ───────────────────────────────────────────────────────────
function PersonalPlanSetupScreen() {
  const { lang } = useLang();
  ...
  useEffect(() => {
    ...
    let alive = true;
    void readAnyPersonalPlanState().then((state) => {
  ...
  const activate = async (planId: PersonalPlanId) => {
    hapticTap();
    // Re-check the durable account-scoped grandfather record on every tap. This
    // prevents stale setup UI (or a deadline race) from opening a retired paywall
    // or creating a first plan for an ineligible account.
  ...
  const renderQuestion = (
    ...
    <Animated.View style={{ opacity: slideFade, transform: [{ translateX: slideX }] }}>
      <Text style={[styles.stepKicker, { color: accent }]}>{triLang(lang, { ru: `Шаг ${stepIndex(step)} из ${TOTAL_STEPS}`, uk: `Крок ${stepIndex(step)} з ${TOTAL_STEPS}`, es: `Paso ${stepIndex(step)} de ${TOTAL_STEPS}`, en: `Step ${stepIndex(step)} of ${TOTAL_STEPS}`, 'pt-BR': `Passo ${stepIndex(step)} de ${TOTAL_STEPS}`, vi: `Bước ${stepIndex(step)}/${TOTAL_STEPS}`, id: `Langkah ${stepIndex(step)} dari ${TOTAL_STEPS}`, tr: `Adım ${stepIndex(step)}/${TOTAL_STEPS}`, pl: `Krok ${stepIndex(step)} z ${TOTAL_STEPS}` })}</Text>
      <Text
  ...
  const content = (() => {
    if (step === 'goal') {
      return renderQuestion(
        triLang(lang, { ru: 'Зачем тебе английский?', uk: 'Навіщо тобі англійська?', es: '¿Para qué necesitas el inglés?', en: 'Why do you need English?', 'pt-BR': 'Para que você precisa do inglês?', vi: 'Bạn học tiếng Anh để làm gì?', id: 'Untuk apa kamu belajar bahasa Inggris?', tr: 'İngilizceye neden ihtiyacın var?', pl: 'Po co potrzebujesz angielskiego?' }),
        triLang(lang, { ru: 'Это определяет ситуации и фразы, которые пригодятся первыми.', uk: 'Це визначає ситуації та фрази, які знадобляться першими.', es: 'Esto determina las situaciones y frases que necesitarás primero.', en: 'This shapes the situations and phrases you’ll need first.', 'pt-BR': 'Isso determina as situações e frases que você vai precisar primeiro.', vi: 'Điều này quyết định tình huống và cụm từ bạn cần trước tiên.', id: 'Ini menentukan situasi dan frasa yang paling dulu dibutuhkan.', tr: 'Bu, önce ihtiyaç duyacağın durumları ve ifadeleri belirler.', pl: 'To określa sytuacje i zwroty, które przydadzą się jako pierwsze.' }),
...
export default withPersonalPlanSunsetGuard(PersonalPlanSetupScreen);
