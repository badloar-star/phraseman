...
//
// РАСХОЖДЕНИЕ СО СПЕЦИФИКАЦИЕЙ, разрешённое в пользу владельца:
// docs/v2/03 в списке фраз E1 прямо называет «My name is …» и «I’m from …».
// Владелец запретил обе формулировки лично и позже спецификации, поэтому здесь
// они заменены живыми эквивалентами того же can-do:
//   • назвать себя      → «I’m Anna» вместо «My name is Anna»;
...
exports.EPISODE_01_SESSION_01_PHRASES = void 0;
/**
 ...
 * со своим интро.
 */
exports.EPISODE_01_SESSION_01_PHRASES = Object.freeze([
    {
        id: 'e01-s01-i-am-here',
        english: 'I am here',
        russian: 'Я здесь',
        explanation: 'Первая полная фраза: «я» + глагол-связка + место. В русском связки нет — мы говорим «я здесь». В английском она обязательна: без am предложение разваливается.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am ready',
        russian: 'Я готов',
        explanation: 'Та же опора «I am», но дальше идёт признак, а не место. Живая фраза: так отвечают, когда можно начинать — перед выходом, звонком, игрой.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am cold',
        russian: 'Мне холодно',
        explanation: 'Обратите внимание на разницу: по-русски «мне холодно», по-английски «я холодный». Англичанин делает себя подлежащим, а не тем, кому холодно.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        russian: 'Я не уверен',
        explanation: 'Первое отрицание. Not ставится сразу после am — это единственное место. Фраза выручает постоянно: так честно говорят, когда не знают ответа.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am tired',
        russian: 'Я устал',
        explanation: 'Одна из самых частых фраз о состоянии. В английском устаёшь «быть уставшим»: I am tired, а не «я устал» через действие. Работает и для мужчины, и для женщины — форма не меняется.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am hungry',
        russian: 'Я голоден',
        explanation: 'В английском голод — это состояние, в котором ты находишься: «я есть голодный». Поэтому нужна связка am, а не глагол «хотеть».',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        explanation: 'Отрицание на уже знакомой фразе: not встаёт сразу после am, остальное не меняется. Так работает любое отрицание со связкой.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am OK',
        russian: 'Я в порядке',
        explanation: 'Так отвечают, когда спрашивают, всё ли хорошо. Короткий honest-ответ, живее книжного «I am fine, thank you». OK пишут заглавными или okay — оба варианта нормальны.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am happy',
        russian: 'Я рад',
        explanation: 'Ещё один признак после «I am». Форма слова не зависит от того, мужчина говорит или женщина, — в английском признаки не меняются по родам.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        russian: 'Я не готов',
        explanation: 'Третье отрицание подряд — правило закрепляется. Заметьте: порядок слов ни разу не поменялся, меняется только последнее слово.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am late',
        russian: 'Я опаздываю',
        explanation: 'Ещё одно состояние через связку. По-русски мы говорим действием — «опаздываю», по-английски признаком: «я есть поздний». Так предупреждают, что задерживаешься.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am busy',
        russian: 'Я занят',
        explanation: 'Вежливый способ сказать, что сейчас не получится поговорить. Форма одна и для мужчины, и для женщины.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am home',
        russian: 'Я дома',
        explanation: 'Снова признак места, как в самой первой фразе урока, только теперь это home — «дома». Так пишут родным, когда добрались.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am fine',
        russian: 'Я в порядке',
        explanation: 'Ещё один честный короткий ответ, вместе с уже знакомым I am OK. Fine и OK значат почти одно и то же — оба говорят каждый день.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
    ...
    },
    {
        ...
        english: 'I am hot',
        russian: 'Мне жарко',
        explanation: 'Противоположность I am cold из этого же урока. По-русски снова «мне жарко», по-английски — «я горячий/жаркий». Один и тот же приём, другой признак.',
        words: [
            {
                correct: 'I',
                category: 'pronoun',
...
//# sourceMappingURL=episode_01_source_v1.js.map