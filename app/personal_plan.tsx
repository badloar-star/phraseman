...
function resolvePlanChrome(themeMode: ThemeMode, t: ReturnType<typeof useTheme>['theme']): PlanChrome {
  ...
  if (themeMode === 'sagePorcelain') return { ...base, bg: ['#F0F1EC', '#E1E5DC', '#D1D9D1'], card: ['#FCFDF9', '#F0F1EC'], hero: ['#E1E5DC', '#F0F1EC'], accent: '#315F50', accent2: '#52605A', accentSoft: '#DCEADF', border: '#CFD6CE', text: '#17201D', muted: '#52605A', ghost: '#61706A', buttonText: '#FFFFFF', taskSurface: '#E1E5DC' };
