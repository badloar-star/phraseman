# Deep Lesson Content Audit (2026-05-16)
...
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1108: ru prompt has Latin tokens [good]: Лучше (сравн. от good)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1108: uk prompt has Latin tokens [good]: Краще (від good)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1109: ru prompt has Latin tokens [bad]: Хуже (сравн. от bad)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1109: uk prompt has Latin tokens [bad]: Гірше (від bad)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1498: ru prompt has Latin tokens [he, she]: Был (для I/he/she/it)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1499: ru prompt has Latin tokens [we, they]: Были (для you/we/they)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1702: ru prompt has Latin tokens [ame]: Археолог (AmE)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:1702: uk prompt has Latin tokens [ame]: Археолог (AmE)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:265: ru prompt has Latin tokens [he, she]: нужно / приходится (he/she/it)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:265: uk prompt has Latin tokens [he, she]: потрібно / доводиться (he/she/it)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:271: ru prompt has Latin tokens [he, she]: нужно / необходимо (he/she/it)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:271: uk prompt has Latin tokens [he, she]: потрібно / необхідно (he/she/it)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:949: ru prompt has Latin tokens [off]: Выключил(а) (с off) / повернул(а)
- **LOW WORD_PROMPT_HAS_LATIN_REVIEW** app/lesson_words.tsx:949: uk prompt has Latin tokens [off]: Вимкнув(ла) (з off) / повернув(ла)
...
- **LOW WORD_SAME_EN_DIFFERENT_POS_REVIEW** call: call appears as multiple POS: verbs, nouns in lessons 3, 4, 6, 11, 13, 17, 18
- **LOW WORD_SAME_EN_DIFFERENT_POS_REVIEW** clean: clean appears as multiple POS: adjectives, verbs in lessons 9, 17, 18
...
- **LOW WORD_SAME_EN_DIFFERENT_POS_REVIEW** order: order appears as multiple POS: verbs, nouns in lessons 3, 6, 11, 17, 21, 29
...
- **LOW WORD_SAME_EN_DIFFERENT_POS_REVIEW** work: work appears as multiple POS: verbs, nouns in lessons 3, 4, 11, 17, 18
