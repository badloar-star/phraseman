...
import { loadApprovedTopicGrounding, loadQuestionBatchForReview, loadQuestionReplacementForReview, type StudioGroundingBucketLike } from './quiz_challenge_grounding';
...
describe('approved quiz/challenge topic grounding', () => {
  ...
  const metadata = { stageId: 'topic-stage', artifactId: 'topic-artifact', kind: 'quiz_topic', state: 'approved', cefr: 'A2', objectPath: 'topic.json', contentHash, objectGeneration: '5' } as const;
