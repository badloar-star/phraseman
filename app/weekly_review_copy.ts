...
export function weeklyReviewCopy(lang: Lang) {
  return {
    ...
    unavailable: L(lang, { ru: 'Сейчас обновить не удалось. Попробуй позже.', uk: 'Зараз оновити не вдалося. Спробуйте пізніше.', es: 'No se pudo actualizar. Inténtalo más tarde.', 'pt-BR': 'Não foi possível atualizar. Tente mais tarde.', vi: 'Chưa thể cập nhật. Hãy thử lại sau.', id: 'Belum dapat memperbarui. Coba lagi nanti.', tr: 'Şimdilik güncellenemedi. Daha sonra tekrar dene.', pl: 'Nie udało się odświeżyć. Spróbuj ponownie później.' }),
    unavailableWithCache: L(lang, { ru: 'Сейчас обновить не удалось — показываем прошлый разбор', uk: 'Зараз оновити не вдалося — показуємо попередній розбір', es: 'No se pudo actualizar; mostramos el análisis anterior', 'pt-BR': 'Não foi possível atualizar; mostramos a análise anterior', vi: 'Chưa thể cập nhật; đang hiển thị bản phân tích trước', id: 'Belum dapat memperbarui; menampilkan analisis sebelumnya', tr: 'Şimdilik güncellenemedi; önceki analiz gösteriliyor', pl: 'Nie udało się odświeżyć; pokazujemy poprzednią analizę' }),
