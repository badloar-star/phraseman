...
| Metric | Value |
| Files scanned | 1871 |
| Localized items | 117346 |
| Target localized items | 19813 |
| Target item share | 0.1688 |
| Field coverage gap files | 0 |
| Item coverage gap files | 0 |
| HTML coverage backlog files | 0 |
| HTML partial coverage files | 6 |
...
| File | Surface | Reason |
| admin/index.html | admin-site | Partial HTML es coverage: 25/737 source item(s). |
| knowly-www/download/index.html | public-web | Partial HTML es coverage: 18/40 source item(s). |
| knowly-www/index.html | public-web | Partial HTML es coverage: 16/35 source item(s). |
| knowly-www/contact/index.html | public-web | Partial HTML es coverage: 30/43 source item(s). |
| admin/support.html | admin-site | Partial HTML es coverage: 3/11 source item(s). |
| duel/index.html | app-other | Partial HTML es coverage: 2/3 source item(s). |
