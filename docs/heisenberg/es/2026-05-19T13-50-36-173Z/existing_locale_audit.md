...
| Metric | Value |
| Files scanned | 1871 |
| Localized items | 117359 |
| Target localized items | 19828 |
| Target item share | 0.169 |
| Field coverage gap files | 0 |
| Item coverage gap files | 0 |
| HTML coverage backlog files | 0 |
| HTML partial coverage files | 4 |
...
| knowly-www/download/index.html | public-web | Partial HTML es coverage: 24/38 source item(s). |
