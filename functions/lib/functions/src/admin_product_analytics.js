...
exports.hasProductAnalyticsAuth = hasProductAnalyticsAuth;
exports.validatedAnalyticsDatasetTable = validatedAnalyticsDatasetTable;
...
exports.handleAdminProductAnalytics = handleAdminProductAnalytics;
const bigquery_1 = require("@google-cloud/bigquery");
const https_1 = require("firebase-functions/v2/https");
const callable_options_1 = require("./callable_options");
const REGION = 'us-central1';
const CACHE_TTL_MS = 10 * 60 * 1000;
const MAXIMUM_BYTES_BILLED = 5000000000;
...
function hasProductAnalyticsAuth(auth) {
...
function validatedAnalyticsDatasetTable(value) {
...
function buildProductAnalyticsAggregateQuery() {
...
function parsePayload(row) {
    try {
        return typeof row.payload === 'string' ? JSON.parse(row.payload) : null;
    }
    catch {
        return null;
    }
...
async function loadProductAnalyticsAggregateRows(input) {
    ...
    try {
        ...
        throw new https_1.HttpsError('invalid-argument', 'Invalid IANA reporting timezone');
    }
...
async function handleAdminProductAnalytics(request) {
