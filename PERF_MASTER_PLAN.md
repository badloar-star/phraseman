...
- 🔄 **B5/B6** (тихая ревалидация + скелетоны) — в работе.
- 📋 Осталось: C3 (после устройства), D3 (FlashList: лента друзей, ачивки), D4 (разбиение lesson_help 20k строк, home, arena_lobby), D5 (friends_screen дубль?), догард legacy-хвоста анимаций (см. allowlist в perf_freeze_contract), B7 (расширение app_snapshot на остальные экраны).
