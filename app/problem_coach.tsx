...
const styles = StyleSheet.create({
  ...
  infoBox: { borderWidth: 0, borderRadius: 14, padding: 14, gap: 8 },
  ...
  feedbackBox: { borderWidth: 0, borderRadius: 16, padding: 14, flexDirection: 'row', gap: 12 },
  feedbackIconBox: {
    width: 46,
    height: 46,
    borderRadius: 14,
  ...
  tipBox: { borderWidth: 0, borderRadius: 16, padding: 12, flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
