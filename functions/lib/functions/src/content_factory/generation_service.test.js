...
describe('language factory generation service', () => {
    it('builds a target-scoped strict JSON prompt from the server blueprint', () => {
        const prompt = (0, generation_service_1.buildLessonGenerationPrompt)({
    ...
    it('accepts only a complete lesson artifact shape', () => {
        const parsed = (0, generation_service_1.parseGeneratedLessonArtifact)(JSON.stringify({
            lessonId: 1,
        ...
        expect(() => (0, generation_service_1.parseGeneratedLessonArtifact)('{"lessonId":1,"phrases":[]}')).toThrow('generated_lesson_invalid');
    });
});
//# sourceMappingURL=generation_service.test.js.map