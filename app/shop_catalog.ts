 ...
 *
 * ЦЕНЫ. Руны стоят ВДВОЕ дороже ступеней бустов лиги (решение владельца 24.08):
 * руна зарабатывается и должна ощущаться весомее покупаемой жемчужины.
 * Соответствие живущим в коде механикам:
 *   • «Опыт ×2 · 1 час»    ← LEAGUE_PERSONAL_BOOSTS x2_30m/x2_1h
 *   • «Клубный буст ×2»    ← LEAGUE_GROUP_BOOST_COST_SHARDS (50 жемчужин → 100 рун)
 *   • «Полная энергия»     ← energyRefillShardCost
 *   • «Щит серии»          ← streak_freeze_cost_shards
