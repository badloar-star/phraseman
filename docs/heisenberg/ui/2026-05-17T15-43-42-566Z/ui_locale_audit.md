...
Generated: 2026-05-17T15:43:42.565Z
Activation ready: no
...
- triLang missing locale units: 455
- triLang calls missing all planned locales: 91
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 91
...
- [warning] trilang-missing-all-planned-locales app/problem_coach.tsx:437 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: 'Готово', uk: 'Готово', es: 'Listo' }
