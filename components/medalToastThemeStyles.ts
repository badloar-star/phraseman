...
export const MEDAL_TOAST_THEME_STYLES: Record<ThemeMode, MedalToastThemeStyle> = {
  ...
  vanilla: {
    signature: 'vanilla-paper-indigo',
    cardBgColors: ['rgba(255,253,244,0.98)', 'rgba(244,235,212,0.98)'],
    borderColor: 'rgba(61,78,143,0.24)',
    titleColor: '#2A2118',
    subtitleColor: 'rgba(111,99,80,0.80)',
    surfaceAccent: '#3D4E8F',
    badgeDownColor: '#9A8D76',
    topShineColors: ['rgba(61,78,143,0)', 'rgba(61,78,143,0.30)', 'rgba(61,78,143,0)'],
    topShineOpacity: 0.60,
    haloOpacity: 0.18,
    auraColor: 'rgba(61,78,143,0.08)',
    medalPlateBg: 'rgba(61,78,143,0.06)',
    medalPlateBorder: 'rgba(61,78,143,0.20)',
    textureColor: 'rgba(58,44,8,0.035)',
    textureOpacity: 0.40,
    tierAccents: DEFAULT_TIER_ACCENTS,
    tierGlows: {
      bronze: 'rgba(208,140,74,0.22)',
      silver: 'rgba(78,143,200,0.22)',
      gold: 'rgba(217,166,46,0.26)',
    },
  },
  dark: {
