// ════════════════════════════════════════════════════════════════════════════
// anim_demo_lab.tsx — production-safe gate.
//
// Реальный код (DEV-демо анимационного стека: FLIP/SHINE/BURST/кнопка) живёт в
// `_anim_demo_lab.tsx` (`_`-префикс → файл не считается роутом expo-router'ом
// и не доступен пользователю напрямую).
//
...
export default function AnimDemoLabGate() {
  if (__DEV__ && !IS_STORE_RELEASE) {
    ...
    const Real = require('./_anim_demo_lab').default;
    return <Real />;
  }
