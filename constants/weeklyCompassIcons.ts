...
export const WEEKLY_COMPASS_ICON_DALLE_PROMPTS: Record<ThemeMode, string> = {
  ...
  olive:
    "Centered sculptural 3D compass icon for a premium language-learning app, matte deep olive lacquer, restrained champagne metal needle, warm ivory reflection, transparent background, no text, logo, people, neon, or glowing rim.",
  sagePorcelain:
    "Centered sculptural 3D porcelain compass for a premium language-learning app, luminous ivory ceramic, pale sage celadon glaze, deep sage needle, restrained antique brass, transparent background, no text, no logo, no people.",
  midnight:
    "Centered 3D compass icon for a language learning app, black cinema finish, midnight indigo and violet glow, sharp luminous needle, premium object cutout, transparent background, no text, no letters, no logo, no hands, no map, soft studio rim light, 1024 square.",
  ember:
    "Centered 3D compass icon for a language learning app, black cinema finish, ember orange metal and smoked glass, warm luminous needle, premium object cutout, transparent background, no text, no letters, no logo, no hands, no map, soft studio rim light, 1024 square.",
  aurora:
    "Centered 3D compass icon for a language learning app, black cinema finish, aurora green and cyan glow, crystalline luminous needle, premium object cutout, transparent background, no text, no letters, no logo, no hands, no map, soft studio rim light, 1024 square.",
  ...
  indigo:
    "Centered 3D compass icon for a language learning app, dusk indigo enamel, soft lavender glow, premium object cutout, transparent background, no text, no letters, no logo, no hands, no map, soft studio rim light, 1024 square.",
};
...
const GENERATED_COMPASS_ICON_SOURCES: Partial<
...
export function weeklyCompassIconSource(
  themeMode: ThemeMode,
): ImageSourcePropType {
