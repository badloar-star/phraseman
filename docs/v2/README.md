...
> **32 урока × 56 учебных сессий**. Один урок раскрывается прямо в общем списке
> и показывает семь глав по восемь сессий. Сессия рассчитана на 5–8 минут;
> целевое среднее — 7 минут. Сессии 8/16/24/32/40/48 являются проверками главы,
...
> самодостаточным без них. Существующая функция Personal Plan сохраняется как
> отдельная необязательная специализация второй очереди; её карточки не
> вставляются в основную карту, а отдельный плановый пул не блокирует готовность
...
| Состав урока | 56 сессий по 5–8 минут, 7 глав × 8; шесть проверок главы и итоговый экзамен №56 |
