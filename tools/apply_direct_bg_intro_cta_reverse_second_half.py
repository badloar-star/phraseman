...
INTRO_VO = (
    "В этом видео тебя ждут больше четырёх часов английского методом цепочек. "
    "Мы не учим отдельные слова, мы собираем смысл: действие, причина, время, место. "
    "Смотри на экран, слушай ритм и повторяй вслух. "
    "А во второй части порядок изменится: русский перевод будет звучать первым, "
    "и ты будешь собирать английскую фразу уже в обратную сторону."
)

MID_VO = (
    "Во второй части всё будет наоборот. Сначала прозвучит русский перевод. "
    "Потом появится английская фраза и транскрипция, чтобы ты собрал смысл в обратную сторону."
)
