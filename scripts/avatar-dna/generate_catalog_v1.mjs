...
export const catalogV1 = {
  ...
  items: [
    ...
    ...irisEntries.map(([id, name], index) => item(id, 'face', [layer(`iris.${name}.mask`, 'iris', 76, 'iris-mask.webp', { clip: 'face.safe', tintFrom: 'irisColor' }), layer(`iris.${name}.shading`, 'iris', 76, 'iris-shading.webp', { clip: 'face.safe' })], { swatchHex: ['#5b341f','#7b6435','#46704c','#47749b','#6f777c','#a66b24'][index] })),
