  ...
  const rows: { icon: keyof typeof Ionicons.glyphMap; lit: boolean; title: string; sub: string }[] = [
    {
      ...
      sub: triLang(lang, {
        ...
        'pt-BR': 'Tudo liberado e sem limites. Nenhuma cobrança.',
        vi: 'Mở tất cả và không giới hạn. Không bị tính phí.',
        id: 'Semua terbuka dan tanpa batas. Nol tagihan.',
        tr: 'Her şey açık ve sınırsız. Sıfır ödeme.',
        pl: 'Wszystko otwarte i bez limitu. Zero opłat.',
      }),
    },
    {
      icon: 'notifications',
    ...
    },
    {
      ...
      title: triLang(lang, {
        ...
        'pt-BR': `Dia ${days}: acesso por ${priceLabel}${periodLabel}`,
        vi: `Ngày ${days}: truy cập với ${priceLabel}${periodLabel}`,
        id: `Hari ${days}: akses seharga ${priceLabel}${periodLabel}`,
        tr: `${days}. gün: ${priceLabel}${periodLabel} ile erişim`,
        pl: `Dzień ${days}: dostęp za ${priceLabel}${periodLabel}`,
      }),
      sub: triLang(lang, {
        ...
        'pt-BR': 'Só se você não cancelar. Cancelar leva dois toques.',
        vi: 'Chỉ khi bạn không hủy. Hủy chỉ mất hai lần chạm.',
        id: 'Hanya jika kamu tidak membatalkan. Batal dalam dua ketukan.',
        tr: 'Sadece iptal etmezsen. İptal iki dokunuş.',
        pl: 'Tylko jeśli nie anulujesz. Anulowanie to dwa stuknięcia.',
      }),
    },
  ];
