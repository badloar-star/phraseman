...
const styles = StyleSheet.create({
  ...
  progressCard: { marginHorizontal: 16, marginTop: 14, padding: 14, borderRadius: 16, borderWidth: 0, gap: 8 },
  ...
  premiumCta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginHorizontal: 16, marginTop: 12, paddingVertical: 12, borderRadius: 14, borderWidth: 0 },
  premiumCtaText: { fontWeight: '800' },
  scroll: { paddingHorizontal: 16, paddingTop: 14, gap: 8 },
  tierRow: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 8, borderRadius: 14, borderWidth: 0},
  ...
  rewardCell: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 9, borderRadius: 10, borderWidth: 0, minHeight: 40 },
