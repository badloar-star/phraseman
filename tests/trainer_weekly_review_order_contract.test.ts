...
describe('trainer weekly review placement', () => {
  ...
  it('embeds the weekly review inside mistake analytics for every tier', () => {
    const reviewIndex = source.indexOf('<WeeklyReviewCard active={trainerRuntimeActive} isPremium={hasPremium} studyTarget={studyTarget} stableLayout embedded />');
