...
export const LESSON4_THEORY: { titleRu: string; titleUk: string; sections: L1Section[] } = {
    ...
    // ───────────────────────── 01 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'I / You / We / They — don\'t + V', ru: 'отрицание с don\'t', uk: 'заперечення з don\'t', hi: 'don\'t' },
            { en: 'He / She / It — doesn\'t + V', ru: 'отрицание с doesn\'t', uk: 'заперечення з doesn\'t', hi: 'doesn\'t' },
          ],
        },
        {
          kind: 'tip',
        ...
        {
          kind: 'drill',
          drill: { type: 'choice', before: 'She', after: 'read books.', options: ['don\'t', 'doesn\'t'], answer: 'doesn\'t', why: { ru: 'She — это he/she/it, поэтому отрицание идёт через doesn\'t.' } },
        },
      ],
    },
    ...
    // ───────────────────────── 02 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'I don\'t work here.', ru: 'Утверждение: I work here.', uk: 'Ствердження: I work here.', hi: 'don\'t' },
            { en: 'She doesn\'t read.', ru: 'Утверждение: She reads books.', uk: 'Ствердження: She reads books.', hi: 'doesn\'t' },
            { en: 'They don\'t play.', ru: 'Утверждение: They play tennis.', uk: 'Ствердження: They play tennis.', hi: 'don\'t' },
          ],
        },
        {
          kind: 'fix',
        ...
        {
          kind: 'drill',
          drill: { type: 'spot_slip', chips: ['She', 'doesn\'t', 'reads'], answerIndex: 2, hint: { ru: 'Тут не та форма. Тапни лишнее слово.' }, fix: { ru: 'После doesn\'t глагол без -s: She doesn\'t read.' } },
        },
      ],
    },
    ...
    // ───────────────────────── 03 ─────────────────────────
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'examples',
          examples: [
            { en: 'Do + ... + V?', ru: 'вопрос с I / you / we / they', uk: 'питання з I / you / we / they', hi: 'Do' },
            { en: 'Does + ... + V?', ru: 'вопрос с he / she / it', uk: 'питання з he / she / it', hi: 'Does' },
          ],
        },
        {
          kind: 'tip',
        ...
        {
          kind: 'drill',
          drill: { type: 'binary', question: { ru: 'Где верно?' }, optionA: 'Does she works?', optionB: 'Does she work?', correct: 'B', explain: { ru: 'После Does глагол стоит в начальной форме, без -s.' } },
        },
        {
          kind: 'drill',
          drill: { type: 'word_bank', prompt: { ru: 'Спроси: «Ты работаешь здесь?»' }, answer: ['Do', 'you', 'work', 'here'], slotLabels: [{ ru: 'помощник' }, { ru: 'кто' }, { ru: 'глагол' }, { ru: 'где' }], distractors: ['Does', 'works'] },
        },
      ],
    },
  ],
