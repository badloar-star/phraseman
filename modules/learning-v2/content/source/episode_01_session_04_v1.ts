...
import { EPISODE_01_SESSION_04_MODE_NATIVE_PRACTICE_V1 } from './episode_01_session_04_mode_native_v1';
...
export const EPISODE_01_SESSION_04_SOURCE: SessionSource = Object.freeze({
  ...previous,
  generationInputFingerprint: 'owner-mode-native-you-are-word-first-e01-s04-v3',
  ...
  phrases: EPISODE_01_SESSION_04_READINESS_PHRASES,
  modeNativePlanId: LESSON1_SESSION_04_MODE_NATIVE_PLAN_ID_V1,
  modeNativePractice: EPISODE_01_SESSION_04_MODE_NATIVE_PRACTICE_V1,
});
