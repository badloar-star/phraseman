...
export const LESSON_24_INTRO_EXTRA: LessonIntroScreen[] = [
  {
    ...
    examples: [
      { labelRU: 'just', labelUK: 'just', labelES: 'just', en: [{ text: 'He ', tone: 'strong' }, { text: 'has', tone: 'accent' }, { text: ' just ' }, { text: 'opened', tone: 'warning' }, { text: ' the door' }], ru: 'Он только что открыл дверь', uk: 'Він щойно відчинив двері', es: 'Acaba de abrir la puerta', noteRU: 'He требует has, а opened здесь третья форма.', noteUK: 'He вимагає has, а opened тут третя форма.', noteES: 'Use has with he, and opened is V3 here.' },
      { labelRU: 'just', labelUK: 'just', labelES: 'just', en: [{ text: 'They ', tone: 'strong' }, { text: 'have', tone: 'accent' }, { text: ' just ' }, { text: 'sent', tone: 'warning' }, { text: ' documents' }], ru: 'Они только что отправили документы', uk: 'Вони щойно надіслали документи', es: 'Acaban de enviar los documentos', noteRU: 'They требует have, а sent - третья форма.', noteUK: 'They вимагає have, а sent - третя форма.', noteES: 'Use have with they, and sent is V3.' },
    ],
    developerNotes: {
  ...
  },
  {
    ...
    examples: [
      { labelRU: 'already', labelUK: 'already', labelES: 'already', en: [{ text: 'You have ' }, { text: 'already', tone: 'accent' }, { text: ' checked it', tone: 'warning' }], ru: 'Ты уже проверил это', uk: 'Ти вже перевірив це', es: 'Ya lo has revisado', noteRU: 'already обычно стоит между have/has и V3.', noteUK: 'already зазвичай стоїть між have/has і V3.', noteES: 'already usually stands between have/has and V3.' },
      { labelRU: 'yet', labelUK: 'yet', labelES: 'yet', en: [{ text: 'We have ' }, { text: 'not', tone: 'danger' }, { text: ' found the keys ', tone: 'warning' }, { text: 'yet', tone: 'danger' }], ru: 'Мы ещё не нашли ключи', uk: 'Ми ще не знайшли ключі', es: 'Todavía no hemos encontrado las llaves', noteRU: 'yet в таких фразах стоит в конце.', noteUK: 'yet у таких фразах стоїть у кінці.', noteES: 'yet goes at the end in these sentences.' },
    ],
    developerNotes: {
  ...
  },
  {
    ...
    examples: [
      { labelRU: 'yet question', labelUK: 'yet question', labelES: 'yet question', en: [{ text: 'Has', tone: 'accent' }, { text: ' he ', tone: 'strong' }, { text: 'opened', tone: 'warning' }, { text: ' the door yet?', tone: 'danger' }], ru: 'Он уже открыл дверь?', uk: 'Він вже відчинив двері?', es: '¿Él ya ha abierto la puerta?', noteRU: 'В вопросе Has выходит перед he, а yet стоит в конце.', noteUK: 'У питанні Has виходить перед he, а yet стоїть у кінці.', noteES: 'In a question, Has moves before he, and yet goes at the end.' },
      { labelRU: 'ever', labelUK: 'ever', labelES: 'ever', en: [{ text: 'Have', tone: 'accent' }, { text: ' you ', tone: 'strong' }, { text: 'ever', tone: 'accent' }, { text: ' lost your phone?', tone: 'warning' }], ru: 'Ты когда-нибудь терял свой телефон?', uk: 'Ти коли-небудь губив свій телефон?', es: '¿Alguna vez has perdido tu teléfono?', noteRU: 'ever спрашивает об опыте за жизнь или до настоящего момента.', noteUK: 'ever питає про досвід за життя або дотепер.', noteES: 'ever asks about life experience up to now.' },
      { labelRU: 'never', labelUK: 'never', labelES: 'never', en: [{ text: 'We have ' }, { text: 'never', tone: 'danger' }, { text: ' met them', tone: 'warning' }], ru: 'Мы никогда не встречали их', uk: 'Ми ніколи не зустрічали їх', es: 'Nunca los hemos conocido', noteRU: 'never уже несёт отрицание, поэтому not не нужен.', noteUK: 'never уже несе заперечення, тому not не потрібен.', noteES: 'never already makes the meaning negative, so not is not needed.' },
    ],
    developerNotes: {
  ...
  },
  {
    ...
    examples: [
      { labelRU: 'been', labelUK: 'been', labelES: 'been', en: [{ text: 'She has ' }, { text: 'been', tone: 'warning' }, { text: ' here before' }], ru: 'Она уже была здесь раньше', uk: 'Вона вже була тут раніше', es: 'Ella ha estado aquí antes', noteRU: 'После has нужна форма been, не was.', noteUK: 'Після has потрібна форма been, не was.', noteES: 'After has, use been, not was.' },
      { labelRU: 'done', labelUK: 'done', labelES: 'done', en: [{ text: 'We have ' }, { text: 'done', tone: 'warning' }, { text: ' it' }], ru: 'Мы сделали это', uk: 'Ми зробили це', es: 'Lo hemos hecho', noteRU: 'Do -> did в Past Simple, но после have нужна форма done.', noteUK: 'Do -> did у Past Simple, але після have потрібна форма done.', noteES: 'Do -> did in Past Simple, but after have use done.' },
      { labelRU: 'made', labelUK: 'made', labelES: 'made', en: [{ text: 'They have ' }, { text: 'made', tone: 'warning' }, { text: ' mistakes' }], ru: 'Они сделали ошибки', uk: 'Вони зробили помилки', es: 'Ellos han cometido errores', noteRU: 'Make в V3 становится made.', noteUK: 'Make у V3 стає made.', noteES: 'Make becomes made in V3.' },
    ],
    developerNotes: {
...
export const LESSON_25_INTRO_EXTRA: LessonIntroScreen[] = [
  {
    ...
    examples: [
      { labelRU: 'was', labelUK: 'was', labelES: 'was', en: [{ text: 'She ', tone: 'strong' }, { text: 'was', tone: 'accent' }, { text: ' writing a message at noon', tone: 'warning' }], ru: 'Она писала сообщение в полдень', uk: 'Вона писала повідомлення опівдні', es: 'Estaba escribiendo un mensaje al mediodía', noteRU: 'She требует was, а действие получает -ing.', noteUK: 'She вимагає was, а дія отримує -ing.', noteES: 'Use was with she, and add -ing to the action.' },
      { labelRU: 'were', labelUK: 'were', labelES: 'were', en: [{ text: 'We ', tone: 'strong' }, { text: 'were', tone: 'accent' }, { text: ' checking documents', tone: 'warning' }], ru: 'Мы проверяли документы', uk: 'Ми перевіряли документи', es: 'Estábamos revisando documentos', noteRU: 'We требует were.', noteUK: 'We вимагає were.', noteES: 'Use were with we.' },
    ],
  },
  {
    lessonId: 25,
    ...
    examples: [
      { labelRU: 'вопрос', labelUK: 'питання', labelES: 'question', en: [{ text: 'Was', tone: 'accent' }, { text: ' she writing a message at noon?', tone: 'warning' }], ru: 'Она писала сообщение в полдень?', uk: 'Вона писала повідомлення опівдні?', es: '¿Ella estaba escribiendo un mensaje al mediodía?', noteRU: 'В вопросе Was выходит перед she.', noteUK: 'У питанні Was виходить перед she.', noteES: 'In a question, Was moves before she.' },
      { labelRU: 'отрицание', labelUK: 'заперечення', labelES: 'negative', en: [{ text: 'She ', tone: 'strong' }, { text: 'was', tone: 'accent' }, { text: ' ' }, { text: 'not', tone: 'danger' }, { text: ' using my phone', tone: 'warning' }], ru: 'Она не пользовалась моим телефоном', uk: 'Вона не користувалася моїм телефоном', es: 'Ella no estaba usando mi teléfono', noteRU: 'not стоит после was, а using остаётся с -ing.', noteUK: 'not стоїть після was, а using залишається з -ing.', noteES: 'not comes after was, and using keeps -ing.' },
    ],
  },
  {
    lessonId: 25,
    ...
    examples: [
      { labelRU: 'WH-вопрос', labelUK: 'WH-питання', labelES: 'WH-question', en: [{ text: 'Why', tone: 'accent' }, { text: ' ' }, { text: 'was', tone: 'warning' }, { text: ' she crying?', tone: 'warning' }], ru: 'Почему она плакала?', uk: 'Чому вона плакала?', es: '¿Por qué estaba llorando?', noteRU: 'Why первым, потом was, потом she crying.', noteUK: 'Why першим, потім was, потім she crying.', noteES: 'Why first, then was, then she crying.' },
      { labelRU: 'while', labelUK: 'while', labelES: 'while', en: [{ text: 'She ', tone: 'strong' }, { text: 'was writing', tone: 'warning' }, { text: ' ' }, { text: 'while', tone: 'accent' }, { text: ' I ', tone: 'strong' }, { text: 'was reading', tone: 'warning' }], ru: 'Она писала, пока я читал', uk: 'Вона писала, поки я читав', es: 'Ella estaba escribiendo mientras yo leía', noteRU: 'while соединяет два процесса, которые шли одновременно.', noteUK: 'while поєднує два процеси, які тривали одночасно.', noteES: 'while connects two actions happening at the same time.' },
    ],
  },
  {
    lessonId: 25,
    ...
    examples: [
      { labelRU: 'фон + событие', labelUK: 'фон + подія', labelES: 'background + event', en: [{ text: 'They ', tone: 'strong' }, { text: 'were watching a movie', tone: 'warning' }, { text: ' ' }, { text: 'when', tone: 'accent' }, { text: ' I ', tone: 'strong' }, { text: 'called', tone: 'warning' }], ru: 'Они смотрели фильм, когда я позвонил', uk: 'Вони дивилися фільм, коли я подзвонив', es: 'Estaban viendo una película cuando llamé', noteRU: 'were watching = фон, called = короткое событие.', noteUK: 'were watching = фон, called = коротка подія.', noteES: 'were watching = background, called = short event.' },
      { labelRU: 'фон + событие', labelUK: 'фон + подія', labelES: 'background + event', en: [{ text: 'I ', tone: 'strong' }, { text: 'was writing a message', tone: 'warning' }, { text: ' ' }, { text: 'when', tone: 'accent' }, { text: ' you ', tone: 'strong' }, { text: 'knocked on the door', tone: 'warning' }], ru: 'Я писал сообщение, когда ты постучал в дверь', uk: 'Я писав повідомлення, коли ти постукав у двері', es: 'Estaba escribiendo un mensaje cuando llamaste a la puerta', noteRU: 'was writing длилось, knocked on the door произошло в один момент.', noteUK: 'was writing тривало, knocked on the door сталося в один момент.', noteES: 'was writing was in progress; knocked on the door happened at one moment.' },
    ],
  },
];
...
export const LESSON_26_INTRO_EXTRA: LessonIntroScreen[] = [
  {
    ...
    examples: [
      { labelRU: 'условие + результат', labelUK: 'умова + результат', labelES: 'condition + result', en: [{ text: 'If', tone: 'accent' }, { text: ' you open the app, it ' }, { text: 'will', tone: 'warning' }, { text: ' work' }], ru: 'Если ты откроешь приложение, оно будет работать', uk: 'Якщо ти відкриєш застосунок, він працюватиме', es: 'Si abres la aplicación, funcionará', noteRU: 'Open стоит после if без will. Will стоит перед результатом work.', noteUK: 'Open стоїть після if без will. Will стоїть перед результатом work.', noteES: 'Open comes after if without will. Will comes before the result work.' },
      { labelRU: 'he / she / it', labelUK: 'he / she / it', labelES: 'he / she / it', en: [{ text: 'If', tone: 'accent' }, { text: ' he finds the keys, he ' }, { text: 'will', tone: 'warning' }, { text: ' call us' }], ru: 'Если он найдёт ключи, он позвонит нам', uk: 'Якщо він знайде ключі, він зателефонує нам', es: 'Si él encuentra las llaves, nos llamará', noteRU: 'После he в условии нужно finds, потому что это Present Simple.', noteUK: 'Після he в умові потрібно finds, бо це Present Simple.', noteES: 'After he in the condition, use finds because it is Present Simple.' },
    ],
  },
  {
    lessonId: 26,
