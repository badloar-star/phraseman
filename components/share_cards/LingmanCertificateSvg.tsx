...
const COPY = {
  ...
  'pt-BR': {
    eyebrow: 'PHRASEMAN APP',
    sub: 'Teste interno · 2026',
    title: `PHRASEMAN ${CERT_LEVEL}`,
    presented: 'Recompensa concedida ao usuário',
    achievement: `alcançou o nível ${CERT_LEVEL} no teste do aplicativo`,
    professor: 'Phraseman App',
    scoreLabel: 'Resultado',
    ...
    professorName: 'Phraseman App',
    disclaimerLine1: 'Recompensa interna do aplicativo · Não é uma qualificação oficial',
    disclaimerLine2: 'O nível é uma autoavaliação pelos descritores CEFR (Conselho da Europa)',
  },
  vi: {
    eyebrow: 'PHRASEMAN APP',
    sub: 'Bài kiểm tra nội bộ · 2026',
    title: `PHRASEMAN ${CERT_LEVEL}`,
    presented: 'Phần thưởng được trao cho người dùng',
    achievement: `đã đạt cấp độ ${CERT_LEVEL} trong bài kiểm tra của ứng dụng`,
    professor: 'Phraseman App',
    scoreLabel: 'Kết quả',
    ...
    professorName: 'Phraseman App',
    disclaimerLine1: 'Phần thưởng nội bộ của ứng dụng · Không phải chứng chỉ chính thức',
    disclaimerLine2: 'Cấp độ là tự đánh giá theo mô tả CEFR (Hội đồng Châu Âu)',
  },
  'id': {
    eyebrow: 'PHRASEMAN APP',
    sub: 'Tes internal · 2026',
    title: `PHRASEMAN ${CERT_LEVEL}`,
    presented: 'Penghargaan diberikan kepada pengguna',
    achievement: `mencapai level ${CERT_LEVEL} dalam tes aplikasi`,
    professor: 'Phraseman App',
    scoreLabel: 'Hasil',
    ...
    professorName: 'Phraseman App',
    disclaimerLine1: 'Penghargaan internal aplikasi · Bukan kualifikasi resmi',
    disclaimerLine2: 'Level adalah penilaian mandiri berdasarkan deskriptor CEFR (Dewan Eropa)',
  },
  tr: {
    eyebrow: 'PHRASEMAN APP',
    sub: 'Dahili test · 2026',
    title: `PHRASEMAN ${CERT_LEVEL}`,
    presented: 'Ödül kullanıcıya verildi',
    achievement: `uygulama testinde ${CERT_LEVEL} seviyesine ulaştı`,
    professor: 'Phraseman App',
    scoreLabel: 'Sonuç',
    ...
    signatureLabel: 'İmza',
    professorName: 'Phraseman App',
    disclaimerLine1: 'Uygulama içi ödül · Resmi bir yeterlilik değildir',
    disclaimerLine2: 'Seviye, CEFR tanımlayıcılarına göre öz değerlendirmedir (Avrupa Konseyi)',
  },
  pl: {
    eyebrow: 'PHRASEMAN APP',
    sub: 'Test wewnętrzny · 2026',
    title: `PHRASEMAN ${CERT_LEVEL}`,
    presented: 'Nagroda przyznana użytkownikowi',
    achievement: `osiągnął/osiągnęła poziom ${CERT_LEVEL} w teście aplikacji`,
    professor: 'Phraseman App',
    scoreLabel: 'Wynik',
    ...
    professorName: 'Phraseman App',
    disclaimerLine1: 'Wewnętrzna nagroda aplikacji · Nie jest oficjalną kwalifikacją',
    disclaimerLine2: 'Poziom to samoocena według deskryptorów CEFR (Rada Europy)',
  },
} as const;
