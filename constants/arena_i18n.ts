...
export const arenaToasts = {
  ...
  searchTimeout: {
    messageRu: 'Соперник не найден. Попробуй ещё раз.',
    messageUk: 'Суперника не знайдено. Спробуй ще раз.',
    messageEs: 'No se ha encontrado rival. Inténtalo de nuevo.',
    messagePtBr: 'Nenhum rival encontrado. Tente novamente.',
    messageVi: 'Không tìm thấy đối thủ. Hãy thử lại.',
    messageId: 'Lawan tidak ditemukan. Coba lagi.',
    messageTr: 'Rakip bulunamadı. Tekrar dene.',
    messagePl: 'Nie znaleziono rywala. Spróbuj ponownie.',
  },
  queueJoinFailRetry: {
