...
function validate(kind, stage, base, candidate) {
    ...
    switch (kind) {
        ...
        case 'quiz_topic':
        case 'challenge_topic': return (0, quiz_challenge_artifacts_1.validateTopicArtifact)(candidate, { kind, cefr: String(stage.cefr) });
        case 'quiz_questions':
        case 'challenge_questions': {
            ...
            return (0, quiz_challenge_artifacts_1.validateQuestionBatchArtifact)(candidate, { kind, count: Number(stage.count), grounding: { topic, previousQuestionKeys: [] } });
        }
        case 'quiz_question_replacement':
        case 'challenge_question_replacement': {
            ...
            return (0, quiz_challenge_artifacts_1.validateQuestionReplacementArtifact)(candidate, { kind, grounding: { replacementForQuestionId: result.replacementForQuestionId, originalQuestion, topic: { skillTags: [originalQuestion.skillTag] }, previousQuestionKeys: [] } });
        }
        ...
        case 'arena_topic': return (0, arena_artifacts_1.validateArenaTopicArtifact)(candidate, { cefr: String(stage.cefr), studyTarget: String(stage.studyTarget), sourceLocale: String(stage.sourceLocale) });
        case 'arena_questions': {
            ...
            return (0, arena_artifacts_1.validateArenaQuestionBatchArtifact)(candidate, { count: Number(stage.count), grounding: { topic, previousQuestionKeys: [] } });
        }
        case 'arena_question_replacement': {
            const result = record(base) && record(base.result) ? base.result : {};
            const originalQuestion = record(result.item) ? result.item : {};
            return (0, arena_artifacts_1.validateArenaQuestionReplacementArtifact)(candidate, { grounding: { replacementForQuestionId: result.replacementForQuestionId, originalQuestion, topic: { skillTags: [originalQuestion.skillTag] }, previousQuestionKeys: [] } });
        }
    }
}
