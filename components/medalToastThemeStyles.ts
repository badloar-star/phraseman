...
export const MEDAL_TOAST_THEME_STYLES: Record<ThemeMode, MedalToastThemeStyle> = {
  ...
  horizon: {
    signature: 'horizon-cinema-bloom',
    cardBgColors: ['rgba(58,36,80,0.97)', 'rgba(8,5,16,0.97)'],
    borderColor: 'rgba(255,173,122,0.28)',
    titleColor: '#FFFFFF',
    subtitleColor: 'rgba(255,255,255,0.74)',
    surfaceAccent: '#FFAD7A',
    badgeDownColor: '#FFAD7A',
    topShineColors: ['rgba(255,173,122,0)', 'rgba(255,173,122,0.56)', 'rgba(255,173,122,0)'],
    topShineOpacity: 0.72,
    haloOpacity: 0.24,
    auraColor: 'rgba(242,140,80,0.14)',
    medalPlateBg: 'rgba(255,173,122,0.07)',
    medalPlateBorder: 'rgba(255,173,122,0.22)',
    textureColor: 'rgba(255,111,165,0.05)',
    textureOpacity: 0.52,
    tierAccents: {
      bronze: '#F28C50',
      silver: '#F7A6C6',
    ...
    tierGlows: {
      bronze: 'rgba(242,140,80,0.3)',
      silver: 'rgba(247,166,198,0.3)',
      gold: 'rgba(255,201,107,0.34)',
    },
  },
  midnight: {
