import { ARENA_TIER_COUNT, ARENA_TIER_KEYS, type ArenaTierKey } from './rank_engine';
 ...
 * трогаем».
 *
 * Отсюда три жёстких свойства, и каждое из них — против очевидного, но
 * неправильного решения:
 *
 *   — награда КОСМЕТИКА, а не звёзды: звёзды это общая валюта приложения
 *     (D-05), и подмешивать в неё выдачу за ранг значит менять экономику всего
 *     приложения ради одного раздела;
 *   — награда ОДИН РАЗ ЗА ВСЮ ЖИЗНЬ, а не за сезон: восемь наград, и всё.
 *     Сезонная выдача превратила бы редкую веху в рутинную подачку;
 *   — награда за ПЕРВОЕ достижение: откат её не отбирает и не выдаёт заново.
 *
 * Чистые данные: ни сети, ни выдачи.
 */
