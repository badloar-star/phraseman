...
describe('tournament backend hardening source contracts', () => {
    const source = fs_1.default.readFileSync(path_1.default.join(__dirname, 'tournaments.ts'), 'utf8');
    const core = fs_1.default.readFileSync(path_1.default.join(__dirname, 'tournament_core.ts'), 'utf8');
    const index = fs_1.default.readFileSync(path_1.default.join(__dirname, 'index.ts'), 'utf8');
...
//# sourceMappingURL=tournament_backend_contract.test.js.map