...
/**
 * Турниры сохранены в исходниках для дальнейшей разработки, но полностью
 * закрыты в пользовательской навигации и root-стеке до отдельного решения
 * владельца о релизе. Это не dev-флаг: false действует во всех сборках.
 */
export const ENABLE_TOURNAMENTS = false;
