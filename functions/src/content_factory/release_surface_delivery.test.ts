...
describe('course release surface delivery', () => {
  ...
  it('pins index reads to stored engine provenance and defaults old entries to legacy', () => {
    const request = parseCourseSurfaceBundleRequest({ studyTarget: 'en', learnerSourceLocale: 'ru', releaseId: 'en-ru-r1', surface: 'arena' });
    const units = resolveIndexedCourseUnits({ ...request, units: [
