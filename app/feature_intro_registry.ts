...
export const FEATURE_INTRO_REGISTRY: readonly FeatureIntroDef[] = [
  {
    ...
    body: (lang) => triLang(lang, {
      ru: 'Дуэли один на один по фразам. Побеждай и поднимайся по рангам — от Бронзы до Легенды. За победы — звёзды для сезонных наград.',
      uk: 'Дуелі один на один по фразах. Перемагай і піднімайся по рангах — від Бронзи до Легенди. За перемоги — зірки для сезонних нагород.',
      es: 'Duelos uno contra uno con frases. Gana y sube de rango, desde Bronce hasta Leyenda. Las victorias dan estrellas para las recompensas de temporada.',
      'pt-BR': 'Duelos um contra um com frases. Vença e suba de rank, do Bronze até Lenda. As vitórias dão estrelas para as recompensas da temporada.',
      vi: 'Đấu 1 chọi 1 bằng các câu học. Thắng để lên rank, từ Đồng đến Huyền thoại. Chiến thắng cho sao để đổi phần thưởng theo mùa.',
      id: 'Duel satu lawan satu dengan frasa. Menang untuk naik rank, dari Perunggu sampai Legenda. Kemenangan memberi bintang untuk hadiah musiman.',
      tr: 'Cümlelerle birebir düellolar. Kazan ve rütbe yüksel, Bronzdan Efsaneye kadar. Zaferler sezon ödülleri için yıldız kazandırır.',
      pl: 'Pojedynki 1 na 1 na frazy. Wygrywaj i pnij się w rangach — od Brązu do Legendy. Zwycięstwa dają gwiazdy na nagrody sezonowe.',
    }),
