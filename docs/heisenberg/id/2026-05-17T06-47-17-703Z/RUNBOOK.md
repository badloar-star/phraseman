# Heisenberg runbook: id

## Command
Run again: `npm run heisenberg -- --lang id`

## Generated files
Workspace: `docs/heisenberg/id/2026-05-17T06-47-17-703Z`
...
- `npm run heisenberg -- --all-batch --audit-only --coverage-strict`
