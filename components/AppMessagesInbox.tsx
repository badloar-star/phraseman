...
function inboxText(lang: Lang) {
  return {
    ...
    pollSelected: triLang(lang, { ru: 'Твой выбор', uk: 'Твій вибір', en: 'Your choice', es: 'Tu elección', 'pt-BR': 'Sua escolha', vi: 'Lựa chọn của bạn', id: 'Pilihanmu', tr: 'Seçimin', pl: 'Twój wybór' }),
