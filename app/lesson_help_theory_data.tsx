// ─── Данные теории уроков (THEORY) ────────────────────────────────────────────
//
// ТЯЖЁЛЫЙ модуль контента: литерал THEORY на ~19 тыс. строк. НИКОГДА не
  ...
  render: (t, isUK, f) => [
    ...
    <Table
      ...
      rows={[
        ...
        ['looking for problems', isUK ? 'шукаю проблем' : 'ищу проблем', 'I am not looking for problems'],
      ]}
    />,
...
30: {
  ...
  render: (t, isUK, f) => [
    ...
    <Tip
      key="tip10_help_learn"
      t={t}
      f={f}
      text={isUK
        ? 'У фразі helps you learn слово learn йде без to: після help + когось дія часто стоїть у простій формі. Helps you to learn теж граматично можливе, але урок показує коротшу природну форму.'
        : 'В фразе helps you learn слово learn идёт без to: после help + кого-то действие часто стоит в простой форме. Helps you to learn тоже грамматически возможно, но урок показывает более короткую естественную форму.'
      }
    />,
