 ...
 * слоя (широкий полупрозрачный голубой / средний светло-голубой / тонкое белое ядро) +
...
export interface LightningOverlayProps {
  ...
  level?: number;
  /** Цвета слоёв (по умолчанию голубой→светло-голубой→холодное белое ядро). */
  colors?: { wide: string; mid: string; core: string; flash: string };
}

const DEFAULT_COLORS = {
  // Сине-голубая молния (по просьбе пользователя): широкий слой — насыщенный
  // голубой, средний — светло-голубой, ядро — холодный белый с голубизной.
  wide: 'rgba(90, 170, 255, 0.55)',
  mid: 'rgba(200, 232, 255, 0.9)',
  core: '#EAF6FF',
  // Мягкий голубой flash — низкий контраст пиковой вспышки сохранён ради a11y.
  flash: 'rgba(150, 205, 255, 0.4)',
};
