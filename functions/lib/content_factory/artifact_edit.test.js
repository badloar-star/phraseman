...
const stage = { stageId: 'req:challenge_questions:topic-1:r1', requestId: 'req', kind: 'challenge_questions', scopeId: 'topic-1', studyTarget: 'en', sourceLocale: 'ru', cefr: 'A2', count: 10, revision: 1, artifactId: 'artifact:req:challenge_questions:topic-1:r1' };
...
describe('immutable artifact edit contract', () => {
    ...
    test('rejects invalid answer index, changed count, identity and unapproved source references', () => {
        ...
        expect(() => (0, artifact_edit_1.prepareArtifactEdit)(stage, baseArtifact, { ...baseArtifact, stage: 'flashcard_items' }, 'edit-1')).toThrow('artifact_edit_stage_identity_changed');
    });
