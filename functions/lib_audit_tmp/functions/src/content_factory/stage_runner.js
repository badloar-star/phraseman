...
function parseAndValidate(raw, packet) {
    ...
    if (packet.kind === 'arena_question_replacement' && packet.promptVersion === 'v2')
        errors.push(...(0, arena_artifacts_1.validateArenaQuestionReplacementArtifact)(artifact, { grounding: packet.grounding }));
