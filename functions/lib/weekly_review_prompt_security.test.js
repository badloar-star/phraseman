...
const { sanitizeBriefing, buildSystemPrompt, buildUserPromptEnvelope, parseAndGuardResult } = weekly_review_1.__weeklyReviewTestHooks;
function briefing() {
    return {
...
//# sourceMappingURL=weekly_review_prompt_security.test.js.map