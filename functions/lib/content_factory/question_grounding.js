...
async function loadApprovedTopicGrounding(bucket, stage) {
    ...
    const errors = (0, question_artifacts_1.validateTopicArtifact)(artifact, { kind: stage.kind, cefr: stage.cefr });
    if (errors.length)
...
async function loadQuestionBatchForReview(bucket, stage, options = {}) {
    ...
    const errors = (0, question_artifacts_1.validateQuestionBatchArtifact)(artifact, { kind: stage.kind, count: 10, grounding: { topic } });
    if (errors.length)
...
async function loadQuestionReplacementForReview(bucket, stage, options = {}) {
    ...
    const errors = (0, question_artifacts_1.validateQuestionReplacementArtifact)(artifact, { kind: stage.kind, grounding });
    if (errors.length)
...
//# sourceMappingURL=question_grounding.js.map