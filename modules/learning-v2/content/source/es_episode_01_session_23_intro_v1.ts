...
const CONCEPT_BODY = L({
  ru: 'Уверенное суждение о ситуации звучит иначе, чем вопрос из прошлой практики: голос не поднимается к концу фразы, а, наоборот, твёрдо опускается на признаке. Es fácil произносится с явным ударением на fácil — именно там голос звучит увереннее всего, будто ставит точку. Сначала звучит образец целиком, с этим самым ударением на признаке, и только затем его нужно повторить своим голосом. Голос при этом сравнивается со звучанием образца, а не с буквами на бумаге, — именно так узнают уверенное суждение на слух.',
  uk: 'Впевнене судження про ситуацію звучить інакше, ніж питання з попередньої практики: голос не піднімається до кінця фрази, а навпаки, твердо опускається на ознаці. Es fácil вимовляється з явним наголосом на fácil — саме там голос звучить найупевненіше, ніби ставить крапку. Спершу звучить зразок цілком, із цим самим наголосом на ознаці, і лише потім його потрібно повторити власним голосом. Голос при цьому порівнюється зі звучанням зразка, а не з літерами на папері, — саме так впізнають впевнене судження на слух.',
  es: 'A confident verdict about a situation sounds different from the question from the earlier practice: the voice does not rise toward the end of the phrase — instead, it settles firmly on the quality. Es fácil is said with a clear stress on fácil — that is exactly where the voice sounds most confident, as if placing a full stop. The model sounds first in full, with that same stress on the quality, and only then does it need to be repeated with one\'s own voice. The voice is compared with the sound of the model, not with the letters on paper — that is exactly how a confident verdict is recognized by ear.',
  'pt-BR': 'Um veredito confiante sobre uma situação soa diferente da pergunta da prática anterior: a voz não sobe em direção ao fim da frase — em vez disso, ela se firma sobre a qualidade. Es fácil é dito com um acento claro em fácil — é exatamente aí que a voz soa mais confiante, como se pusesse um ponto final. O modelo soa primeiro por inteiro, com esse mesmo acento na qualidade, e só depois precisa ser repetido com a própria voz. A voz é comparada com o som do modelo, não com as letras no papel — é exatamente assim que se reconhece um veredito confiante pelo ouvido.',
  vi: 'Một nhận định tự tin về tình huống nghe khác với câu hỏi trong bài luyện trước đó: giọng nói không lên cao về cuối câu — mà thay vào đó, nó đọng lại chắc chắn trên đặc điểm được nhắc đến. Es fácil được nói với trọng âm rõ ràng vào fácil — đó chính xác là nơi giọng nói nghe tự tin nhất, như thể đặt một dấu chấm hết. Mẫu vang lên trọn vẹn trước, với chính trọng âm đó trên đặc điểm, và chỉ sau đó mới cần lặp lại bằng chính giọng nói của mình. Giọng nói được so sánh với âm thanh của mẫu, không phải với chữ viết trên giấy — đó chính xác là cách một nhận định tự tin được nhận ra khi nghe.',
  id: 'Sebuah penilaian percaya diri tentang suatu situasi terdengar berbeda dari pertanyaan pada latihan sebelumnya: suara tidak naik menuju akhir frasa — sebaliknya, ia mantap pada sifatnya. Es fácil diucapkan dengan tekanan jelas pada fácil — di situlah persisnya suara terdengar paling percaya diri, seolah membubuhkan titik akhir. Contohnya terdengar utuh terlebih dahulu, dengan tekanan yang sama pada sifat itu, dan baru setelah itu perlu diulangi dengan suara sendiri. Suara dibandingkan dengan bunyi contoh, bukan dengan huruf di atas kertas — begitulah persisnya sebuah penilaian percaya diri dikenali oleh telinga.',
  tr: 'Bir durum hakkındaki kendinden emin bir yargı, önceki pratikteki sorudan farklı duyulur: ses cümlenin sonuna doğru yükselmez — bunun yerine nitelik üzerinde sağlam biçimde yerleşir. Es fácil, fácil üzerinde belirgin bir vurguyla söylenir — sesin en kendinden emin duyulduğu yer tam olarak orasıdır, sanki bir nokta koyuyormuş gibi. Önce örnek baştan sona, nitelik üzerindeki o aynı vurguyla duyulur, ancak sonrasında kendi sesiyle tekrarlanması gerekir. Ses, örneğin sesiyle karşılaştırılır, kağıt üzerindeki harflerle değil — kendinden emin bir yargı kulakla tam olarak böyle tanınır.',
  pl: 'Pewny osąd o sytuacji brzmi inaczej niż pytanie z poprzedniej praktyki: głos nie wznosi się ku końcowi zdania — przeciwnie, stanowczo osiada na cesze. Es fácil wymawia się z wyraźnym akcentem na fácil — właśnie tam głos brzmi najpewniej, jakby stawiał kropkę. Najpierw brzmi cały wzór, z tym samym akcentem na cesze, a dopiero potem trzeba go powtórzyć własnym głosem. Głos porównuje się z brzmieniem wzoru, a nie z literami na papierze — właśnie tak rozpoznaje się pewny osąd na słuch.',
});

const FORMULA_BODY = L({
  ru: 'Формула проста: сначала звучит образец с ударением на признаке, затем голос повторяет его целиком с той же твёрдостью. Es caro звучит с явным нажимом на caro — именно там голос звучит весомее всего, а не на es. Es barato строится точно так же: нажим падает на barato. Слово, несущее это ударение, — обычно последнее слово фразы, сам признак или суть суждения. Точность здесь измеряется на слух: звучит ли признак весомо и твёрдо, как в образце, а не то, правильно ли выбрана буква на письме.',
  uk: 'Формула проста: спершу звучить зразок із наголосом на ознаці, потім голос повторює його цілком із тією ж твердістю. Es caro звучить із явним натиском на caro — саме там голос звучить вагоміше за все, а не на es. Es barato будується так само: натиск падає на barato. Слово, що несе цей наголос, — зазвичай останнє слово фрази, сама ознака чи суть судження. Точність тут вимірюється на слух: чи звучить ознака вагомо й твердо, як у зразку, а не чи правильно обрана літера на письмі.',
  es: 'The formula is simple: first the model sounds with the stress on the quality, then the voice repeats it whole with the same firmness. Es caro is said with a clear push on caro — that is exactly where the voice sounds most weighty, not on es. Es barato is built the same way: the push falls on barato. The word carrying this stress is usually the last word of the phrase, the quality itself or the core of the verdict. Accuracy here is measured by ear: whether the quality sounds weighty and firm the way it does in the model, not whether the right letter was picked in writing.',
  'pt-BR': 'A fórmula é simples: primeiro o modelo soa com o acento na qualidade, depois a voz o repete inteiro com a mesma firmeza. Es caro é dito com uma ênfase clara em caro — é exatamente aí que a voz soa mais firme, não em es. Es barato se constrói do mesmo jeito: a ênfase cai em barato. A palavra que carrega esse acento costuma ser a última palavra da frase, a própria qualidade ou o cerne do veredito. A precisão aqui é medida pelo ouvido: se a qualidade soa firme e com peso como no modelo, não se a letra certa foi escolhida por escrito.',
  vi: 'Công thức rất đơn giản: đầu tiên mẫu vang lên với trọng âm trên đặc điểm, sau đó giọng nói lặp lại trọn vẹn với cùng sự chắc chắn đó. Es caro được nói với sự nhấn mạnh rõ ràng vào caro — đó chính xác là nơi giọng nói nghe có sức nặng nhất, không phải ở es. Es barato được xây dựng theo cách y hệt: sự nhấn mạnh rơi vào barato. Từ mang trọng âm này thường là từ cuối cùng của câu, chính đặc điểm đó hoặc cốt lõi của nhận định. Độ chính xác ở đây được đo bằng tai: đặc điểm có nghe có sức nặng và chắc chắn như trong mẫu hay không, chứ không phải chữ đúng có được chọn khi viết hay không.',
  id: 'Rumusnya sederhana: pertama contoh terdengar dengan tekanan pada sifatnya, kemudian suara mengulanginya secara utuh dengan kemantapan yang sama. Es caro diucapkan dengan penekanan jelas pada caro — di situlah persisnya suara terdengar paling berbobot, bukan pada es. Es barato dibangun dengan cara yang sama: penekanan jatuh pada barato. Kata yang membawa tekanan ini biasanya kata terakhir dari frasa, sifat itu sendiri atau inti dari penilaian. Akurasi di sini diukur dengan telinga: apakah sifatnya terdengar berbobot dan mantap seperti pada contoh, bukan apakah huruf yang tepat dipilih secara tertulis.',
  tr: 'Formül basittir: önce örnek nitelik üzerindeki vurguyla duyulur, ardından ses onu aynı kararlılıkla bütün olarak tekrarlar. Es caro, caro üzerinde belirgin bir baskıyla söylenir — sesin en ağırlıklı duyulduğu yer tam olarak orasıdır, es değil. Es barato da aynı şekilde kurulur: baskı barato üzerine düşer. Bu vurguyu taşıyan kelime genellikle cümlenin son kelimesidir, niteliğin kendisi ya da yargının özü. Buradaki doğruluk kulakla ölçülür: nitelik örnekteki gibi ağırlıklı ve kararlı duyulur mu, yazıda doğru harfin seçilip seçilmediği değil.',
  pl: 'Formuła jest prosta: najpierw brzmi wzór z akcentem na cesze, potem głos powtarza go w całości z tą samą stanowczością. Es caro wymawia się z wyraźnym naciskiem na caro — właśnie tam głos brzmi najbardziej ważko, nie na es. Es barato buduje się tak samo: nacisk pada na barato. Słowo niosące ten akcent to zwykle ostatnie słowo zdania, sama cecha lub sedno osądu. Dokładność mierzy się tu na słuch: czy cecha brzmi ważko i stanowczo tak jak we wzorze, a nie czy wybrano właściwą literę na piśmie.',
});

const TRAP_BODY = L({
  ru: 'Легко подумать, что раз слова знакомы, суждение прозвучит уверенно само собой, — но узнавание фразы и уверенность в голосе проверяются по-разному. Можно точно знать, что означает No es fácil, и всё равно смазать звук, если торопиться и не довести ударение на признаке до конца. Самая опасная ошибка — произнести ¿Es fácil? тем же твёрдым нисходящим тоном, что и уверенное утверждение: тогда собеседник услышит готовый вывод, а не вопрос. Проверка простая: в суждении голос твёрдо ложится на признак в конце фразы, а в вопросе — поднимается.',
  uk: 'Легко подумати, що раз слова знайомі, судження прозвучить упевнено само собою, — але впізнавання фрази й упевненість у голосі перевіряються по-різному. Можна точно знати, що означає No es fácil, і все одно змазати звук, якщо поспішати й не довести наголос на ознаці до кінця. Найнебезпечніша помилка — вимовити ¿Es fácil? тим самим твердим низхідним тоном, що й впевнене твердження: тоді співрозмовник почує готовий висновок, а не питання. Перевірка проста: у судженні голос твердо лягає на ознаку в кінці фрази, а в питанні — піднімається.',
  es: 'It is easy to think that since the words are familiar, the verdict will sound confident by itself — but recognizing the phrase and sounding confident are checked differently. One can know exactly what No es fácil means and still blur the sound if rushing and not carrying the stress on the quality through to the end. The most dangerous mistake is saying ¿Es fácil? with that same firm falling tone as a confident statement: then the listener hears a ready conclusion, not a question. The check is simple: in a verdict the voice settles firmly on the quality at the end of the phrase, while in a question it rises.',
  'pt-BR': 'É fácil pensar que, como as palavras são conhecidas, o veredito vai soar confiante sozinho — mas reconhecer a frase e soar confiante são verificados de formas diferentes. Dá para saber exatamente o que No es fácil significa e ainda assim borrar o som se apressar e não levar o acento na qualidade até o fim. O erro mais perigoso é dizer ¿Es fácil? com o mesmo tom firme e descendente de uma afirmação confiante: aí o interlocutor ouve uma conclusão pronta, não uma pergunta. A checagem é simples: num veredito a voz se firma sobre a qualidade no fim da frase, enquanto numa pergunta ela sobe.',
  vi: 'Dễ nghĩ rằng vì các từ đã quen thuộc, nhận định sẽ tự nhiên nghe tự tin — nhưng việc nhận ra câu và nghe tự tin được kiểm tra khác nhau. Có thể biết chính xác No es fácil nghĩa là gì mà vẫn làm mờ âm thanh nếu vội vàng và không kéo trọng âm trên đặc điểm đến hết. Sai lầm nguy hiểm nhất là nói ¿Es fácil? bằng cùng tông điệu chắc chắn đi xuống như một câu khẳng định tự tin: khi đó người nghe sẽ nghe thấy một kết luận có sẵn, không phải một câu hỏi. Cách kiểm tra đơn giản: trong nhận định, giọng nói đọng chắc chắn trên đặc điểm ở cuối câu, còn trong câu hỏi thì nó lên cao.',
  id: 'Mudah untuk berpikir bahwa karena kata-katanya sudah dikenal, penilaian akan terdengar percaya diri dengan sendirinya — tetapi mengenali frasa dan terdengar percaya diri diperiksa dengan cara berbeda. Seseorang bisa tahu persis apa arti No es fácil dan tetap mengaburkan bunyinya jika terburu-buru dan tidak menuntaskan tekanan pada sifat hingga akhir. Kesalahan paling berbahaya adalah mengucapkan ¿Es fácil? dengan nada tegas menurun yang sama seperti pernyataan percaya diri: maka pendengar akan mendengar kesimpulan yang sudah jadi, bukan pertanyaan. Pengecekannya sederhana: dalam penilaian, suara mantap pada sifat di akhir frasa, sedangkan dalam pertanyaan, suara naik.',
  tr: 'Kelimeler tanıdık olduğu için yargının kendiliğinden kendinden emin duyulacağını düşünmek kolaydır — ama cümleyi tanımak ve kendinden emin duyulmak farklı şekilde kontrol edilir. No es fácil’in ne anlama geldiğini tam olarak bilebilir ve yine de acele edip nitelik üzerindeki vurguyu sona kadar taşımazsa sesi bulanıklaştırabilirsiniz. En tehlikeli hata, ¿Es fácil?’ı kendinden emin bir ifadeyle aynı sağlam düşen tonla söylemektir: o zaman dinleyici bir soru değil, hazır bir sonuç duyar. Kontrol basittir: bir yargıda ses cümlenin sonundaki nitelik üzerine sağlam biçimde oturur, bir soruda ise yükselir.',
  pl: 'Łatwo pomyśleć, że skoro słowa są znajome, osąd zabrzmi pewnie sam z siebie — ale rozpoznanie zdania i brzmienie pewności siebie sprawdza się inaczej. Można dokładnie wiedzieć, co znaczy No es fácil, i mimo to zamazać dźwięk, jeśli się śpieszy i nie doprowadzi akcentu na cesze do końca. Najniebezpieczniejszym błędem jest wypowiedzenie ¿Es fácil? tym samym stanowczym, opadającym tonem co pewne twierdzenie: wtedy rozmówca usłyszy gotowy wniosek, a nie pytanie. Sprawdzenie jest proste: w osądzie głos stanowczo osiada na cesze na końcu zdania, a w pytaniu — wznosi się.',
});
