...
| Metric | Value |
| Files scanned | 1626 |
| Localized items | 90162 |
| Target localized items | 17129 |
| Target item share | 0.19 |
...
## Item Coverage Gaps
| File | Surface | Reason |
| app/achievements.ts | app-other | Extracted 428 source localized item(s), but no es extracted items. |
