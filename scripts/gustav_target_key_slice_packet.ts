...
function main(): void {
  ...
  const sliceDefinitions: Array<Omit<DomainSlice, 'blockerCount' | 'rawTargetStorageRecords' | 'topFiles'>> = [
    ...
    },
    {
      ...
      domains: ['lesson_progress', 'mistake_practice', 'personal_practice', 'flashcards', 'level_exams'],
      adapters: ['lesson_progress_store', 'mistake_practice_store', 'personal_practice_store', 'flashcards_target_store', 'level_exam_certificate_store'],
