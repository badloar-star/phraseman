...
export const EPISODE_01_SESSION_01_WORD_FIRST_INTRO: readonly [SessionSourceIntroPage, SessionSourceIntroPage, SessionSourceIntroPage] = [
  ...
  },
  {
    ...
    question: {
      ...
      prompt: L({ ru: 'Какое двухсловное начало ставит I перед am?', uk: 'Який двослівний початок ставить I перед am?', es: '¿Qué inicio de dos palabras pone I antes de am?', 'pt-BR': 'Qual começo de duas palavras põe I antes de am?', vi: 'Cụm hai từ nào đặt I trước am?', id: 'Awalan dua kata mana yang menaruh I sebelum am?', tr: 'Hangi iki sözcüklü başlangıç I sözcüğünü amden önce koyar?', pl: 'Który dwuwyrazowy początek stawia I przed am?' }),
      choices: [L({ ru: 'I am', uk: 'I am', es: 'I am', 'pt-BR': 'I am', vi: 'I am', id: 'I am', tr: 'I am', pl: 'I am' }), L({ ru: 'am I', uk: 'am I', es: 'am I', 'pt-BR': 'am I', vi: 'am I', id: 'am I', tr: 'am I', pl: 'am I' }), L({ ru: 'I here', uk: 'I here', es: 'I here', 'pt-BR': 'I here', vi: 'I here', id: 'I here', tr: 'I here', pl: 'I here' })],
      correctChoiceIndex: 0,
      explanation: L({ ru: 'I am — правильное начало: I называет говорящего, а am удерживает связь. Дальше можно добавить информацию.', uk: 'I am — правильний початок: I називає мовця, а am утримує зв’язок. Далі можна додати інформацію.', es: 'I am es el inicio correcto: I nombra a quien habla y am mantiene la unión. Después se añade información.', 'pt-BR': 'I am é o começo correto: I identifica quem fala e am mantém a ligação. Depois vem a informação.', vi: 'I am là phần mở đầu đúng: I gọi người nói và am giữ mối nối. Sau đó có thể thêm thông tin.', id: 'I am adalah awal yang benar: I menyebut penutur dan am menjaga penghubungnya. Setelahnya boleh ditambah informasi.', tr: 'I am doğru başlangıçtır: I konuşanı gösterir, am bağlantıyı korur. Sonra bilgi eklenebilir.', pl: 'I am to poprawny początek: I wskazuje mówiącego, a am utrzymuje połączenie. Potem można dodać informację.' }),
    },
  },
];
