...
const CYCLE: ThemeMode[] = ['indigo', 'sagePorcelain', 'midnight', 'minimalDark', 'ember', 'aurora', 'volt', 'candyBlue', 'dark', 'coral', 'gold'];
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const valid =
        ...
        migrated === 'candyBlue' || migrated === 'indigo' || migrated === 'sagePorcelain';
      if (valid) {
