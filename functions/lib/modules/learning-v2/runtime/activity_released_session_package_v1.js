...
function exactText(value, maximum = 8192) {
    if (typeof value !== "string" ||
        value.length < 1 ||
...
function preflight(value) {
    ...
    while (stack.length > 0) {
        ...
        nodes += 1;
        if (nodes > 220000 || current.depth > 32)
            fail();
...
function parseLearner(value) {
    ...
    const responseOptions = value.responseOptions.map((candidate) => {
        ...
        return Object.freeze({
            ...
            text: exactText(candidate.text, 4096),
        });
    });
    ...
    return Object.freeze({
        ...
        accessibilityLabel: exactText(value.accessibilityLabel, 4096),
    });
}
function parseTask(value, expectedSlot) {
    ...
    if (value.scriptedAlternate !== null) {
        ...
        scriptedAlternate = Object.freeze({
            ...
            instruction: exactText(value.scriptedAlternate.instruction, 4096),
