...
describe('R4 quiz/challenge fake-provider smoke', () => {
  it.each([['quiz_topic', 'quiz_questions'], ['challenge_topic', 'challenge_questions']] as const)('runs accepted %s through two independently deduplicated batches', async (topicKind, questionKind) => {
