...
import {
  ES_EPISODE_01_SESSION_16_CHECKPOINT_GOAL,
  ES_EPISODE_01_SESSION_16_CHECKPOINT_INTRO,
  ES_EPISODE_01_SESSION_16_CHECKPOINT_SUMMARY,
 ...
 *
 * Checkpoint конца главы 2 "Ты", как и voice, НЕ вводит новых слов —
 * переиспользует ровно тот же набор из 15 уже утверждённых фраз, что и
 * voice-сессия 15 (см. es_episode_01_session_16_phrases_v1.ts). Choreography
 * (checkpointSteps в lesson1_session_choreography_v1.ts) применяет другой
...
export const ES_EPISODE_01_SESSION_16_SOURCE: SessionSource = Object.freeze({
  ...
  introPages: ES_EPISODE_01_SESSION_16_CHECKPOINT_INTRO,
  phrases: ES_EPISODE_01_SESSION_16_CHECKPOINT_PHRASES,
});
