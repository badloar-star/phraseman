...
exports.validateV2EpisodeContract = exports.validateV2CheckpointContract = exports.validateV2CurriculumProjection = exports.validateV2LearningPackage = void 0;
...
const validateTemplateArtifactBodyShape = (value, path) => {
    ...
    if (hasOwn(value, "voiceReleaseRequirements")) {
        return validateVoiceReleaseRequirementsShape(value.voiceReleaseRequirements, `${path}.voiceReleaseRequirements`);
    }
    return undefined;
};
