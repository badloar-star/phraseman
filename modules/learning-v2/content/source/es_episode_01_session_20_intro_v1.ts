...
const CONCEPT_BODY = L({
  ru: 'Одно высказывание можно оценить двумя способами: ¿Es verdad? проверяет сам факт, а De acuerdo выражает согласие с чьим-то мнением о нём. Можно сказать Es verdad, но No de acuerdo — факт истинный, но говорящий не разделяет вывод из него.',
  uk: 'Одне висловлювання можна оцінити двома способами: ¿Es verdad? перевіряє сам факт, а De acuerdo виражає згоду з чиєюсь думкою про нього. Можна сказати Es verdad, але No de acuerdo — факт істинний, але мовець не поділяє висновок із нього.',
  es: 'A statement can be evaluated in two ways: ¿Es verdad? checks the fact itself, while De acuerdo expresses agreement with someone\'s opinion about it. You can say Es verdad but No de acuerdo — the fact is true, but the speaker does not share the conclusion drawn from it.',
  'pt-BR': 'Uma declaração pode ser avaliada de duas formas: ¿Es verdad? checa o próprio fato, enquanto De acuerdo expressa concordância com a opinião de alguém sobre ele. Dá para dizer Es verdad mas No de acuerdo — o fato é verdadeiro, mas quem fala não compartilha a conclusão tirada dele.',
  vi: 'Một câu nói có thể được đánh giá theo hai cách: ¿Es verdad? kiểm tra chính sự thật, còn De acuerdo thể hiện sự đồng ý với ý kiến của ai đó về điều đó. Có thể nói Es verdad nhưng No de acuerdo — sự thật là đúng, nhưng người nói không chia sẻ kết luận rút ra từ đó.',
  id: 'Suatu pernyataan bisa dinilai dengan dua cara: ¿Es verdad? memeriksa faktanya sendiri, sementara De acuerdo mengungkapkan persetujuan dengan pendapat seseorang tentangnya. Bisa mengatakan Es verdad tetapi No de acuerdo — faktanya benar, tetapi penutur tidak berbagi kesimpulan yang ditarik darinya.',
  tr: 'Bir ifade iki şekilde değerlendirilebilir: ¿Es verdad? gerçeğin kendisini kontrol eder, De acuerdo ise biri hakkındaki bir görüşe katılımı ifade eder. Es verdad ama No de acuerdo diyebilirsiniz — gerçek doğrudur, ama konuşan ondan çıkan sonucu paylaşmaz.',
  pl: 'Jedno stwierdzenie można ocenić na dwa sposoby: ¿Es verdad? sprawdza sam fakt, a De acuerdo wyraża zgodę z czyjąś opinią na jego temat. Można powiedzieć Es verdad, ale No de acuerdo — fakt jest prawdziwy, ale mówiący nie podziela wniosku z niego wyciągniętego.',
});

const FORMULA_BODY = L({
  ru: 'Формула проверки факта та же, что и раньше: es + verdad, знаки ¿? меняют утверждение на вопрос без перестановки слов. Формула согласия тоже не меняется: de + acuerdo, застывшая пара слов, не согласующаяся ни с родом, ни с числом.',
  uk: 'Формула перевірки факту та сама, що й раніше: es + verdad, знаки ¿? змінюють твердження на питання без перестановки слів. Формула згоди теж не змінюється: de + acuerdo, застигла пара слів, що не узгоджується ні з родом, ні з числом.',
  es: 'The formula for checking a fact is the same as before: es + verdad, the marks ¿? turn a statement into a question without reordering words. The agreement formula does not change either: de + acuerdo, a fixed pair of words agreeing with neither gender nor number.',
  'pt-BR': 'A fórmula para checar um fato é a mesma de antes: es + verdad, os sinais ¿? transformam uma afirmação em pergunta sem reordenar as palavras. A fórmula de concordância também não muda: de + acuerdo, um par fixo de palavras que não concorda nem com gênero nem com número.',
  vi: 'Công thức kiểm tra sự thật giống như trước: es + verdad, dấu ¿? biến câu khẳng định thành câu hỏi mà không đổi trật tự từ. Công thức đồng ý cũng không đổi: de + acuerdo, một cặp từ cố định không hòa hợp với giống hay số.',
  id: 'Rumus untuk memeriksa fakta sama seperti sebelumnya: es + verdad, tanda ¿? mengubah pernyataan menjadi pertanyaan tanpa mengubah urutan kata. Rumus persetujuan juga tidak berubah: de + acuerdo, pasangan kata tetap yang tidak sesuai dengan gender maupun jumlah.',
  tr: 'Bir gerçeği kontrol etme formülü öncekiyle aynıdır: es + verdad, ¿? işaretleri kelime sırasını değiştirmeden bir ifadeyi soruya çevirir. Onay formülü de değişmez: de + acuerdo, ne cinsiyete ne de sayıya uyan sabit bir kelime çifti.',
  pl: 'Formuła sprawdzania faktu jest taka sama jak wcześniej: es + verdad, znaki ¿? zamieniają twierdzenie w pytanie bez zmiany kolejności słów. Formuła zgody też się nie zmienia: de + acuerdo, utrwalona para słów, która nie zgadza się ani z rodzajem, ani z liczbą.',
});

const TRAP_BODY = L({
  ru: 'Главная ловушка — решить, что Es verdad и De acuerdo взаимозаменяемы. На самом деле верно и обратное: Es verdad, no de acuerdo — факт подтверждён, но говорящий не разделяет вывод.',
  uk: 'Головна пастка — вирішити, що Es verdad і De acuerdo взаємозамінні. Насправді вірне й зворотне: Es verdad, no de acuerdo — факт підтверджено, але мовець не поділяє висновок.',
  es: 'The main trap is deciding that Es verdad and De acuerdo are interchangeable. In fact, the opposite is also valid: Es verdad, no de acuerdo — the fact is confirmed, but the speaker does not share the conclusion.',
  'pt-BR': 'A armadilha principal é decidir que Es verdad e De acuerdo são intercambiáveis. Na verdade, o oposto também é válido: Es verdad, no de acuerdo — o fato é confirmado, mas quem fala não compartilha a conclusão.',
  vi: 'Cái bẫy chính là cho rằng Es verdad và De acuerdo có thể thay thế cho nhau. Thực tế, điều ngược lại cũng đúng: Es verdad, no de acuerdo — sự thật được xác nhận, nhưng người nói không chia sẻ kết luận.',
  id: 'Jebakan utama adalah memutuskan bahwa Es verdad dan De acuerdo bisa saling menggantikan. Faktanya, kebalikannya juga berlaku: Es verdad, no de acuerdo — faktanya dikonfirmasi, tetapi penutur tidak berbagi kesimpulan.',
  tr: 'Asıl tuzak, Es verdad ile De acuerdo\'nun birbirinin yerine geçtiğine karar vermektir. Aslında tam tersi de geçerlidir: Es verdad, no de acuerdo — gerçek doğrulanmıştır, ama konuşan sonucu paylaşmaz.',
  pl: 'Główna pułapka to uznanie, że Es verdad i De acuerdo są wymienne. W rzeczywistości poprawne jest też odwrotne połączenie: Es verdad, no de acuerdo — fakt jest potwierdzony, ale mówiący nie podziela wniosku.',
});
