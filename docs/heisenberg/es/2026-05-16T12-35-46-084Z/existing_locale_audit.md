...
| Metric | Value |
| Files scanned | 1529 |
| Localized items | 80500 |
| Target localized items | 12917 |
| Target item share | 0.1605 |
| Field coverage gap files | 21 |
...
| components/AddToFlashcard.tsx | app-other | Has 24 localized source-language field marker(s), but no ES field marker. |
| components/DailyPhraseCard.tsx | app-other | Has 12 localized source-language field marker(s), but no ES field marker. |
