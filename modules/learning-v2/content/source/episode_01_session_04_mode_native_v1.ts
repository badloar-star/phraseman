...
const speedMatch: LearningV2ModeNativePayloadV1 = Object.freeze({ family: 'speed_match', pairGrid: Object.freeze(SPEED_WORDS.map((entry, index) => ({ pairId: SPEED_IDS[index]!, target: entry.target, meaningByLocale: L(SPEED_MEANINGS[entry.target]!) }))), leftColumn: Object.freeze([SPEED_IDS[2]!, SPEED_IDS[0]!, SPEED_IDS[3]!, SPEED_IDS[1]!]), rightColumn: Object.freeze([SPEED_IDS[1]!, SPEED_IDS[3]!, SPEED_IDS[0]!, SPEED_IDS[2]!]), pairingKey: 'pair_id', timerPolicy: Object.freeze({ enabledByDefault: true, learnerCanDisable: true, pausesOnInterruption: true }), finishStats: Object.freeze(['speed', 'accuracy', 'personal_best'] as const) });
