...
/**
 * The V2 generator is deliberately represented as a pure plan first.  It does
 * not generate content and it does not touch Firestore; workers can execute
 * these stages later using the existing queue/lease machinery.
 */
