...
> **Любая новая или продолжаемая работа по Learning V2 начинается с**
> [**СТАРТ В2**](<./СТАРТ В2.md>). Он задаёт обязательный маршрут чтения,
> десятиминутные drift-checkpoints, полный refresh после пяти сессий и текущие
> owner-locks на интро, сценарии сессий, локали, дистракторы, feedback и gates.
...
**Нормативный стиль учебного текста:**
[`LEARNING_CONTENT_STYLE_BIBLE.ru.md`](./LEARNING_CONTENT_STYLE_BIBLE.ru.md).
Все интро, фразы и разборы сохраняют утверждённый стиль старого эталона, не
