...
export function getHomeMenuImages(themeMode: ThemeMode): HomeMenuImageSet {
  if (themeMode === 'minimalDark') {
    return {
      ...
      dialogs: require('../assets/images/messages/message-minimal-dark.webp'),
  ...
  if (themeMode === 'gold') {
    return {
      ...
      dialogs: require('../assets/images/messages/message-gold.webp'),
  ...
  if (themeMode === 'coral') {
    return {
      ...
      dialogs: require('../assets/images/levels/dialog coral.webp'),
  ...
  return {
    ...
    dialogs: require('../assets/images/levels/dialog forest.webp'),
