...
Generated: 2026-05-17T15:59:34.723Z
Activation ready: no
...
- triLang missing locale units: 155
- triLang calls missing all planned locales: 31
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 31
...
- components/GlobalBroadcastModal.tsx: 3 findings, 15 missing locale units
...
- components/ReleaseNotesModal.tsx: 4 findings, 0 missing locale units
- app/community_packs/ugcCardThemePresets.ts: 1 findings, 0 missing locale units
- components/StatsPremiumBlur.tsx: 1 findings, 0 missing locale units
...
- [warning] trilang-missing-all-planned-locales app/avatar_select.tsx:364 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: aura.nameRu, uk: aura.nameUk, es: aura.nameEs }
- [warning] trilang-missing-all-planned-locales app/avatar_select.tsx:1042 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: `Открыть ауру «${auraName(pendingAuraPurchase)}» за осколки?`, uk: `Відкрити ауру «${auraName(pendingAuraPurchase)}» за осколки?`, es: `¿Desbloquear el aura «${auraName(pendi
...
- [warning] trilang-missing-all-planned-locales components/GlobalBroadcastModal.tsx:164 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: payload.reviewCtaRu, uk: payload.reviewCtaUk, es: payload.reviewCtaEs }
...
- [warning] dynamic-trilang-copy components/ReleaseNotesModal.tsx:326: triLang uses a dynamic copy object; UI locale audit cannot prove planned locales are present. | triLang(lang, TEXT.cta)
