...
const SESSION_DESIGNS: readonly SessionDesign[] = Object.freeze([
  Object.freeze({ role: "guided_application", intent: "распознать точное значение и форму в двух ясных контекстах", deltas: Object.freeze(["support_fade"]), sessionKind: "meaning_first_recognition_v1", learningFunctions: Object.freeze(["meaning_form_mapping"]), requiredModeFamilies: Object.freeze(["listen_choose", "context_gap_grammar"]), supportStart: "maximum", supportEnd: "high" }),
  Object.freeze({ role: "guided_application", intent: "собрать целую фразу из осмысленных слов и chunks без буквенного пазла", deltas: Object.freeze(["support_fade", "productive_shift"]), sessionKind: "whole_word_guided_build_v1", learningFunctions: Object.freeze(["guided_phrase_construction"]), requiredModeFamilies: Object.freeze(["phrase_builder", "context_gap_grammar"]), supportStart: "high", supportEnd: "medium" }),
  Object.freeze({ role: "guided_application", intent: "выбрать форму по смыслу новой короткой ситуации", deltas: Object.freeze(["contrast_discrimination"]), sessionKind: "diagnostic_context_choice_v1", learningFunctions: Object.freeze(["diagnostic_discrimination"]), requiredModeFamilies: Object.freeze(["context_gap_grammar", "listen_choose"]), supportStart: "high", supportEnd: "medium" }),
  Object.freeze({ role: "variation", intent: "применить тот же шаг с другим участником, предметом или местом", deltas: Object.freeze(["changed_context"]), sessionKind: "changed_context_variation_v1", learningFunctions: Object.freeze(["contextual_variation"]), requiredModeFamilies: Object.freeze(["speed_match", "phrase_builder"]), supportStart: "medium", supportEnd: "low" }),
  Object.freeze({ role: "retrieval", intent: "извлечь нужную форму после интервала и отличить её от близкой изученной формы", deltas: Object.freeze(["delayed_retrieval", "contrast_discrimination"]), sessionKind: "spaced_retrieval_v1", learningFunctions: Object.freeze(["spaced_retrieval"]), requiredModeFamilies: Object.freeze(["listen_build_dictation", "context_gap_grammar"]), supportStart: "medium", supportEnd: "low" }),
  Object.freeze({ role: "near_transfer_repair", intent: "исправить типичную смысловую ошибку и перенести шаг в практическую сцену", deltas: Object.freeze(["targeted_error_repair", "transfer"]), sessionKind: "near_transfer_repair_v1", learningFunctions: Object.freeze(["error_repair", "near_transfer"]), requiredModeFamilies: Object.freeze(["context_gap_grammar", "scripted_dialogue"]), supportStart: "low", supportEnd: "minimal" }),
  Object.freeze({ role: "voice", intent: "понять эталон и самостоятельно произнести целую уместную реплику", deltas: Object.freeze(["productive_shift", "transfer"]), sessionKind: "voice_transfer_v1", learningFunctions: Object.freeze(["listening", "spoken_production"]), requiredModeFamilies: Object.freeze(["scripted_repeat_compare", "quick_spoken_response"]), supportStart: "low", supportEnd: "none" }),
  Object.freeze({ role: "checkpoint", intent: "доказать владение шагом без учебной подсказки в изменённой сцене", deltas: Object.freeze(["delayed_retrieval", "transfer"]), sessionKind: "independent_chapter_probe_v1", learningFunctions: Object.freeze(["independent_probe"]), requiredModeFamilies: Object.freeze(["listen_choose", "phrase_builder", "quick_spoken_response"]), supportStart: "minimal", supportEnd: "none" }),
]);
