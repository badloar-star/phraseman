...
| Metric | Value |
| Files scanned | 1538 |
| Localized items | 80523 |
| Target localized items | 12957 |
| Target item share | 0.1609 |
| Field coverage gap files | 29 |
| Item coverage gap files | 24 |
...
## Field Coverage Gaps
| File | Surface | Reason |
| admin/daily_phrases_seed.json | admin-site | Has 528 localized source-language field marker(s), but no ES field marker. |
...
| components/onboarding.tsx | app-other | Has 12 localized source-language field marker(s), but no ES field marker. |
| app/trainer_words_session.tsx | app-other | Has 4 localized source-language field marker(s), but no ES field marker. |
| app/review_evaluator.ts | app-other | Has 3 localized source-language field marker(s), but no ES field marker. |
| app/flashcards_market_dev.tsx | app-other | Has 2 localized source-language field marker(s), but no ES field marker. |
| app/graphify-out/cache/3d4c792bd09e45b6a7dbfb4a2c804e705c31d9b2344a4fc403de229051d25cc9.json | app-other | Has 2 localized source-language field marker(s), but no ES field marker. |
| app/pack_opening.tsx | app-other | Has 2 localized source-language field marker(s), but no ES field marker. |
| app/graphify-out/cache/5bf7af88ced12ab5b600b24ea5152e873a4e912bc1a5b4d89adde3e7a6cd19fa.json | app-other | Has 1 localized source-language field marker(s), but no ES field marker. |
| constants/i18n.ts | ui-locale | Has 1 localized source-language field marker(s), but no ES field marker. |
| knowly-www/download/index.html | public-web | Has 1 localized source-language field marker(s), but no ES field marker. |
| knowly-www/index.html | public-web | Has 1 localized source-language field marker(s), but no ES field marker. |
| subscription-recovery/package-lock.json | app-other | Has 1 localized source-language field marker(s), but no ES field marker. |
