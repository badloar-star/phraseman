...
exports.DEFAULT_MAIN_QUESTIONS = void 0;
exports.scoreDuel = scoreDuel;
/** Основных вопросов в дуэли по умолчанию (переопределяется cfg.duel.targetScore). */
exports.DEFAULT_MAIN_QUESTIONS = 3;
const NOT_ANSWERED = { correct: false, timeMs: Number.MAX_SAFE_INTEGER };
...
function scoreDuel(answersA, answersB, mainQuestions = exports.DEFAULT_MAIN_QUESTIONS) {
    ...
    for (let i = 0; i < total; i += 1) {
        ...
        if (Math.abs(points[0] - points[1]) > remaining)
            break;
    }
