// зачем: сессия 10 типа words_then_phrases. Тема одна — принадлежность:
// вопрос Whose, апостроф у хозяина (sister’s) и самостоятельные формы
// mine / yours / hers для ответа.
//
// Слова bag, phone и book идут карточками впереди: агент-новичок поймал, что
// в первой версии они появлялись прямо во фразах, и их «приходится угадывать
// по переводу».
