...
describe("Learning V2 owner episode intro projection bridge", () => {
  it("projects exactly 12 learner-safe intros as 3 pages with one embedded question each", () => {
        ...
        (intro) =>
          ...
          intro.pages.every(
            (page, index) =>
              ...
              page.question.taskSlot === index + 1 &&
              page.question.coveredConceptIds[0] === page.conceptId,
          ),
      ),
    ).toBe(true);
