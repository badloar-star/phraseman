...
const TARGET_IDS = [
  ...
  'surface:components-helpboardpanel:hit:2',
  ...
  'surface:components-registrationpromptmodal:trust-accent:1',
  'surface:components-registrationpromptmodal:trust-accent:2',
