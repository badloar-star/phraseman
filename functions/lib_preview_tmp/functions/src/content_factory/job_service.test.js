...
describe('resumable generation units', () => {
    ...
    it('summarizes retries/failures deterministically', () => {
        const units = [
            ...
            { unitId: 'b', jobId: 'j', studyTarget: 'fr', learnerSourceLocale: 'ru', surface: 'flashcard', lessonId: 1, state: 'failed', attempts: 3 },
            { unitId: 'c', jobId: 'j', studyTarget: 'fr', learnerSourceLocale: 'ru', surface: 'lesson', lessonId: 2, state: 'queued', attempts: 0 },
        ];
