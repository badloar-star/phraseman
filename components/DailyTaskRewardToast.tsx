...
export const DAILY_TASK_REWARD_TOAST_THEME_STYLES: Record<ThemeMode, DailyTaskRewardToastThemeStyle> = {
  ...
  compass: {
    cardColors: ['#1F1F21', '#171719'],
    sheenColors: ['rgba(242,196,141,0.20)', 'rgba(242,196,141,0.05)', 'rgba(242,196,141,0)'],
    accentRailColor: '#F2C48D',
    auraColor: 'rgba(242,196,141,0.18)',
    borderColor: 'rgba(242,196,141,0.30)',
    borderWidth: 1,
    radius: 8,
    shadowColor: 'rgba(0,0,0,0.74)',
    iconName: 'navigate-outline',
    iconBg: 'rgba(242,196,141,0.12)',
    iconBorderColor: 'rgba(242,196,141,0.30)',
    iconColor: '#F2C48D',
    titleColor: '#FFF8E8',
    taskColor: '#D8D2C8',
    xpColor: '#F2C48D',
