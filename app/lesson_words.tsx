...
const WORDS_BY_LESSON: Record<number, Word[]> = {
  ...
  27: [
    { en: 'say', ru: 'Говорить', uk: 'Говорити', pos: 'irregular_verbs' },
    { en: 'tell', ru: 'Рассказывать', uk: 'Розповідати', pos: 'irregular_verbs' },
    { en: 'find', ru: 'Находить', uk: 'Знаходити', pos: 'irregular_verbs' },
    { en: 'know', ru: 'Знать', uk: 'Знати', pos: 'irregular_verbs' },
    { en: 'send', ru: 'Отправлять', uk: 'Відправляти', pos: 'irregular_verbs' },
    { en: 'bring', ru: 'Приносить', uk: 'Приносити', pos: 'irregular_verbs' },
    { en: 'lose', ru: 'Терять', uk: 'Втрачати', pos: 'irregular_verbs' },
    { en: 'see', ru: 'Видеть', uk: 'Бачити', pos: 'irregular_verbs' },
    { en: 'break', ru: 'Ломать', uk: 'Зламати', pos: 'irregular_verbs' },
    { en: 'forget', ru: 'Забывать', uk: 'Забувати', pos: 'irregular_verbs' },
    { en: 'make', ru: 'Делать', uk: 'Робити', pos: 'irregular_verbs' },
    { en: 'steal', ru: 'Красть', uk: 'Красти', pos: 'irregular_verbs' },
    { en: 'pay', ru: 'Платить', uk: 'Платити', pos: 'irregular_verbs' },
    { en: 'take', ru: 'Брать', uk: 'Брати', pos: 'irregular_verbs' },
    { en: 'leave', ru: 'Оставлять', uk: 'Залишати', pos: 'irregular_verbs' },
    { en: 'hear', ru: 'Слышать', uk: 'Чути', pos: 'irregular_verbs' },
    { en: 'mention', ru: 'Упоминать', uk: 'Згадувати', pos: 'verbs' },
    ...
    { en: 'report', ru: 'Сообщать', uk: 'Повідомляти', pos: 'verbs' },
  ...
  28: [
    ...
    { en: 'express', ru: 'Выражать', uk: 'Виражати', pos: 'verbs' },
    { en: 'remind', ru: 'Напоминать', uk: 'Нагадувати', pos: 'verbs' },
    ...
    { en: 'relax', ru: 'Отдыхать', uk: 'Відпочивати', pos: 'verbs' },
    ...
    { en: 'keep', ru: 'Хранить', uk: 'Зберігати', pos: 'irregular_verbs' },
    { en: 'make', ru: 'Делать', uk: 'Робити', pos: 'irregular_verbs' },
    { en: 'teach', ru: 'Учить', uk: 'Вчити', pos: 'irregular_verbs' },
    ...
    { en: 'event', ru: 'Событие', uk: 'Подія', pos: 'nouns' },
    ...
    { en: 'journey', ru: 'Путешествие', uk: 'Подорож', pos: 'nouns' },
  ],
  29: [
    { en: 'trust', ru: 'Доверять', uk: 'Довіряти', pos: 'verbs' },
    { en: 'dwell', ru: 'Обитать', uk: 'Мешкати', pos: 'verbs' },
    { en: 'design', ru: 'Проектировать', uk: 'Проєктувати', pos: 'verbs' },
    { en: 'discuss', ru: 'Обсуждать', uk: 'Обговорювати', pos: 'verbs' },
    { en: 'patrol', ru: 'Патрулировать', uk: 'Патрулювати', pos: 'verbs' },
    ...
    { en: 'hide', ru: 'Прятать', uk: 'Ховати', pos: 'irregular_verbs' },
    { en: 'draw', ru: 'Рисовать', uk: 'Малювати', pos: 'irregular_verbs' },
    { en: 'spend', ru: 'Тратить', uk: 'Витрачати', pos: 'irregular_verbs' },
    { en: 'grow', ru: 'Выращивать', uk: 'Вирощувати', pos: 'irregular_verbs' },
    { en: 'forget', ru: 'Забывать', uk: 'Забувати', pos: 'irregular_verbs' },
    { en: 'meet', ru: 'Встречать', uk: 'Зустрічати', pos: 'irregular_verbs' },
    { en: 'bring', ru: 'Приносить', uk: 'Приносити', pos: 'irregular_verbs' },
    { en: 'win', ru: 'Выигрывать', uk: 'Вигравати', pos: 'irregular_verbs' },
    ...
    { en: 'write', ru: 'Писать', uk: 'Писати', pos: 'irregular_verbs' },
    { en: 'feed', ru: 'Кормить', uk: 'Годувати', pos: 'irregular_verbs' },
    ...
    { en: 'attic', ru: 'Чердак', uk: 'Горище', pos: 'nouns' },
    { en: 'conference', ru: 'Конференция', uk: 'Конференція', pos: 'nouns' },
    { en: 'blueprint', ru: 'Чертеж', uk: 'Креслення', pos: 'nouns' },
    ...
    { en: 'ancient', ru: 'Древний', uk: 'Древній', pos: 'adjectives' },
