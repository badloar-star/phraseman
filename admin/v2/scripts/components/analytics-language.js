(function adminAnalyticsLanguage() {
  ...
  const labels = {
    screen: {
      ...
      shards_shop: 'Магазин осколков', streak_stats: 'Статистика серии', referrals: 'Приглашения друзей',
    ...
    context: {
      ...
      onboarding: 'Первый запуск', onboarding_plan: 'План при первом запуске',
