...
| Metric | Value |
| Files scanned | 1666 |
| Localized items | 96762 |
| Target localized items | 17553 |
| Target item share | 0.1814 |
...
## Item Coverage Gaps
| File | Surface | Reason |
| app/achievements.ts | app-other | Extracted 908 source localized item(s), but no es extracted items. |
