...
const PALETTES: Record<ThemeMode, LeagueBonusPalette> = {
  ...
  business: {
    card: ['rgba(36,36,36,0.98)', 'rgba(28,28,28,0.96)', 'rgba(20,20,20,0.90)'],
    cardLocations: [0, 0.52, 1],
    ...
    fill: ['#5E5E5E', '#D4D4D4', '#9A9A9A'],
    readyFill: ['#D4D4D4', '#9A9A9A', '#FFFFFF'],
    innerBg: 'rgba(255,255,255,0.06)',
    innerBorder: 'rgba(255,255,255,0.10)',
    modal: {
      overlay: 'rgba(0,0,0,0.66)',
      frame: ['#D4D4D4', '#9A9A9A', '#5E5E5E'],
      card: ['#242424', '#1C1C1C', '#0A0A0A'],
      cardLocations: [0, 0.55, 1],
      wash: ['rgba(255,255,255,0.10)', 'rgba(0,0,0,0)', 'rgba(255,255,255,0.06)'],
      rail: 'rgba(255,255,255,0.12)',
      ribbon: 'rgba(255,255,255,0.10)',
      ribbonAlt: 'rgba(255,255,255,0.06)',
      halo: 'rgba(255,255,255,0.10)',
      haloBorder: 'rgba(255,255,255,0.12)',
      crestBg: 'rgba(255,255,255,0.08)',
      crestBorder: 'rgba(255,255,255,0.12)',
      eyebrow: '#D4D4D4',
      metaBg: 'rgba(255,255,255,0.08)',
      metaBorder: 'rgba(255,255,255,0.12)',
      primary: ['#FFFFFF', '#D4D4D4', '#9A9A9A'],
      primaryText: '#0A0A0A',
      rewardBg: 'rgba(255,255,255,0.08)',
      rewardBorder: 'rgba(255,255,255,0.10)',
      shine: 'rgba(255,255,255,0.22)',
    },
  },
  midnight: {
