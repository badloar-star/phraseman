...
export const AVATAR_DNA_3D_P0_ROUTE_NAME = routeName('_admin', 'avatar', 'dna', '3d', 'p0');
...
export const AVATAR_DNA_3D_P0_ROUTE = `/${AVATAR_DNA_3D_P0_ROUTE_NAME}`;
