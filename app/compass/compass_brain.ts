 ...
 * только структура рекомендаций на сегодня.
 *
...
export type CompassInductionFeature =
  ...
  | 'daily_tasks'; // задания дня — короткий полезный вход
 ...
 *  3. Возврат (comeback): без перегруза — короткий вход через Задания дня.
