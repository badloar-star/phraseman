    ...
    // ───────────────────────── 01 ─────────────────────────
    {
      ...
      blocks: [
        ...
        } as L1Block,
        {
          kind: 'examples',
          examples: [
            { en: 'He went home.', ru: 'Он пошёл домой.', uk: 'Він пішов додому.', hi: 'went' },
            { en: 'I saw it.', ru: 'Я это видел.', uk: 'Я це бачив.', hi: 'saw' },
            { en: 'We had time.', ru: 'У нас было время.', uk: 'У нас був час.', hi: 'had' },
          ],
        } as L1Block,
        {
          kind: 'tip',
    ...
    // ───────────────────────── 02 ─────────────────────────
    {
      ...
      blocks: [
        ...
        } as L1Block,
        {
          kind: 'examples',
          examples: [
            { en: 'He went home.', ru: 'Утверждение: Subject + V2.', uk: 'Ствердження: Subject + V2.', hi: 'went' },
            { en: "He didn't go.", ru: "Отрицание: Subject + didn't + V1.", uk: "Заперечення: Subject + didn't + V1.", hi: "didn't" },
            { en: 'Did he go?', ru: 'Вопрос: Did + subject + V1?', uk: 'Питання: Did + subject + V1?', hi: 'Did' },
          ],
        } as L1Block,
        {
          kind: 'tip',
        ...
        } as L1Block,
        {
          ...
          drill: {
            ...
            answer: "didn't",
            why: { ru: 'Отрицание в прошлом: Subject + didn’t + V1. Глагол go остаётся в начальной форме.' },
          },
        } as unknown as L1Block,
        {
          ...
          drill: {
            type: 'binary',
            question: { ru: 'Где верный вопрос в прошедшем?' },
            optionA: 'Did he went?',
            optionB: 'Did he go?',
            correct: 'B',
            explain: { ru: 'После did глагол всегда в начальной форме: Did he go?' },
          },
        } as unknown as L1Block,
      ],
    },
    ...
    // ───────────────────────── 03 ─────────────────────────
    {
      ...
      blocks: [
        ...
        } as L1Block,
        {
          kind: 'examples',
          examples: [
            { en: 'go → went', ru: 'идти / ехать', uk: 'іти / їхати', hi: 'went' },
            { en: 'come → came', ru: 'приходить', uk: 'приходити', hi: 'came' },
            { en: 'see → saw', ru: 'видеть', uk: 'бачити', hi: 'saw' },
            { en: 'get → got', ru: 'получать', uk: 'отримувати', hi: 'got' },
            { en: 'have → had', ru: 'иметь', uk: 'мати', hi: 'had' },
            { en: 'say → said', ru: 'говорить', uk: 'говорити', hi: 'said' },
            { en: 'take → took', ru: 'брать', uk: 'брати', hi: 'took' },
            { en: 'know → knew', ru: 'знать', uk: 'знати', hi: 'knew' },
            { en: 'think → thought', ru: 'думать', uk: 'думати', hi: 'thought' },
            { en: 'buy → bought', ru: 'покупать', uk: 'купувати', hi: 'bought' },
          ],
        } as L1Block,
        {
          kind: 'tip',
        ...
        } as L1Block,
        {
          ...
          drill: {
            ...
            answer: 'saw',
            why: { ru: 'Прошедшая форма глагола see — saw. Это неправильный глагол, без -ed.' },
          },
        } as unknown as L1Block,
        {
          kind: 'drill',
          drill: {
            type: 'word_bank',
            prompt: { ru: 'Он пошёл домой.' },
            answer: ['He', 'went', 'home'],
            slotLabels: [{ ru: 'кто' }, { ru: 'глагол V2' }, { ru: 'куда' }],
            distractors: ['goed', 'go'],
          },
        } as unknown as L1Block,
      ],
