 ...
 *
 * Механизм не выдуман: это обобщение daily_tasks_screen_persist, благодаря которому
 * экран «Вызовы дня» открывается мгновенно. Там он был написан под один экран
 * (id заданий, прогресс, реролл). Здесь то же самое, но для любых данных экрана.
 *
 * Как работает:
