...
export function episode01Session15ChoiceTargetsV1(
  correct: string,
...
function feedback(locale: Locale, correct: string, wrong: string): string | undefined {
  return FEEDBACK[`${correct}\u0000${wrong}`]?.[locale];
}

export function episode01Session15ChoiceFeedbackV1(
  locale: Locale,
  correct: string,
  wrong: string,
): string | undefined {
...
export function episode01Session15FormFeedbackV1(
  locale: Locale,
  target: string,
  wrong: string,
): string | undefined {
