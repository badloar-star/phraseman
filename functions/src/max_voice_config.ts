...
export const MAX_VOICE_CONFIG_DEFAULTS: MaxVoiceConfig = {
  ...
  // рвали фразу на 6–8-й секунде посреди слова. Владелец 2026-08-23 — «говорит
  // очень долго, не даёт мне сказать»: 500–1000 разрешали монолог на 25–50 с,
  // и одного лишь текста промпта не хватало, чтобы учитель был краток.
  // Середина: 18–22 с — вдвое короче монолога и втрое длиннее порога обрыва,
  // ровно под правило «одна-три коротких фразы за ход». injected (приветствие,
  // подсказка, прощание) — 25 с: прощание в два хода не должно рваться.
  maxResponseOutputTokens: { A1: 360, A2: 400, B1: 440, B2: 440, injected: 500 },
