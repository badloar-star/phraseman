...
| File | Surface | Reason |
| admin/index.html | admin-site | Extracted 737 HTML source localized item(s), but no es HTML items. |
| knowly-www/contact/index.html | public-web | Extracted 43 HTML source localized item(s), but no es HTML items. |
| knowly-www/download/index.html | public-web | Extracted 38 HTML source localized item(s), but no es HTML items. |
| knowly-www/index.html | public-web | Extracted 35 HTML source localized item(s), but no es HTML items. |
| admin/support.html | admin-site | Extracted 11 HTML source localized item(s), but no es HTML items. |
