...
const FEATURE_DEFINITIONS = [
  ...
  },
  {
    ...
    label: 'My practice, trainer queues and weak-spot practice',
    keywords: ['personal_practice', 'practice', 'trainer', 'weak_spot'],
    missingFamily: 'personal_practice_banks_not_row_fanout',
    priority: 10,
  },
  {
    id: 'srs_review',
    label: 'SRS/active recall review',
    keywords: ['srs', 'active_recall', 'review', 'recall'],
    missingFamily: null,
    priority: 11,
  },
  {
