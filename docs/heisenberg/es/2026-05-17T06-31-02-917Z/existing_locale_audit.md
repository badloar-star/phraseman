...
| Metric | Value |
| Files scanned | 1622 |
| Localized items | 90240 |
| Target localized items | 17159 |
| Target item share | 0.1901 |
...
## Item Coverage Gaps
| File | Surface | Reason |
| app/achievements.ts | app-other | Extracted 476 source localized item(s), but no es extracted items. |
