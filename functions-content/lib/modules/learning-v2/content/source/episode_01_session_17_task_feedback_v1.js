...
exports.episode01Session17TaskSelectionV1 = episode01Session17TaskSelectionV1;
exports.episode01Session17ChoiceTargetsV1 = episode01Session17ChoiceTargetsV1;
exports.episode01Session17TaskFeedbackV1 = episode01Session17TaskFeedbackV1;
const L = (value) => value;
...
function episode01Session17TaskSelectionV1(family, target) {
...
function episode01Session17ChoiceTargetsV1(target) {
...
function episode01Session17TaskFeedbackV1(locale, target, wrong) {
    return FEEDBACK[`${target}\0${wrong}`]?.[locale];
}
//# sourceMappingURL=episode_01_session_17_task_feedback_v1.js.map