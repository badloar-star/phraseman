...
exports.learningV2NewWordCardEditorialV1 = learningV2NewWordCardEditorialV1;
const generator_course_contract_1 = require("../generator_course_contract");
const episode_02_session_01_editorial_v2_1 = require("./episode_02_session_01_editorial_v2");
const episode_02_session_02_editorial_v2_1 = require("./episode_02_session_02_editorial_v2");
const episode_02_session_03_editorial_v2_1 = require("./episode_02_session_03_editorial_v2");
const episode_02_session_04_editorial_v2_1 = require("./episode_02_session_04_editorial_v2");
 ...
 */
const ENGLISH_EDITORIAL = Object.freeze([
    {
        targetLanguage: "en",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "As luzinhas acenderam por dentro, mesmo sem festa no calendário.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "A bateria do humor acabou, e nem um biscoito consegue salvar o dia.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "A bateria interna pisca um por cento e exige um sofá imediatamente.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "Nem fogos, nem desastre: está tudo seguindo razoavelmente bem.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "A agenda trancou a porta: até um minuto livre precisa marcar horário.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "Uma batidinha na porta da conversa, antes de alguém passar o café.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "A conversa vestiu o casaco: é hora de ir, sem trilha dramática.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "O crachá de um desconhecido: ainda sem nome, mas já pode entrar.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "O mesmo crachá, com uma ponte n para não tropeçar numa vogal.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "A pessoa que sabe a resposta e mesmo assim pergunta à turma inteira.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "Quem transforma uma folha vazia num ótimo motivo para atrasar o jantar.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "O dedo da conversa aponta para o outro lado: agora fala de você.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "O parceiro de you: sem ele, o estado fica esperando no corredor.",
    ...
    },
    {
        ...
        playfulMeaningByLocale: copy({
            ...
            "pt-BR": "Mesa para um: não precisa ser triste, apenas não veio companhia hoje.",
...
for (const entry of [
    ...episode_02_session_01_editorial_v2_1.EPISODE_02_SESSION_01_WORD_CARD_EDITORIAL_V2,
    ...episode_02_session_02_editorial_v2_1.EPISODE_02_SESSION_02_WORD_CARD_EDITORIAL_V2,
    ...episode_02_session_03_editorial_v2_1.EPISODE_02_SESSION_03_WORD_CARD_EDITORIAL_V2,
    ...episode_02_session_04_editorial_v2_1.EPISODE_02_SESSION_04_WORD_CARD_EDITORIAL_V2,
]) {
...
const session1FineSource = ENGLISH_EDITORIAL.find((entry) => entry.lexicalItemId === "e01-s03-word-fine");
if (!session1FineSource)
    throw new Error("learning_v2_new_word_card_source_missing:fine:session1");
...
const SESSION_03_FULL_B1_EDITORIAL = Object.freeze([
...
const SESSION_04_FULL_B1_EDITORIAL = Object.freeze([
...
const SESSION_05_FULL_B1_EDITORIAL = Object.freeze([
...
const SESSION_06_FULL_B1_EDITORIAL = Object.freeze([
...
const SESSION_07_FULL_B1_EDITORIAL = Object.freeze([
...
function learningV2NewWordCardEditorialV1(input) {
    ...
    if (!entry) {
        throw new Error(`learning_v2_new_word_card_editorial_missing:${input.targetLanguage}:${input.lexicalItemId}`);
    }
    if (entry.targetText !== input.targetText) {
        throw new Error(`learning_v2_new_word_card_editorial_target_mismatch:${input.lexicalItemId}`);
    }
    if (Object.keys(entry.playfulMeaningByLocale).join("\u0000") !==
        generator_course_contract_1.LEARNING_V2_INTERFACE_LOCALES.join("\u0000")) {
        throw new Error(`learning_v2_new_word_card_editorial_locales_invalid:${input.lexicalItemId}`);
    }
    return entry;
}
//# sourceMappingURL=learning_v2_new_word_card_editorial_v1.js.map