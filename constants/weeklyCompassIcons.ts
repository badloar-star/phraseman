...
export const WEEKLY_COMPASS_ICON_DALLE_PROMPTS: Record<ThemeMode, string> = {
  ...
  sagePorcelain: 'Centered sculptural 3D porcelain compass for a premium language-learning app, luminous ivory ceramic, pale sage celadon glaze, deep sage needle, restrained antique brass, transparent background, no text, no logo, no people.',
