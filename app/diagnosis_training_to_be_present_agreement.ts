...
function beStep(input: {
  ...
  return {
    ...
    explanationBlock: tri(
      'Be меняется по subject: I am, he/she/it is, you/we/they are. В английском be нельзя пропускать перед состоянием, ролью или местом.',
      'Be змінюється за subject: I am, he/she/it is, you/we/they are. В англійській be не можна пропускати перед станом, роллю або місцем.',
      'Be cambia según el subject: I am, he/she/it is, you/we/they are. En inglés no omitimos be antes de estado, rol o lugar.',
    ),
    microTask: tri('Выбери правильную форму be.', 'Обери правильну форму be.', 'Elige la forma correcta de be.'),
    ...
    wrongFeedbackByOption: Object.fromEntries(input.options
      ...
      .map((option) => [option, input.wrong[option] ?? tri(
        'Не совсем. Найди subject и выбери форму: I = am, he/she/it/one thing = is, you/we/they/plural = are.',
        'Не зовсім. Знайди subject і обери форму: I = am, he/she/it/one thing = is, you/we/they/plural = are.',
    ...
    fallbackExplanation: tri(
      'Карта be: I am. He/she/it is. You/we/they are. Если после subject идет adjective, place или role, be почти точно нужен.',
      'Карта be: I am. He/she/it is. You/we/they are. Якщо після subject іде adjective, place або role, be майже точно потрібен.',
...
export const TO_BE_PRESENT_AGREEMENT_TRAINING: DiagnosisTraining = {
  ...
  diagnosisText: tri(
    'Ты путаешь am, is и are в настоящем времени. В русском и украинском часто нет отдельного слова "есть" в таких фразах, а английский требует форму be почти всегда: I am, he is, they are.',
    'Ти плутаєш am, is і are у теперішньому часі. Українською часто немає окремого слова "є" в таких фразах, а англійська майже завжди потребує форму be: I am, he is, they are.',
  ...
  mentalModel: tri(
    'Be меняется по subject. I = am. He/she/it/one thing = is. You/we/they/plural = are.',
    'Be змінюється за subject. I = am. He/she/it/one thing = is. You/we/they/plural = are.',
  ...
  whatUserMustLearn: {
    ru: [
      'Be нужен с ролью: He is a doctor.',
      'Be нужен с качеством/состоянием: She is tired, I am ready.',
      'Be нужен с местом: They are at home.',
      'I всегда идет с am.',
      'He/she/it и один предмет идут с is.',
      'You/we/they и множественное число идут с are.',
      'В вопросе be выходит вперед: Is she ready?',
      'В отрицании not идет после be: They are not here.',
    ],
    uk: [
      'Be потрібен з роллю: He is a doctor.',
      'Be потрібен із якістю/станом: She is tired, I am ready.',
      'Be потрібен із місцем: They are at home.',
      'I завжди йде з am.',
      'He/she/it і один предмет ідуть з is.',
      'You/we/they і множина йдуть з are.',
      'У питанні be виходить вперед: Is she ready?',
      'У запереченні not іде після be: They are not here.',
    ],
    es: [
  ...
  examples: [
    ...
    { en: 'The lesson is difficult.', ru: 'Урок сложный.', uk: 'Урок складний.', es: 'La lección es difícil.', why: tri('The lesson = one thing, поэтому is.', 'The lesson = one thing, тому is.', 'The lesson = one thing, por eso is.') },
    { en: 'The books are on the table.', ru: 'Книги на столе.', uk: 'Книги на столі.', es: 'Los libros están sobre la mesa.', why: tri('Books = plural, поэтому are.', 'Books = plural, тому are.', 'Books = plural, por eso are.') },
  ...
  introBlocks: [
    { id: 'intro_problem', type: 'diagnosis', text: tri('Похоже, ты путаешь am, is и are или пропускаешь be там, где английский его требует.', 'Схоже, ти плутаєш am, is і are або пропускаєш be там, де англійська його потребує.', 'Parece que confundes am, is y are u omites be donde el inglés lo necesita.') },
  ...
  steps: [
    ...
    beStep({ id: 'be_present_contrast_004', order: 7, difficulty: 'contrast', targetSkill: 'be_with_place_singular', sentence: 'She ___ at home.', translation: tri('Она дома.', 'Вона вдома.', 'Ella está en casa.'), options, correctAnswer: 'is', correctFeedback: tri('Да. She идет с is. At home - место, be нужен.', 'Так. She йде з is. At home - місце, be потрібен.', 'Sí. She va con is. At home es lugar, necesitamos be.'), wrong: { am: tri('Am только с I. She требует is.', 'Am тільки з I. She потребує is.', 'Am solo con I. She necesita is.'), are: tri('Are с you/we/they. She требует is.', 'Are з you/we/they. She потребує is.', 'Are con you/we/they. She necesita is.'), 'no be': tri('She at home неправильно. Нужно She is at home.', 'She at home неправильно. Потрібно She is at home.', 'She at home es incorrecto. Necesitamos She is at home.') }, retry: [tri('Она дома = She is at home.', 'Вона вдома = She is at home.', 'Ella en casa = She is at home.'), tri('She is.', 'She is.', 'She is.'), tri('Подсказка: She is at home.', 'Підказка: She is at home.', 'Pista: She is at home.')], focusWords: ['she', 'is'] }),
    beStep({ id: 'be_present_contrast_005', order: 8, difficulty: 'contrast', targetSkill: 'be_with_place_plural', sentence: 'They ___ in the office.', translation: tri('Они в офисе.', 'Вони в офісі.', 'Están en la oficina.'), options, correctAnswer: 'are', correctFeedback: tri('Да. They идет с are. In the office - место.', 'Так. They йде з are. In the office - місце.', 'Sí. They va con are. In the office es lugar.'), wrong: { am: tri('Am только с I. They требует are.', 'Am тільки з I. They потребує are.', 'Am solo con I. They necesita are.'), is: tri('Is с he/she/it. They требует are.', 'Is з he/she/it. They потребує are.', 'Is con he/she/it. They necesita are.'), 'no be': tri('They in the office неправильно. Нужно They are in the office.', 'They in the office неправильно. Потрібно They are in the office.', 'They in the office es incorrecto. Necesitamos They are in the office.') }, retry: [tri('They = are.', 'They = are.', 'They = are.'), tri('Место тоже требует be.', 'Місце теж потребує be.', 'Lugar también necesita be.'), tri('Подсказка: They are in the office.', 'Підказка: They are in the office.', 'Pista: They are in the office.')], focusWords: ['they', 'are'] }),
    beStep({ id: 'be_present_contrast_006', order: 9, difficulty: 'contrast', targetSkill: 'be_with_place_object', sentence: 'The keys ___ on the table.', translation: tri('Ключи на столе.', 'Ключі на столі.', 'Las llaves están sobre la mesa.'), options, correctAnswer: 'are', correctFeedback: tri('Да. The keys = plural/they. Поэтому are.', 'Так. The keys = plural/they. Тому are.', 'Sí. The keys = plural/they. Por eso are.'), wrong: { am: tri('Am только с I. Keys - plural, поэтому are.', 'Am тільки з I. Keys - plural, тому are.', 'Am solo con I. Keys es plural, por eso are.'), is: tri('Is нужен для одного предмета. Keys - plural, поэтому are.', 'Is потрібен для одного предмета. Keys - plural, тому are.', 'Is se usa para una cosa. Keys es plural, por eso are.'), 'no be': tri('The keys on the table неправильно как полное предложение. Нужно are.', 'The keys on the table неправильно як повне речення. Потрібно are.', 'The keys on the table es incorrecto como oración completa. Necesitamos are.') }, retry: [tri('Keys = they.', 'Keys = they.', 'Keys = they.'), tri('The keys are.', 'The keys are.', 'The keys are.'), tri('Подсказка: The keys are on the table.', 'Підказка: The keys are on the table.', 'Pista: The keys are on the table.')], focusWords: ['keys', 'are'] }),
    beStep({ id: 'be_present_mixed_001', order: 10, difficulty: 'mixed', targetSkill: 'singular_noun_is', sentence: 'The lesson ___ difficult.', translation: tri('Урок сложный.', 'Урок складний.', 'La lección es difícil.'), options, correctAnswer: 'is', correctFeedback: tri('Да. The lesson = one thing/it. Один предмет идет с is.', 'Так. The lesson = one thing/it. Один предмет іде з is.', 'Sí. The lesson = one thing/it. Una cosa va con is.'), wrong: { am: tri('Am только с I. The lesson - one thing, поэтому is.', 'Am тільки з I. The lesson - one thing, тому is.', 'Am solo con I. The lesson es one thing, por eso is.'), are: tri('Are нужен для plural. The lesson - один урок, поэтому is.', 'Are потрібен для plural. The lesson - один урок, тому is.', 'Are es para plural. The lesson es singular, por eso is.'), 'no be': tri('The lesson difficult неправильно. Нужно is.', 'The lesson difficult неправильно. Потрібно is.', 'The lesson difficult es incorrecto. Necesitamos is.') }, retry: [tri('The lesson = it.', 'The lesson = it.', 'The lesson = it.'), tri('One thing = is.', 'One thing = is.', 'One thing = is.'), tri('Подсказка: The lesson is difficult.', 'Підказка: The lesson is difficult.', 'Pista: The lesson is difficult.')], focusWords: ['lesson', 'is'] }),
    beStep({ id: 'be_present_mixed_002', order: 11, difficulty: 'mixed_review', targetSkill: 'be_question_order', sentence: '___ she ready?', translation: tri('Она готова?', 'Вона готова?', 'Está lista?'), options: ['Am', 'Is', 'Are', 'Does'], correctAnswer: 'Is', correctFeedback: tri('Да. She идет с is. В вопросе is выходит вперед.', 'Так. She йде з is. У питанні is виходить вперед.', 'Sí. She va con is. En pregunta, is va al principio.'), wrong: { Am: tri('Am только с I. С she нужна Is.', 'Am тільки з I. З she потрібна Is.', 'Am solo con I. Con she necesitamos Is.'), Are: tri('Are с you/we/they. С she нужна Is.', 'Are з you/we/they. З she потрібна Is.', 'Are con you/we/they. Con she necesitamos Is.'), Does: tri('Does нужен с обычными глаголами. Ready - adjective, поэтому Is she ready?', 'Does потрібен зі звичайними дієсловами. Ready - adjective, тому Is she ready?', 'Does se usa con verbos normales. Ready es adjective, por eso Is she ready?') }, retry: [tri('She is ready -> Is she ready?', 'She is ready -> Is she ready?', 'She is ready -> Is she ready?'), tri('Вопрос с be: be вперед.', 'Питання з be: be вперед.', 'Pregunta con be: be al principio.'), tri('Подсказка: Is she ready?', 'Підказка: Is she ready?', 'Pista: Is she ready?')], focusWords: ['is', 'she'] }),
    beStep({ id: 'be_present_mixed_003', order: 12, difficulty: 'mixed_review', targetSkill: 'mixed_be_agreement', sentence: 'Choose the correct pair.', translation: tri('Выбери правильную пару.', 'Обери правильну пару.', 'Elige la pareja correcta.'), options: ['I am ready / They are ready', 'I is ready / They are ready', 'I am ready / They is ready', 'I ready / They ready'], correctAnswer: 'I am ready / They are ready', correctFeedback: tri('Да. I идет с am. They идет с are.', 'Так. I йде з am. They йде з are.', 'Sí. I va con am. They va con are.'), wrong: { 'I is ready / They are ready': tri('They are правильно, но I is неправильно. С I всегда am.', 'They are правильно, але I is неправильно. З I завжди am.', 'They are está bien, pero I is es incorrecto. Con I siempre am.'), 'I am ready / They is ready': tri('I am правильно, но They is неправильно. They требует are.', 'I am правильно, але They is неправильно. They потребує are.', 'I am está bien, pero They is es incorrecto. They necesita are.'), 'I ready / They ready': tri('В обеих фразах пропущен be: I am ready / They are ready.', 'В обох фразах пропущено be: I am ready / They are ready.', 'En ambas frases falta be: I am ready / They are ready.') }, retry: [tri('I = am.', 'I = am.', 'I = am.'), tri('They = are.', 'They = are.', 'They = are.'), tri('Подсказка: I am ready / They are ready.', 'Підказка: I am ready / They are ready.', 'Pista: I am ready / They are ready.')], focusWords: ['am', 'are'] }),
  ],
  masteryRules: {
    minCorrect: 10,
    minCorrectStreak: 4,
  ...
  adaptiveFeedbackPolicy: {
    maxDepth: 4,
    depth1: tri('Обычное объяснение: показываем subject и нужную форму be.', 'Звичайне пояснення: показуємо subject і потрібну форму be.', 'Explicación normal: mostramos subject y la forma correcta de be.'),
  ...
  failureRecovery: {
    afterTwoWrongInSameExercise: { action: 'show_simplified_rule_card', card: tri('Остановись. I = am. He/she/it/one thing = is. You/we/they/many things = are.', 'Зупинись. I = am. He/she/it/one thing = is. You/we/they/many things = are.', 'Detente. I = am. He/she/it/one thing = is. You/we/they/many things = are.') },
    afterThreeWrongInSameExercise: { action: 'show_subject_be_hint_then_retry', card: tri('Система покажет группу subject, но не выберет форму be за пользователя.', 'Система покаже групу subject, але не вибере форму be за користувача.', 'El sistema mostrará el grupo del subject, pero no elegirá la forma be.') },
    afterFourWrongInSameExercise: { action: 'switch_to_guided_mode', card: tri('Режим подсказки: сначала выбери группу subject. Потом вернемся к am/is/are.', 'Режим підказки: спочатку обери групу subject. Потім повернемося до am/is/are.', 'Modo guiado: primero elige el grupo del subject. Luego volvemos a am/is/are.') },
  },
  guidedMode: {
    enabled: true,
    triggerAfterWrongAttempts: 4,
    tasks: [
      { id: 'guided_be_present_001', prompt: tri('I идет с какой формой be?', 'I йде з якою формою be?', 'I va con qué forma de be?'), options: ['am', 'is', 'are'], correctIndex: 0, thenReturnToExerciseId: 'be_present_easy_001' },
      ...
      { id: 'guided_be_present_003', prompt: tri('The keys - это один предмет или plural?', 'The keys - це один предмет чи plural?', 'The keys es una cosa singular o plural?'), options: ['one thing', 'plural'], correctIndex: 1, thenReturnToExerciseId: 'be_present_contrast_006' },
      { id: 'guided_be_present_004', prompt: tri('В вопросе с be слово be выходит вперед?', 'У питанні з be слово be виходить вперед?', 'En pregunta con be, be va al principio?'), options: ['да', 'нет'], correctIndex: 0, thenReturnToExerciseId: 'be_present_mixed_002' },
    ],
  },
  smartTrainerConfig: {
    mode: 'weak',
