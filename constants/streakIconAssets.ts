...
const STREAK_FREEZE_ICON_ASSET_PATHS: Record<ThemeMode, string> = {
  ...
  sagePorcelain: 'assets/images/streak_icons/businessLight/streak-freeze-businessLight.webp',
...
const STREAK_FREEZE_ICON_SOURCES: Record<ThemeMode, ImageSourcePropType> = {
  ...
  sagePorcelain: require('../assets/images/streak_icons/businessLight/streak-freeze-businessLight.webp'),
...
const STREAK_FREEZE_ICON_SOURCE_PROMPTS: Record<ThemeMode, string> = {
  ...
  sagePorcelain: 'generated:scripts/generate_business_line_icons.mjs',
