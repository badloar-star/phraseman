  ...
  function renderPaywall() {
    ...
    return h('div', { class: 'qscreen' }, [
      ...
      h('div', { class: 'qfaq-mini' }, [
        ...
        h('details', {}, [h('summary', {}, ['Можно ли отменить?']), h('p', {}, ['Да. Месячный и годовой планы можно не продлевать, а в первые 7 дней вернём оплату полностью — просто напишите в поддержку.'])]),
