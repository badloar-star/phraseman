...
function doStep(input: {
  ...
  return {
    ...
    explanationBlock: tri(
      'В Present Simple does уже забирает -s на себя. После do/does/don’t/doesn’t основной глагол идет в base form.',
      'У Present Simple does уже забирає -s на себе. Після do/does/don’t/doesn’t основне дієслово йде в base form.',
    ...
    wrongFeedbackByOption: Object.fromEntries(input.options
      ...
      .map((option) => [option, input.wrong[option] ?? tri(
        'Не совсем. Проверь subject и основной глагол: he/she/it = does/doesn’t, после auxiliary глагол без -s.',
        'Не зовсім. Перевір subject і основне дієслово: he/she/it = does/doesn’t, після auxiliary дієслово без -s.',
    ...
    fallbackExplanation: tri(
      'Subject сначала: he/she/it -> does/doesn’t. I/you/we/they -> do/don’t. После auxiliary всегда base verb: work, like, know.',
      'Спочатку subject: he/she/it -> does/doesn’t. I/you/we/they -> do/don’t. Після auxiliary завжди base verb: work, like, know.',
...
export const VERB_PRESENT_SIMPLE_NEGATIVE_QUESTION_TRAINING: DiagnosisTraining = {
  ...
  shortTitle: tri('Do / Does + base verb', 'Do / Does + base verb', 'Do / Does + base verb'),
  shortDiagnosis: tri(
  ...
  coreRule: tri(
    "Утверждение: She works. Отрицание: She doesn't work. Вопрос: Does she work? После do/does/don't/doesn't основной глагол всегда в base form.",
    "Ствердження: She works. Заперечення: She doesn't work. Питання: Does she work? Після do/does/don't/doesn't основне дієслово завжди в base form.",
  ...
  whatUserMustLearn: {
    ru: [
      ...
      "В отрицании с he/she/it используется doesn't + base verb: she doesn't work.",
      'В вопросе с he/she/it используется Does + subject + base verb: Does she work?',
      'Нельзя говорить Does she works? Это двойная грамматика.',
      "Нельзя говорить She doesn't works. Doesn't уже несет -s.",
      "С I/you/we/they используется do/don't + base verb: Do they work? They don't work.",
    ...
    uk: [
      ...
      "У запереченні з he/she/it використовується doesn't + base verb: she doesn't work.",
      'У питанні з he/she/it використовується Does + subject + base verb: Does she work?',
      'Не можна говорити Does she works? Це подвійна граматика.',
      "Не можна говорити She doesn't works. Doesn't уже несе -s.",
      "З I/you/we/they використовується do/don't + base verb: Do they work? They don't work.",
  ...
  examples: [
    { en: 'She works every day.', ru: 'Она работает каждый день.', uk: 'Вона працює щодня.', es: 'Ella trabaja todos los días.', why: tri('Это утверждение. Subject she, поэтому основной глагол получает -s: works.', 'Це ствердження. Subject she, тому основне дієслово отримує -s: works.', 'Es afirmación. Subject she, por eso el verbo principal recibe -s: works.') },
    ...
    { en: 'Does she work here?', ru: 'Она здесь работает?', uk: 'Вона тут працює?', es: 'Ella trabaja aquí?', why: tri('В вопросе does стоит перед subject. После does основной глагол в base form: work.', 'У питанні does стоїть перед subject. Після does основне дієслово в base form: work.', 'En pregunta, does va antes del subject. Después de does el verbo principal va en base form: work.') },
    { en: "They don't like coffee.", ru: 'Они не любят кофе.', uk: 'Вони не люблять каву.', es: 'A ellos no les gusta el café.', why: tri("They идет с don't, не с doesn't. После don't основной глагол тоже base form: like.", "They йде з don't, не з doesn't. Після don't основне дієслово теж base form: like.", "They va con don't, no con doesn't. Después de don't el verbo principal también va en base form: like.") },
    ...
    { en: "I don't understand.", ru: 'Я не понимаю.', uk: 'Я не розумію.', es: 'No entiendo.', why: tri("I идет с don't, не с doesn't. После don't глагол в base form.", "I йде з don't, не з doesn't. Після don't дієслово в base form.", "I va con don't, no con doesn't. Después de don't el verbo va en base form.") },
  ],
  introBlocks: [
  ...
  adaptiveFeedbackPolicy: {
    maxDepth: 4,
    depth1: tri('Обычное объяснение: показываем subject, auxiliary и base verb.', 'Звичайне пояснення: показуємо subject, auxiliary і base verb.', 'Explicación normal: mostramos subject, auxiliary y base verb.'),
  ...
  failureRecovery: {
    afterTwoWrongInSameExercise: { action: 'show_simplified_rule_card', card: tri("Остановись. Subject: he/she/it = does/doesn't. I/you/we/they = do/don't. После auxiliary глагол всегда простой: work, like, know.", "Зупинись. Subject: he/she/it = does/doesn't. I/you/we/they = do/don't. Після auxiliary дієслово завжди просте: work, like, know.", "Detente. Subject: he/she/it = does/doesn't. I/you/we/they = do/don't. Después de auxiliary el verbo siempre va simple.") },
    afterThreeWrongInSameExercise: { action: 'show_auxiliary_subject_hint_then_retry', card: tri('Подсказка по структуре: система покажет subject и подскажет, нужен do или does, но не выберет весь ответ.', 'Підказка за структурою: система покаже subject і підкаже, потрібен do чи does, але не вибере всю відповідь.', 'Pista de estructura: el sistema mostrará el subject y dirá si necesitas do o does, pero no elegirá toda la respuesta.') },
    afterFourWrongInSameExercise: { action: 'switch_to_guided_mode', card: tri('Режим подсказки: сначала выбери subject group. Потом система вернет тебя к полной фразе.', 'Режим підказки: спочатку обери subject group. Потім система поверне тебе до повної фрази.', 'Modo guiado: primero elige subject group. Luego el sistema te devuelve a la frase completa.') },
  },
  guidedMode: {
    enabled: true,
