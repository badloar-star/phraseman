...
// ════════════════════════════════════════════════════════════════════════════
import {
  arenaSeasonConfigFromData,
  ARENA_SEASON_DEFAULTS,
  type ArenaSeasonConfig,
} from './arena_season';
 ...
 */
export async function resolveArenaSeasonConfig(
  db: FirebaseFirestore.Firestore,
): Promise<ArenaSeasonConfig> {
  try {
    ...
    return arenaSeasonConfigFromData(data?.numbers);
  } catch (e) {
    console.warn('resolveArenaSeasonConfig failed, using defaults', e);
    return { ...ARENA_SEASON_DEFAULTS };
  }
}
