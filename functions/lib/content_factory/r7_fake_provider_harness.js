...
async function runR7FakeProviderMatrix(input) {
    ...
    const schemaPacket = (0, prompt_registry_1.buildStagePromptPacket)('quiz_topic', 'v2', (0, prompt_context_1.buildPromptContext)({ studyTarget: 'en', sourceLocale: 'ru', cefr: 'A2', objective: 'City', count: 1, approvedArtifactIds: [], exemplarIds: [], previousContentFingerprints: [] }));
