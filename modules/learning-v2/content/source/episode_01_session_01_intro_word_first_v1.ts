...
const CONCEPT_BODY = L({
  ru: 'Слово I не приклеено к одному человеку навсегда. Оно переходит к тому, у кого сейчас воображаемый микрофон. Говорите вы — I означает «я» и указывает на вас. Собеседник забирает реплику — теперь его I указывает уже на него. Поэтому I узнают не по имени и не по месту, а по роли: это человек, который говорит прямо сейчас. На письме английский всегда даёт этому короткому слову заглавную форму I.',
  uk: 'Слово I не належить одній людині назавжди. Воно переходить до того, в кого зараз уявний мікрофон. Говорите ви — I означає «я» і вказує на вас. Співрозмовник бере слово — його I вже вказує на нього. Отже, I визначають не за ім’ям і не за місцем, а за роллю: це людина, яка говорить саме зараз. На письмі англійська завжди подає це коротке слово великою літерою I.',
  es: 'I no pertenece para siempre a una sola persona: viaja con el micrófono imaginario. Si hablas tú, I significa «yo» y te señala a ti. Cuando la otra persona toma la palabra, su I pasa a señalarla a ella. Por eso I no se reconoce por un nombre ni por un lugar, sino por un papel muy preciso: quien habla ahora. En la escritura inglesa esta palabra breve siempre aparece como I mayúscula.',
  'pt-BR': 'I não pertence para sempre a uma única pessoa: acompanha o microfone imaginário. Quando você fala, I significa «eu» e aponta para você. Quando a outra pessoa toma a palavra, o I dela passa a apontar para ela. Portanto, I não é identificado pelo nome nem pelo lugar, mas por um papel exato: quem está falando agora. Na escrita inglesa, essa palavra curta aparece sempre como I maiúsculo.',
  vi: 'I không gắn vĩnh viễn với một người; nó đi theo chiếc micro tưởng tượng. Khi bạn đang nói, I mang nghĩa “tôi” và chỉ chính bạn. Khi người đối diện cất lời, I của họ lại chỉ họ. Vì thế không thể tìm I bằng tên hay vị trí; hãy nhìn đúng vai trò: người đang nói ngay lúc này. Trong chữ viết tiếng Anh, từ rất ngắn ấy luôn xuất hiện bằng chữ hoa I.',
  id: 'I tidak melekat selamanya pada satu orang; kata ini mengikuti mikrofon khayalan. Saat kamu berbicara, I berarti “saya” dan menunjuk dirimu. Ketika lawan bicara mengambil giliran, I miliknya menunjuk dirinya sendiri. Jadi I tidak ditentukan oleh nama atau tempat, melainkan oleh satu peran: orang yang sedang berbicara. Dalam tulisan bahasa Inggris, kata pendek ini selalu tampil sebagai huruf besar I.',
  tr: 'I sonsuza kadar tek bir kişiye ait değildir; hayalî mikrofon kimdeyse onunla birlikte gider. Siz konuşurken I “ben” demektir ve sizi gösterir. Söz karşı tarafa geçince onun söylediği I artık onu gösterir. Bu yüzden I bir isimle ya da yerle değil, rolle bulunur: o anda konuşan kişi. İngilizce yazıda bu kısa sözcük her zaman büyük I biçimindedir.',
  pl: 'I nie należy na stałe do jednej osoby; wędruje razem z wyobrażonym mikrofonem. Gdy mówisz ty, I znaczy „ja” i wskazuje ciebie. Kiedy głos przejmuje rozmówca, jego I wskazuje już jego. Dlatego I rozpoznaje się nie po imieniu ani miejscu, lecz po roli: to osoba mówiąca właśnie teraz. W angielskim zapisie to krótkie słowo zawsze ma wielką formę I.',
});
...
export const EPISODE_01_SESSION_01_WORD_FIRST_INTRO: readonly [
...
] = [
  {
    ...
    body: CONCEPT_BODY,
    bodyRuns: {
      ru: R({ text: 'Слово ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' не приклеено к одному человеку навсегда. Оно переходит к тому, у кого сейчас воображаемый микрофон. Говорите вы — ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' означает «я» и указывает на вас. Собеседник забирает реплику — теперь его ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' указывает уже на него. Поэтому это слово узнают не по имени и не по месту, а по роли: человек говорит прямо сейчас. На письме форма всегда заглавная: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      uk: R({ text: 'Слово ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' не належить одній людині назавжди. Воно переходить до того, в кого зараз уявний мікрофон. Говорите ви — ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' означає «я» і вказує на вас. Співрозмовник бере слово — його ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' вже вказує на нього. Отже, це слово визначають не за ім’ям і не за місцем, а за роллю: людина говорить саме зараз. На письмі форма завжди велика: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      es: R({ text: 'La palabra ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' no pertenece para siempre a una sola persona: viaja con el micrófono imaginario. Si hablas tú, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' significa «yo» y te señala a ti. Cuando otra persona toma la palabra, su ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' pasa a señalarla a ella. Por eso se reconoce por un papel preciso —quien habla ahora— y no por un nombre o un lugar. En inglés siempre se escribe con mayúscula: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      'pt-BR': R({ text: 'A palavra ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' não pertence para sempre a uma pessoa: acompanha o microfone imaginário. Quando você fala, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' significa «eu» e aponta para você. Quando a outra pessoa toma a palavra, o ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' dela passa a apontar para ela. Portanto, reconheça o papel —quem está falando agora—, não um nome ou lugar. Na escrita inglesa a forma é sempre maiúscula: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      vi: R({ text: 'Từ ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' không gắn vĩnh viễn với một người; nó đi theo chiếc micro tưởng tượng. Khi bạn đang nói, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' mang nghĩa “tôi” và chỉ chính bạn. Khi người đối diện cất lời, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' của họ lại chỉ họ. Vì thế hãy nhìn đúng vai trò —người đang nói ngay lúc này— chứ không tìm theo tên hay vị trí. Trong chữ viết tiếng Anh, từ ấy luôn viết hoa: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      id: R({ text: 'Kata ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' tidak melekat selamanya pada satu orang; kata ini mengikuti mikrofon khayalan. Saat kamu berbicara, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' berarti “saya” dan menunjuk dirimu. Ketika lawan bicara mengambil giliran, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' miliknya menunjuk dirinya sendiri. Jadi cari perannya —orang yang sedang berbicara— bukan nama atau tempatnya. Dalam tulisan bahasa Inggris bentuknya selalu huruf besar: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      tr: R({ text: 'Sözcük ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' sonsuza kadar tek bir kişiye ait değildir; hayalî mikrofon kimdeyse onunla birlikte gider. Siz konuşurken ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' “ben” demektir ve sizi gösterir. Söz karşı tarafa geçince onun ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' sözcüğü artık onu gösterir. Bu yüzden isim ya da yer değil, o anda konuşan kişi aranır. İngilizce yazıda biçim her zaman büyüktür: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
      pl: R({ text: 'Słowo ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' nie należy na stałe do jednej osoby; wędruje razem z wyobrażonym mikrofonem. Gdy mówisz ty, ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' znaczy „ja” i wskazuje ciebie. Kiedy głos przejmuje rozmówca, jego ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: ' wskazuje już jego. Rozpoznaje się więc rolę —osobę mówiącą właśnie teraz— a nie imię czy miejsce. W angielskim zapisie forma jest zawsze wielka: ', semantic: 'explanation' }, { text: 'I', semantic: 'targetCorrect' }, { text: '.', semantic: 'explanation' }),
    },
    question: {
      ...
      explanation: L({
        ru: 'I следует за голосом: пока говорите вы, оно означает именно вас. Слушатель и место разговора от этого слова не зависят.',
        uk: 'I іде за голосом: поки говорите ви, воно означає саме вас. Слухач і місце розмови від цього слова не залежать.',
        es: 'I sigue la voz: mientras hablas tú, te nombra precisamente a ti. No señala ni al oyente ni al lugar.',
        'pt-BR': 'I acompanha a voz: enquanto você fala, nomeia exatamente você. Não aponta para quem ouve nem para o lugar.',
        vi: 'I đi theo người cất tiếng: khi bạn đang nói, nó chỉ chính bạn, không phải người nghe hay địa điểm.',
        id: 'I mengikuti suara: saat kamu berbicara, kata itu menunjuk tepat kepadamu, bukan pendengar atau tempatnya.',
        tr: 'I sesi izler: siz konuşurken doğrudan sizi gösterir; dinleyeni ya da konuşma yerini göstermez.',
        pl: 'I podąża za głosem: gdy mówisz ty, wskazuje właśnie ciebie, a nie słuchacza ani miejsce rozmowy.',
      }),
    },
  },
  {
