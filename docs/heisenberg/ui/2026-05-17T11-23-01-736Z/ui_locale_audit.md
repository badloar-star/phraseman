...
Generated: 2026-05-17T11:23:01.735Z
Activation ready: no
...
- triLang missing locale units: 3000
- triLang calls missing all planned locales: 600
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 600
...
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3278 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Розблокувати', ru: 'Разблокировать', es: 'Desbloquear' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3288 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Зняти преміум?', ru: 'Снять премиум?', es: '¿Quitar Premium?' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3289 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Акаунт буде переведено в режим без преміуму. RevenueCat не буде змінено.', ru: 'Аккаунт будет переведён в режим без премиума. RevenueCat не будет затронут.', es: 'La cuenta 
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3294 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скасувати', ru: 'Отмена', es: 'Cancelar' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3295 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Зняти', ru: 'Снять', es: 'Quitar' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3305 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скинути все?', ru: 'Сбросить все?', es: '¿Restablecer todo?' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3306 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Це видалить уроки, досягнення, рамки, енергію, XP та всі налаштування. Це не можна скасувати!', ru: 'Это удалит уроки, достижения, рамки, энергию, XP и все настройки. Это не
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3311 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скасувати', ru: 'Отмена', es: 'Cancelar' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3312 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скинути', ru: 'Сбросить', es: 'Restablecer' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3322 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скинути статистику?', ru: 'Сбросить статистику?', es: '¿Restablecer estadísticas?', }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3327 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Це видалить стрік, щоденну статистику та інші досягнення. Це не можна скасувати!', ru: 'Это удалит цепочку дней, ежедневную статистику и другие достижения. Это нельзя отмени
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3332 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скасувати', ru: 'Отмена', es: 'Cancelar' }
- [warning] trilang-missing-all-planned-locales app/_admin_settings_testers.tsx:3333 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { uk: 'Скинути', ru: 'Сбросить', es: 'Restablecer' }
