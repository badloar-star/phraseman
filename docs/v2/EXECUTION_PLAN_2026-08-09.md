...
### Owner topology correction — active additive migration (2026-08-13)

Более позднее решение владельца заменяет старую продуктовую кардинальность, но
не переписывает уже проверенные immutable-схемы задним числом:
...
1. 32 стабильных урока, каждый с 56 обязательными сессиями по 5–8 минут;
   optional practice и Personal Plan не обязательны для пути и не создают
   mastery.
