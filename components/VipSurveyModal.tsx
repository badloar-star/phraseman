...
function VipSurveyModal({ visible, messageId, onClose, onCompleted }: Props) {
  ...
  const copy = useMemo(() => ({
    ...
    introTitle: triLang(lang, { ru: 'Что такое VIP?', uk: 'Що таке VIP?', es: '¿Qué es VIP?', 'pt-BR': 'O que é VIP?', vi: 'VIP là gì?', id: 'Apa itu VIP?', tr: 'VIP nedir?', pl: 'Czym jest VIP?' }),
    introBody: triLang(lang, {
      ...
      es: 'VIP es como Premium: acceso completo a todas las funciones. Tras la encuesta recibirás un aura verde y un nombre verde.',
      'pt-BR': 'VIP é como o Premium: acesso completo a todos os recursos. Após a pesquisa, você ganha uma aura verde e um nome verde.',
      vi: 'VIP giống như Premium: toàn quyền truy cập mọi tính năng. Sau khi khảo sát, bạn nhận được hào quang xanh và tên màu xanh.',
      id: 'VIP itu seperti Premium: akses penuh ke semua fitur. Setelah survei, kamu mendapat aura hijau dan nama hijau.',
      tr: 'VIP, Premium gibidir: tüm özelliklere tam erişim. Anketten sonra yeşil bir aura ve yeşil bir ad kazanırsın.',
      pl: 'VIP jest jak Premium: pełny dostęp do wszystkich funkcji. Po ankiecie otrzymasz zieloną aurę i zielony nick.',
    }),
    ...
    completedBody: triLang(lang, {
      ...
      id: 'Jawabanmu akan membantu menyempurnakan Phraseman. Ketuk «Selesaikan survei» dan VIP akan aktif.',
      tr: 'Cevapların Phraseman’i daha iyi hale getirir. «Anketi bitir»e dokun, VIP etkinleşsin.',
      pl: 'Twoje odpowiedzi pomogą ulepszyć Phraseman. Naciśnij «Zakończ ankietę», a VIP się aktywuje.',
    }),
