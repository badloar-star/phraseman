  ...
  return {
    ...
    retryFeedback: [
      ...
      tri(
        ...
        `Підказка: промов готовий зворот "${input.correctAnswer} ${input.focusWords[0] ?? ''}".`.trim(),
...
export const PREPOSITION_TIME_PLACE_TRAINING: DiagnosisTraining = {
  ...
  whatUserMustLearn: {
    ...
    uk: [
      'Якщо йдеться про простір усередині чогось, потрібен готовий зворот з in: in the room, in the car, in Dublin.',
      'Якщо річ лежить на поверхні, потрібен готовий зворот з on: on the table, on the wall.',
      ...
      'Деякі фрази краще запамʼятати готовим зворотом: at work, on the bus, in the car.',
  ...
  steps: [
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: in the room.', 'Готовий зворот: in the room.', 'Bloque: in the room.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: on the table.', 'Готовий зворот: on the table.', 'Bloque: on the table.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: at the door.', 'Готовий зворот: at the door.', 'Bloque: at the door.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: on Monday.', 'Готовий зворот: on Monday.', 'Bloque: on Monday.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: at 8.', 'Готовий зворот: at 8.', 'Bloque: at 8.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: in 1990.', 'Готовий зворот: in 1990.', 'Bloque: in 1990.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: in Dublin.', 'Готовий зворот: in Dublin.', 'Bloque: in Dublin.'),
      ],
    ...
    timePlaceStep({
      ...
      wrong: {
        ...
        at: tri('At night - отдельный готовый блок. Но evening обычно: in the evening.', 'At night - окремий готовий зворот. Але evening зазвичай: in the evening.', 'At night es otro bloque. Evening normalmente: in the evening.'),
      ...
      retry: [
        ...
        tri('Готовый блок: in the evening.', 'Готовий зворот: in the evening.', 'Bloque: in the evening.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: on May 5th.', 'Готовий зворот: on May 5th.', 'Bloque: on May 5th.'),
      ],
    ...
    timePlaceStep({
      ...
      teachingText: tri('Некоторые места лучше запомнить готовым куском. “На работе” по-английски часто at work.', 'Деякі місця краще запамʼятати готовим зворотом. “На роботі” англійською часто at work.', 'Algunos lugares se aprenden como bloque. “En el trabajo” suele ser at work.'),
      sentence: 'I am ___ work.',
      translation: tri('Я на работе.', 'Я на роботі.', 'Estoy en el trabajo.'),
      options: ['at', 'in', 'on', 'to'],
      correctAnswer: 'at',
      correctFeedback: tri('Да. Готовый блок: at work.', 'Так. Готовий зворот: at work.', 'Sí. Bloque: at work.'),
      wrong: {
        in: tri('In work не передаёт “я на работе”. Здесь нужен готовый блок at work.', 'In work не передає “я на роботі”. Тут потрібен готовий зворот at work.', 'In work no da este sentido. Usa at work.'),
        on: tri('On work не звучит как “на работе”. Запомни блок at work.', 'On work не звучить як “на роботі”. Запамʼятай зворот at work.', 'On work no suena como “en el trabajo”. Usa at work.'),
      ...
      retry: [
        tri('Это готовый блок.', 'Це готовий зворот.', 'Es un bloque fijo.'),
        tri('На работе = at work.', 'На роботі = at work.', 'En el trabajo = at work.'),
        tri('Говори целиком: I am at work.', 'Кажи цілим зворотом: I am at work.', 'Di el bloque: I am at work.'),
      ],
    ...
    timePlaceStep({
      ...
      teachingText: tri('С общественным транспортом часто работает готовый блок on the bus.', 'З громадським транспортом часто працює готовий зворот on the bus.', 'Con transporte público muchas veces usamos on the bus.'),
      ...
      wrong: {
        in: tri('In the bus можно понять физически, но обычный блок для поездки или нахождения в автобусе - on the bus.', 'In the bus можна зрозуміти фізично, але звичний зворот для поїздки або перебування в автобусі - on the bus.', 'In the bus puede entenderse físicamente, pero el bloque normal es on the bus.'),
      ...
      retry: [
        ...
        tri('Готовый блок: on the bus.', 'Готовий зворот: on the bus.', 'Bloque: on the bus.'),
        tri('Скажи целиком: She is on the bus.', 'Скажи цілим зворотом: She is on the bus.', 'Di el bloque: She is on the bus.'),
      ],
    ...
    timePlaceStep({
      ...
      retry: [
        ...
        tri('Готовый блок: in the car.', 'Готовий зворот: in the car.', 'Bloque: in the car.'),
      ],
    ...
    timePlaceStep({
      ...
      fallbackExplanation: tri('Одна русская “в” может стать разными английскими кусками: in the room, но on Monday.', 'Одна українська “в/у” може стати різними англійськими зворотами: in the room, але on Monday.', 'Una traducción puede convertirse en bloques distintos: in the room, pero on Monday.'),
    ...
    timePlaceStep({
      ...
      teachingText: tri('Финальная сборка: город, день и точный час. У каждого куска своё маленькое слово.', 'Фінальна збірка: місто, день і точна година. У кожного звороту своє маленьке слово.', 'Construcción final: ciudad, día y hora exacta. Cada bloque tiene su palabra pequeña.'),
      ...
      wrong: {
        'I live at Dublin, work in Mondays, and start on 8.': tri('Ты выбрал логично по переводу, но английские куски другие: in Dublin, on Mondays, at 8.', 'Ти обрав логічно за перекладом, але англійські звороти інші: in Dublin, on Mondays, at 8.', 'Elegiste por traducción, pero los bloques son: in Dublin, on Mondays, at 8.'),
        ...
        'I live to Dublin, work to Mondays, and start to 8.': tri('To показывает движение, а здесь место, день и точный час. Нужны куски: in Dublin, on Mondays, at 8.', 'To показує рух, а тут місце, день і точна година. Потрібні звороти: in Dublin, on Mondays, at 8.', 'To muestra movimiento. Aquí necesitas lugar, día y hora: in Dublin, on Mondays, at 8.'),
      },
      retry: [
        tri('Разбей фразу на три куска.', 'Розбий фразу на три звороти.', 'Divide la frase en tres bloques.'),
      ...
      fallbackExplanation: tri('Когда в одной фразе есть место и время, не ищи один общий перевод. Собери по кускам: in Dublin, on Mondays, at 8.', 'Коли в одній фразі є місце і час, не шукай один спільний переклад. Збери зворотами: in Dublin, on Mondays, at 8.', 'Cuando hay lugar y tiempo en una frase, no busques una traducción única. Usa bloques.'),
