...
const copies: Readonly<Record<Lang, SessionCopy>> = {
  ru: {
    ...
    startVoice: "Ответить голосом — нажать или удерживать",
...
function makeCopy(
  ...
  return {
    ...
    startVoice: phrase(
      "Відповісти голосом — натиснути або утримувати",
      "Responder por voz: toca o mantén pulsado",
      "Responder por voz: toque ou segure",
      "Trả lời bằng giọng nói — chạm hoặc giữ",
      "Jawab dengan suara — ketuk atau tahan",
      "Sesle yanıtla — dokun veya basılı tut",
      "Odpowiedz głosem — naciśnij lub przytrzymaj",
    ),
    secondError: phrase(
