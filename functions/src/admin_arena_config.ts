 ...
 *
 * Поэтому админ здесь выбирает ТОЛЬКО переключатели и причину изменения.
 * Минимальная версия остаётся техническим полем со значением `0.0.0`, а
 * версии схемы и хеши содержимого подставляет сборка — руками их вводить
 * нельзя.
 */
