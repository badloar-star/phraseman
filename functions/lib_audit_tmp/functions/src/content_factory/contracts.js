...
function createGenerationJob(input) {
    ...
    const total = (0, generation_plan_1.countLegacyGenerationUnits)(input.lessonIds, input.surfaces);
    return Object.freeze({
        ...
        plannedSurfaces: (0, generation_plan_1.canonicalizeFactorySurfaces)(input.surfaces),
        planFingerprint: (0, generation_plan_1.generationPlanFingerprint)(input.lessonIds, input.surfaces),
