...
describe('Gustav exact approval P45 to P46 handoff remote verify contract', () => {
  const source = fs.readFileSync(
    path.join(ROOT, 'scripts', 'gustav_exact_approval_p45_to_p46_apply_transaction_handoff_simulation_v2_packet.ts'),
    'utf8',
  );

  it('requires P46 publish/upload/remote verification before simulating P46 transaction readiness', () => {
