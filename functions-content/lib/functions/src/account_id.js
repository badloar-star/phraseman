...
exports.ACCOUNT_ID_FIELD = exports.ACCOUNT_ID_INDEX = void 0;
exports.newAccountId = newAccountId;
exports.isAccountId = isAccountId;
exports.accountIdIndexDocId = accountIdIndexDocId;
exports.cleanAliases = cleanAliases;
...
exports.ACCOUNT_ID_INDEX = 'account_id_index';
/** Поле в users, где живёт новое имя. */
exports.ACCOUNT_ID_FIELD = 'accountId';
/**
...
function newAccountId() {
    return `${ACCOUNT_ID_PREFIX}${(0, crypto_1.randomUUID)().replace(/-/g, '')}`.slice(0, ACCOUNT_ID_PREFIX.length + ACCOUNT_ID_RANDOM_LEN);
}
 ...
 */
function accountIdIndexDocId(alias) {
    return `alias_${(0, crypto_1.createHash)('sha256').update(String(alias)).digest('hex')}`;
}
