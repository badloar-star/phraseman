  ...
  introPages: [
    {
      ...
      body: {
        ru: 'Часть английских фраз работает не по правилам, а целым куском: Hi, Please, Sorry, Thank you, See you later, Good night. Их не собирают из грамматики — их просто говорят. Так же, как по-русски «здрасьте» никто не разбирает на части. Запоминайте их целиком, и они сразу зазвучат естественно. Именно эти слова англичане повторяют десятки раз в день, и без них речь кажется резкой. Пару слов внутри всё же поясним. Later значит «позже», поэтому See you later — это «увидимся позже», наше «до встречи». А в Nice to meet you маленькое to стоит перед действием: оно показывает, что дальше идёт «встретить», а не предмет. Запоминать его отдельно не нужно — просто знайте, что оно там не случайно.',
    ...
    },
    {
      ...
      body: {
        ru: 'По-русски мы говорим «я учитель» — два слова. В английском между ними обязательно встаёт короткое a: I am a teacher. Оно означает «один из», то есть вы один из многих учителей. Это слово нельзя пропускать, хотя в русском ему нет никакой пары — именно поэтому его забывают чаще всего. Правило: перед названием профессии или занятия всегда a. И сразу оговорка, чтобы потом не удивляться: если следующее слово начинается с гласного звука, вместо a говорят an — например an artist. А вот перед именами и названиями городов никакого артикля нет: просто Anna, просто Madrid.',
