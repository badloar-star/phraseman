...
const THEME_OPTIONS: ThemeOption[] = [
  ...
  { mode: 'sagePorcelain', labelRU: 'Нефрит', labelUK: 'Нефрит', labelES: 'Jade', labelPtBr: 'Jade', labelVi: 'Ngọc bích', labelId: 'Giok', labelTr: 'Yeşim', labelPl: 'Jadeit', bg: '#FCFDF9', accent: '#315F50', text: '#17201D', preview2: '#F0F1EC', preview3: '#E1E5DC', colors: ['#FCFDF9', '#315F50', '#D1D9D1'] },
