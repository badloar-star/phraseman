...
Арена работает во всех своих точках: поиск создаёт очередь, бот приходит в
обещанный срок, кнопки режимов активны, экраны рангов и топов открываются.
Незавершённые языковые контуры не влияют на английский, пока владелец их не
включит. Причина каждой поломки названа фактом из логов, а не догадкой.
