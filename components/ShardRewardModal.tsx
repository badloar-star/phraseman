...
const TEXTS = {
  ru: {
    ...
    body: 'Твой репорт проверили и баг починили. Это настоящая работа — жемчужина заслужена.',
    bodySuggestion: 'Команда начислила тебе жемчужину. Твоя помощь делает Phraseman лучше — спасибо.',
    bodyAdmin: 'Команда начислила тебе жемчужину — это наш способ сказать спасибо.',
  ...
  uk: {
    ...
    bodySuggestion: 'Команда нарахувала тобі жемчужину. Дякуємо, що допомагаєш Phraseman ставати кращим.',
    bodyAdmin: 'Команда нарахувала тобі жемчужину. Невеликий жест великої вдячності.',
  ...
  es: {
    kicker: 'RECOMPENSA',
    title: 'Tus perlas',
    subtitle: (n: number) => (n > 1 ? `+${n} perlas` : '+1 fragmento de conocimiento'),
    body: 'Confirmaron tu informe y ya corrigieron el fallo. Mereces el botín del detective.',
    bodySuggestion: 'El equipo te abonó perlas. Gracias por ayudar a mejorar Phraseman.',
    bodyAdmin: 'El equipo te abonó perlas. Gracias por quedarte con nosotros.',
  ...
  'pt-BR': {
    kicker: 'RECOMPENSA',
    title: 'Perlas recebidos',
    subtitle: (n: number) => (n > 1 ? `+${n} perlas de conhecimento` : '+1 fragmento de conhecimento'),
    body: 'Seu relatório foi verificado e o bug foi corrigido. Recompensa merecida por uma investigação de verdade.',
    bodySuggestion: 'A equipe creditou perlas para você. Obrigado por ajudar o Phraseman a melhorar.',
    bodyAdmin: 'A equipe creditou perlas para você. É nosso jeito de agradecer pelo seu apoio.',
    label: 'Pela correção:',
