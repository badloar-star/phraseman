// ════════════════════════════════════════════════════════════════════════════
// admin_celebration_lab.tsx — production-safe gate.
//
// Реальный код (DEV-превью «дорогого» празднования победы урока) живёт в
// `_admin_celebration_lab.tsx` (`_`-префикс → файл не считается роутом
...
export default function AdminCelebrationLabGate() {
  if (ENABLE_DEV_TOOLS) {
    ...
    const Real = require('./_admin_celebration_lab').default;
    return <Real />;
  }
