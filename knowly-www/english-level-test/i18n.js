(function (global) {
  ...
  const TESTS = deepFreeze({
    en: { bcp47: 'en-US', bankUrl: './data/questions.en.json?v=20260801-1', nativeLabel: 'English', filenameSlug: 'english', filenameSlugs: { ru: 'angliyskiy-yazyk', en: 'english' }, certificateNames: { ru: 'английского языка', en: 'English' }, resultNames: { ru: 'английского языка', en: 'English' }, names: { ru: { nominative: 'английский язык', genitive: 'английского языка', subject: 'английскому языку' }, en: { nominative: 'English', genitive: 'English', subject: 'English' } } },
    ...
    fr: { bcp47: 'fr-FR', bankUrl: './data/questions.fr.json?v=20260801-1', nativeLabel: 'Français', filenameSlug: 'french', filenameSlugs: { ru: 'frantsuzskiy-yazyk', en: 'french' }, certificateNames: { ru: 'французского языка', en: 'French' }, resultNames: { ru: 'французского языка', en: 'French' }, names: { ru: { nominative: 'французский язык', genitive: 'французского языка', subject: 'французскому языку' }, en: { nominative: 'French', genitive: 'French', subject: 'French' } } },
    ...
    es: { bcp47: 'es-ES', bankUrl: './data/questions.es.json?v=20260801-1', nativeLabel: 'Español', filenameSlug: 'spanish', filenameSlugs: { ru: 'ispanskiy-yazyk', en: 'spanish' }, certificateNames: { ru: 'испанского языка', en: 'Spanish' }, resultNames: { ru: 'испанского языка', en: 'Spanish' }, names: { ru: { nominative: 'испанский язык', genitive: 'испанского языка', subject: 'испанскому языку' }, en: { nominative: 'Spanish', genitive: 'Spanish', subject: 'Spanish' } } },
  });
  ...
  const DICTIONARY = deepFreeze({
    ...
    en: {
      ...
      certificate: { title: 'Result certificate', language: 'Language', theme: 'Style', download: 'Download', print: 'Print', save: 'Save', close: 'Close', cta: 'Get certificate', filename: '{{language}}-{{level}}-result', dialogLabel: 'Result certificate dialog', closeLabel: 'Close certificate', languageGroup: 'Certificate language', themeGroup: 'Certificate theme', create: 'Create certificate', downloadPng: 'Download PNG', printPdf: 'Print / PDF', iosReadyImageAlt: 'Ready certificate image to save', iosLongPressHint: 'Press and hold the certificate, then choose Save to Photos.', pngFailure: 'Could not create PNG. Try printing instead.', printTitle: 'Certificate', ctaText: 'Practise real English every day with Phraseman.', ctaButton: 'Download Phraseman free', bodyTitle: 'Certificate of Completion', certifies: 'This certifies that', completed: 'completed the text-based level check', received: 'and received an estimated CEFR level of', summary: '{{correct}} correct out of {{answered}}', informal: 'This is an informal text-based assessment, not an accredited language qualification.', themes: { gold: 'Gold', dark: 'Midnight', emerald: 'Emerald', rose: 'Rose', royal: 'Royal' } },
