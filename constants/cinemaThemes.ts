...
export const CINEMA: Record<CinemaMode, CinemaPalette> = {
  midnight: {
    ...
    card: '#151829', surface: '#1B1F36', surface2: '#232948', borderLight: '#2A3052',
    textMuted: '#A9AECB', textGhost: '#6E7390', btnShadow: '#39448F',
    cardGradient: ['#202540', '#0E1020'],
    bgGradient3: ['#0D1020', '#06070E', '#010102'],
    quiz: {
  ...
  ember: {
    ...
    card: '#1F150C', surface: '#281B10', surface2: '#332215', borderLight: '#3A2817',
    textMuted: '#C9B4A4', textGhost: '#8A7464', btnShadow: '#9A4E0E',
    cardGradient: ['#2C1F12', '#120C07'],
    bgGradient3: ['#170E07', '#0C0704', '#010101'],
    quiz: {
  ...
  aurora: {
    ...
    card: '#0F1B15', surface: '#15241C', surface2: '#1C2F24', borderLight: '#223829',
    textMuted: '#A7C0B5', textGhost: '#6F837A', btnShadow: '#0E7A57',
    cardGradient: ['#1A2B20', '#0A110C'],
    bgGradient3: ['#0A1710', '#050C08', '#010201'],
    quiz: {
  ...
  volt: {
    ...
    card: '#181C0A', surface: '#20250E', surface2: '#2A3013', borderLight: '#303716',
    textMuted: '#BFC6A3', textGhost: '#7E8563', btnShadow: '#5F7A0A',
    cardGradient: ['#262C10', '#0E1106'],
    bgGradient3: ['#121607', '#080A04', '#010200'],
    quiz: {
