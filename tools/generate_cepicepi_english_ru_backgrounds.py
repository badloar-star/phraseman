#!/usr/bin/env python3
"""Download and render phrase-specific stock backgrounds for English-Russian Cepicepi."""
...
ROWS_PATH = OUT / "english_chains_100.json"
...
def generate() -> dict:
    ...
    # base generator uses "english" field for query context — already correct
