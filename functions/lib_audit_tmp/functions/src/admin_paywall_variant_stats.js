...
exports.computePaywallVariantVerdict = computePaywallVariantVerdict;
 ...
 */
function computePaywallVariantVerdict(rows) {
    const empty = { winner: null, runnerUp: null, pValue: null, liftPct: null };
