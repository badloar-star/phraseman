...
exports.episode01Session18TaskSelectionV1 = episode01Session18TaskSelectionV1;
exports.episode01Session18ChoiceTargetsV1 = episode01Session18ChoiceTargetsV1;
exports.episode01Session18TaskFeedbackV1 = episode01Session18TaskFeedbackV1;
const L = (value) => value;
...
function episode01Session18TaskSelectionV1(family, target) {
...
function episode01Session18ChoiceTargetsV1(target) {
...
function episode01Session18TaskFeedbackV1(locale, target, wrong) {
    return FEEDBACK[`${target}\0${wrong}`]?.[locale];
}
//# sourceMappingURL=episode_01_session_18_task_feedback_v1.js.map