...
import {
  ES_EPISODE_01_SESSION_08_CHECKPOINT_GOAL,
  ES_EPISODE_01_SESSION_08_CHECKPOINT_INTRO,
  ES_EPISODE_01_SESSION_08_CHECKPOINT_SUMMARY,
 ...
 *
 * Карта сессии: es_episode_01_session_map_v1.ts, sessionOrdinal 8,
 * kind: 'checkpoint', teaches: [], builtOn: [1..7], recalls: [1,2,3,4,5].
 *
...
export const ES_EPISODE_01_SESSION_08_SOURCE: SessionSource = Object.freeze({
  ...
  introPages: ES_EPISODE_01_SESSION_08_CHECKPOINT_INTRO,
  phrases: ES_EPISODE_01_SESSION_08_CHECKPOINT_PHRASES,
});
