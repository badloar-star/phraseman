...
const IRREGULAR_VERB_GLOSSARY: Record<string, IrregularVerb> = {
  break: { base: 'break', past: 'broke', pp: 'broken', ru: 'Ломать', uk: 'Ламати', es: 'Romper' },
  bring: { base: 'bring', past: 'brought', pp: 'brought', ru: 'Приносить', uk: 'Приносити', es: 'Traer' },
  build: { base: 'build', past: 'built', pp: 'built', ru: 'Строить', uk: 'Будувати', es: 'Construir' },
  buy: { base: 'buy', past: 'bought', pp: 'bought', ru: 'Покупать', uk: 'Купувати', es: 'Comprar' },
  choose: { base: 'choose', past: 'chose', pp: 'chosen', ru: 'Выбирать', uk: 'Вибирати', es: 'Elegir' },
  come: { base: 'come', past: 'came', pp: 'come', ru: 'Приходить', uk: 'Приходити', es: 'Venir' },
  cost: { base: 'cost', past: 'cost', pp: 'cost', ru: 'Стоить', uk: 'Коштувати', es: 'Costar' },
  drink: { base: 'drink', past: 'drank', pp: 'drunk', ru: 'Пить', uk: 'Пити', es: 'Beber' },
  drive: { base: 'drive', past: 'drove', pp: 'driven', ru: 'Водить', uk: 'Водити', es: 'Conducir' },
  eat: { base: 'eat', past: 'ate', pp: 'eaten', ru: 'Есть', uk: 'Їсти', es: 'Comer' },
  fall: { base: 'fall', past: 'fell', pp: 'fallen', ru: 'Падать', uk: 'Падати', es: 'Caer' },
  feel: { base: 'feel', past: 'felt', pp: 'felt', ru: 'Чувствовать', uk: 'Відчувати', es: 'Sentir' },
  find: { base: 'find', past: 'found', pp: 'found', ru: 'Находить', uk: 'Знаходити', es: 'Encontrar' },
  forget: { base: 'forget', past: 'forgot', pp: 'forgotten', ru: 'Забывать', uk: 'Забувати', es: 'Olvidar' },
  get: { base: 'get', past: 'got', pp: 'gotten', ru: 'Получать', uk: 'Отримувати', es: 'Conseguir' },
  give: { base: 'give', past: 'gave', pp: 'given', ru: 'Давать', uk: 'Давати', es: 'Dar' },
  go: { base: 'go', past: 'went', pp: 'gone', ru: 'Идти; ехать', uk: 'Іти; їхати', es: 'Ir' },
  have: { base: 'have', past: 'had', pp: 'had', ru: 'Иметь', uk: 'Мати', es: 'Tener' },
  hear: { base: 'hear', past: 'heard', pp: 'heard', ru: 'Слышать', uk: 'Чути', es: 'Oír' },
  hit: { base: 'hit', past: 'hit', pp: 'hit', ru: 'Ударять', uk: 'Вдаряти', es: 'Golpear' },
  hurt: { base: 'hurt', past: 'hurt', pp: 'hurt', ru: 'Причинять боль', uk: 'Завдавати болю', es: 'Herir' },
  keep: { base: 'keep', past: 'kept', pp: 'kept', ru: 'Держать; хранить', uk: 'Тримати; зберігати', es: 'Mantener' },
  know: { base: 'know', past: 'knew', pp: 'known', ru: 'Знать', uk: 'Знати', es: 'Saber / conocer' },
  leave: { base: 'leave', past: 'left', pp: 'left', ru: 'Уходить; оставлять', uk: 'Іти; залишати', es: 'Salir / dejar' },
  let: { base: 'let', past: 'let', pp: 'let', ru: 'Позволять', uk: 'Дозволяти', es: 'Dejar' },
  lose: { base: 'lose', past: 'lost', pp: 'lost', ru: 'Терять', uk: 'Втрачати', es: 'Perder' },
  make: { base: 'make', past: 'made', pp: 'made', ru: 'Делать; заставлять', uk: 'Робити; змушувати', es: 'Hacer' },
  meet: { base: 'meet', past: 'met', pp: 'met', ru: 'Встречать', uk: 'Зустрічати', es: 'Conocer' },
  pay: { base: 'pay', past: 'paid', pp: 'paid', ru: 'Платить', uk: 'Платити', es: 'Pagar' },
  put: { base: 'put', past: 'put', pp: 'put', ru: 'Класть; ставить', uk: 'Класти; ставити', es: 'Poner' },
  read: { base: 'read', past: 'read', pp: 'read', ru: 'Читать', uk: 'Читати', es: 'Leer' },
  ring: { base: 'ring', past: 'rang', pp: 'rung', ru: 'Звонить', uk: 'Дзвонити', es: 'Sonar / llamar' },
  run: { base: 'run', past: 'ran', pp: 'run', ru: 'Бегать', uk: 'Бігати', es: 'Correr' },
  say: { base: 'say', past: 'said', pp: 'said', ru: 'Сказать', uk: 'Сказати', es: 'Decir' },
  see: { base: 'see', past: 'saw', pp: 'seen', ru: 'Видеть', uk: 'Бачити', es: 'Ver' },
  sell: { base: 'sell', past: 'sold', pp: 'sold', ru: 'Продавать', uk: 'Продавати', es: 'Vender' },
  send: { base: 'send', past: 'sent', pp: 'sent', ru: 'Отправлять', uk: 'Надсилати', es: 'Enviar' },
  shake: { base: 'shake', past: 'shook', pp: 'shaken', ru: 'Трясти', uk: 'Трусити', es: 'Sacudir' },
  sing: { base: 'sing', past: 'sang', pp: 'sung', ru: 'Петь', uk: 'Співати', es: 'Cantar' },
  sit: { base: 'sit', past: 'sat', pp: 'sat', ru: 'Сидеть', uk: 'Сидіти', es: 'Sentarse / estar sentado' },
  sleep: { base: 'sleep', past: 'slept', pp: 'slept', ru: 'Спать', uk: 'Спати', es: 'Dormir' },
  speak: { base: 'speak', past: 'spoke', pp: 'spoken', ru: 'Говорить', uk: 'Говорити', es: 'Hablar' },
  stand: { base: 'stand', past: 'stood', pp: 'stood', ru: 'Стоять', uk: 'Стояти', es: 'Estar de pie' },
  strike: { base: 'strike', past: 'struck', pp: 'struck', ru: 'Ударять', uk: 'Вдаряти', es: 'Golpear' },
  take: { base: 'take', past: 'took', pp: 'taken', ru: 'Брать', uk: 'Брати', es: 'Tomar' },
  tell: { base: 'tell', past: 'told', pp: 'told', ru: 'Рассказывать; говорить', uk: 'Розповідати; говорити', es: 'Contar' },
  think: { base: 'think', past: 'thought', pp: 'thought', ru: 'Думать', uk: 'Думати', es: 'Pensar' },
  understand: { base: 'understand', past: 'understood', pp: 'understood', ru: 'Понимать', uk: 'Розуміти', es: 'Entender' },
  wake: { base: 'wake', past: 'woke', pp: 'woken', ru: 'Просыпаться; будить', uk: 'Прокидатися; будити', es: 'Despertarse' },
  wear: { base: 'wear', past: 'wore', pp: 'worn', ru: 'Носить', uk: 'Носити', es: 'Llevar (puesto)' },
  write: { base: 'write', past: 'wrote', pp: 'written', ru: 'Писать', uk: 'Писати', es: 'Escribir' },
};
