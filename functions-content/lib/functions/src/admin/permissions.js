...
exports.explicitAdminRoleFromToken = explicitAdminRoleFromToken;
 ...
 */
function explicitAdminRoleFromToken(token) {
    if (!token || typeof token !== 'object')
        return null;
    const claims = token;
    return claims.admin === true && (0, roles_1.hasAdminRole)(claims.adminRole) ? claims.adminRole : null;
}
/**
