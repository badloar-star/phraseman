 ...
 *
 * Таймлайн, палитра и анимации — по утверждённому макету, собранному из
 * dev-прототипа app/_admin_celebration_lab.tsx (тот же стиль будет у финала
 * урока — единый язык праздников в приложении).
 *
