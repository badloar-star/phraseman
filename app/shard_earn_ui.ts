...
const LABELS: Record<string, ShardEarnLabel> = {
  ...
  level_premium_gift: {
    ...
    'pt-BR': "Presente Premium por subir: para quem segue em frente",
    vi: "Quà Premium khi lên cấp: dành cho người luôn tiến bước",
    id: "Hadiah Premium saat naik level: untuk yang terus maju",
    tr: "Seviye Premium hediyesi: ilerlemeyi sürdürenler için",
    pl: "Prezent Premium za poziom: dla tych, którzy idą dalej",
  },
  release_wave_bonus: {
  ...
  remote_shard_reward: {
    ...
    id: "Shard dari tim: bantuanmu berarti",
    tr: "Ekipten parçalar: yardımın değerli",
    pl: "Odłamki od zespołu: twoja pomoc ma znaczenie",
  },
  streak_wager_win: {
  ...
  club_boost_refund: {
    ...
    id: "Pengembalian shard untuk boost klub",
    tr: "Kulüp boostu için parça iadesi",
    pl: "Zwrot odłamków za boost klubu",
  },
  achievement_shard: {
  ...
  generic_raw: {
    ...
    id: "Shard pengetahuan dikreditkan",
    tr: "Bilgi parçaları eklendi",
    pl: "Odłamki wiedzy przyznane",
  },
};
