...
function phrase(
  ...
  const [english, ru, newWords, firstSeenConstructions, correctRu, wrongRu] = row;
...
function buildDays(): GavanCanonicalDay[] {
  return [
    day(
      ...
      [
        ['I am here.', 'Я здесь.', ['here'], ['I am'], 'Верно: короткая фраза без лишних деталей. Here значит здесь, а I am спокойно говорит о тебе.', 'Собираем простую мысль: сначала I am, потом место или состояние. Так фраза остаётся понятной и взрослой.'],
        ['I am ready.', 'Я готов.', ['ready'], ['I am'], 'Да, ready значит готов. Фраза звучит спокойно и подходит почти в любой обычной ситуации.', 'Если говорим о себе, начинаем с I am. Ready ставим после, без украшений и лишней официальности.'],
        ['I need a minute.', 'Мне нужна минута.', ['need', 'minute'], ['I need'], 'Хорошо: I need a minute даёт паузу без неловкости. Minute здесь не про точное время, а про короткую передышку.', 'Держим смысл: I need говорит мне нужно, a minute добавляет спокойную паузу. Это нормальная просьба, не оправдание.'],
        ['Could you repeat that?', 'Можете повторить?', ['repeat', 'that'], ['Could you'], 'Отлично: Could you звучит мягко, repeat значит повторить, that указывает на сказанное только что.', 'Для вежливой просьбы ставим Could you в начало. Так звучит спокойно, даже если ты просишь повторить второй раз.'],
      ],
      [
    ...
    day(
      ...
      [
        ['Could you say that again?', 'Можете сказать это ещё раз?', ['again'], ['Could you'], 'Да, again значит ещё раз. Could you делает просьбу мягкой и нормальной для живого разговора.', 'Смысл простой: просьба начинается с Could you, потом действие. Так ты не звучишь резко.'],
        ['Could you say it slower?', 'Можете сказать медленнее?', ['slower'], ['Could you'], 'Верно: slower значит медленнее. Это обычная просьба, когда темп слишком быстрый.', 'Просим темп, не извиняемся пять раз. Could you помогает сделать фразу вежливой.'],
        ["I didn't catch that.", 'Я не расслышал.', ['catch'], ["didn't"], 'Хорошо: catch здесь значит уловить смысл на слух. Фраза звучит естественно, когда ты не расслышал.', 'Didn’t показывает, что не получилось понять. Это не ошибка общения, а нормальная просьба уточнить.'],
        ['One more time, please.', 'Ещё раз, пожалуйста.', ['more', 'please'], ['One more time'], 'Да, это готовая короткая просьба. Please добавляет вежливость без длинной фразы.', 'Фраза работает целиком: One more time, please. Её удобно помнить как один спокойный блок.'],
      ],
      [
    ...
    day(
      ...
      [
        ['I need some help.', 'Мне нужна помощь.', ['some', 'help'], ['I need'], 'Да, some help звучит мягко: нужна помощь, но без паники. Фраза короткая и очень частая.', 'I need держит основу просьбы. Some help делает её обычной человеческой фразой, не приказом.'],
        ['I need to check this.', 'Мне нужно это проверить.', ['check', 'this'], ['I need to'], 'Верно: I need to check this говорит, что тебе нужно проверить это. This указывает на предмет или информацию рядом.', 'После I need to ставим действие. Check this звучит коротко и понятно.'],
        ['Can you help me with this?', 'Можете помочь мне с этим?', ['with'], ['Can you'], 'Хорошо: with this значит с этим. Can you звучит прямо, но всё ещё нормально и вежливо.', 'Фраза просит помощь с конкретной вещью, не раскрывая личные данные и не растягивая разговор.'],
        ['I need a little more time.', 'Мне нужно немного больше времени.', ['little', 'time'], ['I need'], 'Да, a little more time звучит мягко: нужно немного больше времени, а не бесконечная пауза.', 'Строим от I need. A little more time добавляет понятную, спокойную просьбу.'],
      ],
      [
    ...
    day(
      ...
      [
        ['Is this right?', 'Так правильно?', ['right'], ['Is this'], 'Да, right здесь значит правильно. Is this помогает быстро проверить то, что перед тобой.', 'В вопросе порядок меняется: сначала is, потом this. Так английский слышит вопрос.'],
        ['Is it here?', 'Это здесь?', ['here'], ['Is it'], 'Верно: Is it here коротко проверяет место. It подходит для предмета, места или ситуации.', 'Если спрашиваем про место, here ставится в конце. Фраза получается короткой и ясной.'],
        ['Is that okay?', 'Так нормально?', ['that', 'okay'], ['Is that'], 'Хорошо: Is that okay мягко проверяет, подходит ли вариант. That указывает на уже сказанное или показанное.', 'Это безопасная фраза для быта и сервиса. Она не звучит как спор.'],
        ['Do I need anything else?', 'Мне нужно что-то ещё?', ['anything', 'else'], ['Do I need'], 'Да, anything else значит что-то ещё. Фраза помогает не уйти слишком рано.', 'Do I need превращает I need в вопрос. Смысл: нужно ли мне ещё что-то.'],
      ],
      [
    ...
    day(
      ...
      [
        ['Could you explain it simply?', 'Можете объяснить проще?', ['explain', 'simply'], ['Could you'], 'Верно: explain значит объяснить, simply значит проще. Фраза просит удобный формат, а не обвиняет человека.', 'Could you помогает звучать мягко. Simply ставим в конце, чтобы попросить проще.'],
        ['Could you show me?', 'Можете показать мне?', ['show'], ['Could you'], 'Да, show значит показать. Иногда увидеть проще, чем слушать длинное объяснение.', 'Фраза короткая и вежливая: Could you show me. Никаких лишних уточнений не нужно.'],
        ['Can you write it down?', 'Можете записать это?', ['write', 'down'], ['Can you'], 'Хорошо: write it down значит записать. Down здесь часть устойчивой фразы.', 'Can you звучит чуть прямее, чем Could you, но остаётся нормальной просьбой.'],
        ['Please use simple words.', 'Пожалуйста, используйте простые слова.', ['use', 'simple', 'words'], ['Please use'], 'Да, simple words значит простые слова. Фраза помогает снизить сложность разговора.', 'Please use звучит как просьба, если сказать спокойно. Это нормально, когда нужно понять главное.'],
      ],
      [
    ...
    day(
      ...
      [
        ['That works for me.', 'Мне подходит.', ['works'], ['works for me'], 'Да, works for me значит мне подходит. Это живой короткий ответ, не про работу буквально.', 'Works здесь значит подходит. Фраза помогает быстро согласиться без длинного объяснения.'],
        ['I can do that.', 'Я могу это сделать.', ['can', 'do'], ['I can'], 'Верно: can значит могу, do that значит сделать это. Ответ короткий и уверенный.', 'Если можешь сделать, говорим I can do that. Это естественнее, чем длинная книжная фраза.'],
        ["I can't do that today.", 'Сегодня я не могу это сделать.', ['today'], ["I can't"], 'Хорошо: can’t коротко отрицает can, today уточняет время. Фраза честная и спокойная.', 'Смысл не в отказе навсегда, а в сегодняшнем ограничении. Поэтому today важен.'],
        ["I'll check and come back.", 'Я проверю и вернусь.', ['check', 'come back'], ["I'll"], 'Да, I’ll значит I will. Come back значит вернуться, а check даёт время проверить.', 'Фраза полезна, когда нужно взять паузу и ответить позже. Она звучит нормально и по делу.'],
      ],
      [
    ...
    day(
      ...
      [
        ['Let me check.', 'Дайте мне проверить.', ['let', 'check'], ['Let me'], 'Верно: Let me check даёт паузу и звучит естественно. Это коротко и без паники.', 'Фраза работает целиком: Let me check. Её удобно держать как готовый инструмент.'],
        ['I think I understand.', 'Кажется, я понял.', ['think', 'understand'], ['I think'], 'Да, I think смягчает ответ, а understand значит понимать. Звучит спокойно, без чрезмерной уверенности.', 'Так можно подтвердить понимание и оставить себе место уточнить, если что-то ещё неясно.'],
        ['I have one question.', 'У меня один вопрос.', ['have', 'question'], ['I have'], 'Хорошо: one question звучит коротко и не пугает длинным списком. Фраза вежливо открывает уточнение.', 'I have здесь значит у меня есть. Дальше ставим one question, и смысл сразу понятен.'],
        ["Thanks, that's clear.", 'Спасибо, теперь понятно.', ['clear'], ["that's"], 'Да, clear значит понятно. Thanks добавляет нормальное человеческое завершение разговора.', 'That’s clear коротко подтверждает, что объяснение помогло. Фраза звучит тепло и спокойно.'],
      ],
      [
