import type { TheoryContent } from '../components/lesson_help_theory_ui';
 ...
 * вынесен в отдельный тяжёлый модуль components/lesson_help_theory_data.tsx, который
...
function loadTheory(): Record<number, TheoryContent> {
  ...
  const mod = require('../components/lesson_help_theory_data') as { THEORY: Record<number, TheoryContent> };
