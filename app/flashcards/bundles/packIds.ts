...
export const OFFICIAL_DARK_LOGIC_EN_ID = 'official_dark_logic_en';
export const OFFICIAL_NEGOTIATOR_EN_ID = 'official_negotiator_en';

/**
 * Id колишнього набору EN-шифр — лише для `sourceId` / відображення карт, які могли
 * лишитися в кеші; у магазині цього паку більше немає.
 */
export const OFFICIAL_MODERN_ABBREV_EN_ID = 'official_modern_abbrev_en';
