...
const ARENA_ACTION_ICONS: Record<ArenaActionIconKind, Record<ThemeMode, ImageSourcePropType>> = {
  match: {
    ...
    businessLight: require('../assets/images/arena_actions/arena-action-match-businessLight.webp'),
  ...
  friend: {
    ...
    businessLight: require('../assets/images/arena_actions/arena-action-friend-businessLight.webp'),
  ...
  throne: {
    ...
    businessLight: require('../assets/images/arena_actions/arena-action-throne-businessLight.webp'),
