...
| Metric | Value |
| Files scanned | 1871 |
| Localized items | 117250 |
| Target localized items | 19719 |
| Target item share | 0.1682 |
| Field coverage gap files | 0 |
| Item coverage gap files | 6 |
...
## Item Coverage Gaps
| File | Surface | Reason |
| admin/index.html | admin-site | Extracted 737 source localized item(s), but no es extracted items. |
| knowly-www/contact/index.html | public-web | Extracted 43 source localized item(s), but no es extracted items. |
| knowly-www/download/index.html | public-web | Extracted 38 source localized item(s), but no es extracted items. |
| knowly-www/index.html | public-web | Extracted 35 source localized item(s), but no es extracted items. |
| admin/support.html | admin-site | Extracted 11 source localized item(s), but no es extracted items. |
| duel/index.html | app-other | Extracted 3 source localized item(s), but no es extracted items. |
