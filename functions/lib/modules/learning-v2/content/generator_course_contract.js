...
function validateLearningV2GeneratedCoursePackage(input) {
    ...
    if (!Array.isArray(input.objectives) || input.objectives.length < 1 || input.objectives.length > 2000) {
    ...
    if (!Array.isArray(input.artifacts) || input.artifacts.length < exports.LEARNING_V2_REQUIRED_CONTENT_KINDS.length || input.artifacts.length > 10000) {
