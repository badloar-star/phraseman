...
const L1_TRAPS: readonly PhraseErrorTraps[] = [
  ...
  // 5: "I am young"
  {
    phraseIndex: 5,
    wordTraps: [],
    generalRule: 'Описание («какой?») не требует артикля a. Ты не можешь быть «одним молодым» в штуках. Качества артиклей не боятся.',
  ...
  // 12: "She is an engineer"
  {
    phraseIndex: 12,
    wordTraps: [],
    generalRule: 'Перед гласной «e» артикль a превращается в an. Попробуй сказать «a engineer» — язык запнётся. An нужен для скорости и красоты.',
  ...
  // 15: "I am free"
  {
    phraseIndex: 15,
    wordTraps: [],
    generalRule: 'Качество («какой?») не требует артикля a. Ты свободен от артиклей! Если это описание состояния, просто ставь am.',
