...
// Language-signal rules live in the shared locale registry so adding a new
// locale automatically wires its detection here too.
const LOCALE_LANGUAGE_SIGNALS = require('./heisenberg_locales.cjs').buildLocaleLanguageSignals();
