...
export const ADMIN_SEASON_PASS_LAB_ROUTE_NAME = routeName('admin', 'season', 'pass', 'lab');
...
export const ADMIN_SEASON_PASS_LAB_ROUTE = `/${ADMIN_SEASON_PASS_LAB_ROUTE_NAME}`;
...
export const DEV_UTILITY_ROUTE_NAMES = [
  ...
  ADMIN_SEASON_PASS_LAB_ROUTE_NAME,
