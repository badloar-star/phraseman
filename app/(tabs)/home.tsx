...
const GREETINGS_RU = [
  'Привет,','Снова в деле,','Добро пожаловать,','Рад видеть тебя,',
  'Отлично выглядишь,','Готов учиться,','На старт,','Погнали,',
  'Хорошего дня,','Учимся вместе,','Время знаний,','Профессор ждёт,',
  'Новый день — новые слова,','Вперёд,','Давай начнём,',
  'С возвращением,','Открой мозг,','Сделаем это,','Ты справишься,',
  'Не останавливайся,','Ещё один шаг,','Продолжай расти,',
  'Язык сам себя не выучит,','Умник в деле,','Работаем,',
  'Сегодня лучше чем вчера,','Прекрасный момент учиться,',
  'Твой английский растёт,','Привет, полиглот,','Поехали,',
];
const GREETINGS_UK = [
  'Привіт,','Знову в справі,','Ласкаво просимо,','Радий бачити тебе,',
  'Чудово виглядаєш,','Готовий вчитися,','На старт,','Поїхали,',
  'Гарного дня,','Вчимося разом,','Час знань,','Професор чекає,',
  'Новий день — нові слова,','Вперед,','Давай почнемо,',
  'З поверненням,','Відкрий мозок,','Зробимо це,','Ти впораєшся,',
  'Не зупиняйся,','Ще один крок,','Продовжуй зростати,',
  'Мова сама себе не вивчить,','Розумник у справі,','Працюємо,',
  'Сьогодні краще ніж вчора,','Прекрасний момент вчитися,',
  'Твоя англійська росте,','Привіт, поліглот,','Поїхали,',
];
