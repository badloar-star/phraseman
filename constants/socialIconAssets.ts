...
const SOCIAL_FRIENDS_ICONS: Record<ThemeMode, ImageSourcePropType> = {
  ...
  sagePorcelain: require('../assets/images/social_icons/social-friends-businessLight.webp'),
...
const SOCIAL_CHAT_ICONS: Record<ThemeMode, ImageSourcePropType> = {
  ...
  sagePorcelain: require('../assets/images/social_icons/social-chat-businessLight.webp'),
