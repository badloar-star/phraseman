      ...
      <View style={styles.backdrop}>
        ...
        <Animated.View style={[styles.card, cardStyle]}>
          ...
          <View style={styles.actions}>
            <V2Cta tone="gold" onPress={onClose}>{L({ ru: 'Понятно, погнали', uk: 'Зрозуміло, почнімо', es: 'Entendido, vamos', 'pt-BR': 'Entendi, vamos lá', vi: 'Đã hiểu, bắt đầu thôi', id: 'Mengerti, ayo mulai', tr: 'Anladım, başlayalım', pl: 'Rozumiem, zaczynajmy' })}</V2Cta>
          </View>
        </Animated.View>
      </View>
    </Modal>
