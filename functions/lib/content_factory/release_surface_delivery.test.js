...
describe('course release surface delivery', () => {
    ...
    it('resolves a complete surface bundle in lesson order without losing identity', () => {
        const request = (0, release_surface_delivery_1.parseCourseSurfaceBundleRequest)({ studyTarget: 'de', learnerSourceLocale: 'ru', releaseId: 'de-ru-r1', surface: 'flashcard' });
    ...
    it('rejects a surface outside the current release contract', () => {
        expect(() => (0, release_surface_delivery_1.parseCourseSurfaceBundleRequest)({ studyTarget: 'en', learnerSourceLocale: 'ru', releaseId: 'en-ru-r1', surface: 'retired' })).toThrow('course_surface_request_invalid');
    });
