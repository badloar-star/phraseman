...
export function getHomeMenuImages(themeMode: ThemeMode): HomeMenuImageSet {
  ...
  if (themeMode === 'compass') {
    return {
      ...
      dayTasks: require('../assets/images/home_menu/compass-premium/home-compass-premium-daily-tasks-clean.webp'),
      ...
      practice: require('../assets/images/home_menu/compass-premium/home-compass-premium-practice-clean.webp'),
