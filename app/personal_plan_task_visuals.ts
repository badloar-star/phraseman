...
const THEMED_TASK_ASSETS: Record<
  ThemeMode,
  Record<PersonalPlanTaskVisualSource, ImageSourcePropType>
> = {
  midnight: {
  ...
  sagePorcelain: {
    ...
    sentence_build: require("../assets/images/personal_plan_tasks_fit/sagePorcelain/sentence_build.webp"),
    speaking: require("../assets/images/personal_plan_tasks_fit/sagePorcelain/speaking.webp"),
    flashcards: require("../assets/images/personal_plan_tasks_fit/sagePorcelain/flashcards.webp"),
  },
  ember: {
  ...
  olive: {
    core_lesson: require("../assets/images/personal_plan_tasks_fit/olive/core_lesson.webp"),
    route_phrase: require("../assets/images/personal_plan_tasks_fit/olive/route_gavan.webp"),
    recall: require("../assets/images/personal_plan_tasks_fit/olive/recall.webp"),
    practice: require("../assets/images/personal_plan_tasks_fit/olive/practice.webp"),
    choice: require("../assets/images/personal_plan_tasks_fit/olive/choice.webp"),
    listening: require("../assets/images/personal_plan_tasks_fit/olive/listening.webp"),
    sentence_build: require("../assets/images/personal_plan_tasks_fit/olive/sentence_build.webp"),
    speaking: require("../assets/images/personal_plan_tasks_fit/olive/speaking.webp"),
    flashcards: require("../assets/images/personal_plan_tasks_fit/olive/flashcards.webp"),
  },
};
...
> = {
  ...
  olive: {
    gavan: require("../assets/images/personal_plan_tasks_fit/olive/route_gavan.webp"),
    voyazh: require("../assets/images/personal_plan_tasks_fit/olive/route_voyazh.webp"),
    mitap: require("../assets/images/personal_plan_tasks_fit/olive/route_mitap.webp"),
    impuls: require("../assets/images/personal_plan_tasks_fit/olive/route_impuls.webp"),
    echo: require("../assets/images/personal_plan_tasks_fit/olive/route_echo.webp"),
  },
  gold: {
...
function normalizeTaskVisualTheme(themeMode?: ThemeMode): ThemeMode {
  return themeMode && THEMED_TASK_ASSETS[themeMode]
    ? themeMode
...
export function getPersonalPlanTaskVisualAsset(
  ...
  if (source === "route_phrase") {
    const routeAssets =
      THEMED_ROUTE_ASSETS[visualTheme] ??
      THEMED_ROUTE_ASSETS[DEFAULT_VISUAL_THEME];
    return planId ? routeAssets[planId] : routeAssets.gavan;
  }
  return (
    THEMED_TASK_ASSETS[visualTheme][source] ??
    THEMED_TASK_ASSETS[DEFAULT_VISUAL_THEME][source]
  );
}

function getPersonalPlanTaskVisualAssetKey(
  source: PersonalPlanTaskVisualSource,
  planId?: PersonalPlanId,
): string {
  if (source === "route_phrase")
    return planId ? `${planId}_route_phrase` : "gavan_route_phrase";
  return source;
}
  ...
  switch (task.destination.type) {
    ...
    case "plan_phrase_lesson":
      return {
        ...
        asset: getPersonalPlanTaskVisualAsset(
          "route_phrase",
          planId,
          themeMode,
        ),
    ...
    case "mistake_practice":
      return {
        source: "practice",
        label: "Ошибки",
        intent: "Исправим реальные ошибки адаптивной сессией",
        icon: "medkit-outline",
        assetKey: getPersonalPlanTaskVisualAssetKey("practice", planId),
        asset: getPersonalPlanTaskVisualAsset("practice", planId, themeMode),
        artStyle: "practiceGrid",
