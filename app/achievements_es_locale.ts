...
export const ACHIEVEMENT_ES: Record<string, { nameEs: string; descEs: string }> = {
  ...
  shards_100: {
    ...
    descEs: 'Llega a un saldo de 100 monedas de conocimiento.',
  },
  shards_spent_100: {
    nameEs: 'Monedas en acción',
    descEs: 'Gasta 100 monedas en total dentro de la app.',
  },
  energy_refill_first: {
    nameEs: 'Segundo aire',
    descEs: 'Recarga energía con monedas por primera vez.',
  },
  energy_refill_5: {
    nameEs: 'Carga completa',
    descEs: 'Recarga energía con monedas 5 veces.',
  },
  league_result_first: {
  ...
  arena_wager_win: {
    ...
    descEs: 'Apuesta monedas en un combate de Arena y gana.',
  },
  arena_wager_5: {
  ...
  shards_250: { nameEs: '250 monedas', descEs: 'Lleva tu saldo a 250 monedas de conocimiento.' },
  shards_500: { nameEs: '500 monedas', descEs: 'Lleva tu saldo a 500 monedas de conocimiento.' },
  shards_1000: { nameEs: 'Mil monedas', descEs: 'Lleva tu saldo a 1000 monedas de conocimiento.' },
  shards_spent_500: { nameEs: '500 monedas usados', descEs: 'Gasta 500 monedas en total.' },
  shards_spent_1000: { nameEs: 'Gran circulación', descEs: 'Gasta 1000 monedas en total.' },
  energy_refill_10: { nameEs: '10 recargas', descEs: 'Recarga energía con monedas 10 veces.' },
  energy_refill_25: { nameEs: '25 recargas', descEs: 'Recarga energía con monedas 25 veces.' },
