...
Generated: 2026-05-17T16:46:11.218Z
Activation ready: no
...
- triLang missing locale units: 50
- triLang calls missing all planned locales: 10
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 10
...
- app/(tabs)/friends.tsx: 1 findings, 5 missing locale units
...
## First Findings
- [warning] trilang-missing-all-planned-locales app/(tabs)/friends.tsx:1270 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru, uk, es }
