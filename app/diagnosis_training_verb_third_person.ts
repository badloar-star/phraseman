...
function thirdStep(input: {
  ...
  return {
    ...
    explanationBlock: tri(
      'В Present Simple утверждении только he/she/it добавляют маленький хвост к глаголу: -s, -es или особую форму has.',
      'У Present Simple ствердженні тільки he/she/it додають маленький хвіст до дієслова: -s, -es або особливу форму has.',
      'En afirmación de Present Simple, solo he/she/it añade una marca al verbo: -s, -es o la forma especial has.',
    ),
    microTask: tri(
      'Выбери форму глагола, которая подходит к subject.',
      'Обери форму дієслова, яка підходить до subject.',
    ...
    wrongFeedbackByOption: Object.fromEntries(input.options
      ...
      .map((option) => [option, input.wrong[option] ?? tri(
        'Не совсем. Сначала найди subject: he/she/it требует форму с -s/-es, а I/you/we/they оставляют base verb.',
        'Не зовсім. Спочатку знайди subject: he/she/it потребує форму з -s/-es, а I/you/we/they залишають base verb.',
    ...
    fallbackExplanation: tri(
      'Проверь две вещи: это утверждение или вопрос? Если утверждение и subject = he/she/it, нужен verb+s/es. После does форма снова простая.',
      'Перевір дві речі: це ствердження чи питання? Якщо ствердження і subject = he/she/it, потрібен verb+s/es. Після does форма знову проста.',
...
export const VERB_THIRD_PERSON_TRAINING: DiagnosisTraining = {
  ...
  shortDiagnosis: tri(
    'Ты забываешь -s/-es в Present Simple утверждениях с he/she/it.',
    'Ти забуваєш -s/-es у Present Simple ствердженнях з he/she/it.',
    'Olvidas -s/-es en afirmaciones de Present Simple con he/she/it.',
  ),
  diagnosisText: tri(
    'Ты забываешь -s/-es после he, she, it в Present Simple утверждениях. Это не ошибка смысла, а ошибка формы: в английском he/she/it в обычном утверждении требует маленький грамматический хвост на глаголе.',
    'Ти забуваєш -s/-es після he, she, it у Present Simple ствердженнях. Це не помилка змісту, а помилка форми: в англійській he/she/it у звичайному ствердженні потребує маленький граматичний хвіст на дієслові.',
  ...
  mentalModel: tri(
    'В Present Simple утверждении: I/you/we/they используют простой глагол. He/she/it добавляют -s или -es: I work, she works. They go, he goes.',
    'У Present Simple ствердженні: I/you/we/they використовують просте дієслово. He/she/it додають -s або -es: I work, she works. They go, he goes.',
  ...
  coreRule: tri(
    'I work, you work, we work, they work. Но: he works, she works, it works. После -o, -ch, -sh, -s, -x часто добавляем -es: goes, watches, finishes. Have становится has.',
    'I work, you work, we work, they work. Але: he works, she works, it works. Після -o, -ch, -sh, -s, -x часто додаємо -es: goes, watches, finishes. Have стає has.',
  ...
  whatUserMustLearn: {
    ru: [
      'В Present Simple утверждении he/she/it требует -s или -es на глаголе.',
      'I/you/we/they используют base verb: I work, they live.',
      'He/she/it используют verb+s: he works, she lives, it costs.',
      ...
      'Если глагол заканчивается на consonant + y, y меняется на ies: study -> studies.',
      'Have меняется на has с he/she/it: I have, she has.',
    ],
    uk: [
      'У Present Simple ствердженні he/she/it потребує -s або -es на дієслові.',
      'I/you/we/they використовують base verb: I work, they live.',
      'He/she/it використовують verb+s: he works, she lives, it costs.',
      ...
      'Якщо дієслово закінчується на consonant + y, y змінюється на ies: study -> studies.',
  ...
  introBlocks: [
    ...
    { id: 'intro_rule', type: 'rule', text: tri('Present Simple + утверждение + he/she/it = добавь -s или -es.', 'Present Simple + ствердження + he/she/it = додай -s або -es.', 'Present Simple + afirmación + he/she/it = añade -s o -es.') },
  ...
  adaptiveFeedbackPolicy: {
    maxDepth: 4,
    depth1: tri('Обычное объяснение: показываем subject и форму глагола.', 'Звичайне пояснення: показуємо subject і форму дієслова.', 'Explicación normal: mostramos subject y forma del verbo.'),
    depth2: tri('Проще: делим subject на he/she/it и все остальные.', 'Простіше: ділимо subject на he/she/it і всі інші.', 'Más simple: dividimos subject en he/she/it y todos los demás.'),
    depth3: tri('Еще проще: I work / she works.', 'Ще простіше: I work / she works.', 'Aún más simple: I work / she works.'),
  ...
  failureRecovery: {
    afterTwoWrongInSameExercise: { action: 'show_simplified_rule_card', card: tri('Остановись. Сначала найди subject. He/she/it или один предмет в утверждении = -s/-es. I/you/we/they или plural = base verb.', 'Зупинись. Спочатку знайди subject. He/she/it або один предмет у ствердженні = -s/-es. I/you/we/they або plural = base verb.', 'Detente. Primero encuentra el subject. He/she/it o una cosa singular en afirmación = -s/-es. I/you/we/they o plural = base verb.') },
    afterThreeWrongInSameExercise: { action: 'show_subject_group_hint_then_retry', card: tri('Подсказка по subject: система покажет группу subject, но не выберет форму за пользователя.', 'Підказка за subject: система покаже групу subject, але не вибере форму за користувача.', 'Pista de subject: el sistema mostrará el grupo del subject, pero no elegirá la forma.') },
    afterFourWrongInSameExercise: { action: 'switch_to_guided_mode', card: tri('Режим подсказки: сначала выбери группу subject. Потом вернемся к форме глагола.', 'Режим підказки: спочатку обери групу subject. Потім повернемося до форми дієслова.', 'Modo guiado: primero elige el grupo del subject. Luego volvemos a la forma del verbo.') },
  },
  guidedMode: {
    enabled: true,
