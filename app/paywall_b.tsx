...
export function PaywallBView({ entry }: { readonly entry: PaywallEntry }) {
...
export default function PaywallBRoute() {
  return <DirectPaywallRoute render={(entry) => <PaywallBView entry={entry} />} />;
}
