...
Generated: 2026-05-17T10:40:51.930Z
Activation ready: no
...
- Files scanned: 579
- triLang calls: 1512
- Static triLang calls: 1491
- Dynamic triLang calls: 21
- triLang missing locale units: 5145
- triLang calls missing all planned locales: 1029
- Bundle missing locale units: 10

## Finding Codes
- trilang-missing-all-planned-locales: 1029
...
- [warning] dynamic-trilang-copy app/(tabs)/settings.tsx:543: triLang uses a dynamic copy object; UI locale audit cannot prove planned locales are present. | triLang(lang, FONT_SIZE_LABELS[fontSize])
- [warning] trilang-missing-all-planned-locales app/(tabs)/settings.tsx:718 missing: pt-BR, vi, id, tr, pl: Static triLang copy has ru/uk/es, but planned interface locales are not present yet. | { ru: 'Настройки', uk: 'Налаштування', es: 'Ajustes', }
