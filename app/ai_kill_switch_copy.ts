 ...
 *
 * Help Board намеренно НЕ имеет плашки: ответ ИИ там не гарантия (юзер лишь ставит
 * галочку «разрешить ответ ИИ»), поэтому при выключенном ИИ там просто ничего не
 * происходит.
 *
 ...
 * (Help Board намеренно отсутствует — см. шапку файла.)
 */
...
const PERSONAL_LIMIT_VARIANTS: readonly MultiLangPair[] = [
  {
    ...
    message: {
      ru: 'Ты сегодня разобрал столько, что кассир повесил табличку «ушёл на рыбалку». Завтра снова откроют — а по Plus вход без очереди 🎣',
      uk: 'Ти сьогодні розібрав стільки, що касир повісив табличку «пішов на рибалку». Завтра знову відкриють — а з Plus вхід без черги 🎣',
      es: 'Hoy analizaste tanto que el cajero colgó un cartel de «me fui a pescar». Mañana abren de nuevo — con Plus entras sin cola 🎣',
      'pt-BR': 'Você analisou tanto hoje que o caixa pendurou a placa «fui pescar». Amanhã abre de novo — com Plus você entra sem fila 🎣',
      vi: 'Hôm nay bạn phân tích nhiều đến mức thu ngân treo bảng «đi câu cá rồi». Mai lại mở — với Plus thì vào không cần xếp hàng 🎣',
      id: 'Hari ini kamu analisis banyak banget sampai kasirnya pasang papan «lagi mancing». Besok buka lagi — dengan Plus masuk tanpa antre 🎣',
      tr: 'Bugün o kadar çok inceledin ki kasiyer «balığa gittim» tabelası astı. Yarın yine açılır — Plus ile sıra beklemeden girersin 🎣',
      pl: 'Dziś przeanalizowałeś tyle, że kasjer powiesił tabliczkę «poszedłem na ryby». Jutro znów otworzą — a z Plus wchodzisz bez kolejki 🎣',
    },
  },
  {
    title: {
      ru: 'Последняя булочка уехала',
      uk: 'Остання булочка поїхала',
      es: 'Se llevaron el último bollo',
      'pt-BR': 'O último pãozinho foi embora',
      vi: 'Chiếc bánh cuối cùng đã hết',
      id: 'Roti terakhir sudah diambil',
      tr: 'Son çörek gitti',
      pl: 'Ostatnia bułeczka pojechała',
    },
    message: {
      ru: 'Разборы разобрали как горячие пирожки — тебе достался последний. Свежие завтра утром, а с Plus печём весь день 🥐',
      uk: 'Розбори розібрали як гарячі пиріжки — тобі дістався останній. Свіжі завтра вранці, а з Plus печемо весь день 🥐',
      es: 'Los análisis volaron como pan caliente — te tocó el último. Frescos mañana por la mañana, y con Plus horneamos todo el día 🥐',
      'pt-BR': 'As análises voaram feito pão quente — sobrou a última pra você. Fresquinhas amanhã de manhã, e com Plus a gente assa o dia todo 🥐',
      vi: 'Các bài phân tích hết veo như bánh nóng — bạn vớ được cái cuối cùng. Mai sáng có mẻ mới, còn với Plus thì nướng cả ngày 🥐',
      id: 'Analisisnya ludes kayak roti anget — kamu kebagian yang terakhir. Yang baru besok pagi, dan dengan Plus kami memanggang seharian 🥐',
      tr: 'İncelemeler sıcak simit gibi kapışıldı — sonuncusu sana kaldı. Yarın sabah taze, Plus ile gün boyu fırındayız 🥐',
      pl: 'Analizy rozeszły się jak świeże bułeczki — dostała ci się ostatnia. Świeże jutro rano, a z Plus pieczemy cały dzień 🥐',
    },
  },
  {
    title: {
      ru: 'Библиотека на сегодня всё',
      uk: 'Бібліотека на сьогодні все',
      es: 'La biblioteca cerró por hoy',
      'pt-BR': 'A biblioteca fechou por hoje',
      vi: 'Thư viện đóng cửa hôm nay',
      id: 'Perpustakaan tutup untuk hari ini',
      tr: 'Kütüphane bugünlük kapandı',
      pl: 'Biblioteka na dziś zamknięta',
    },
    message: {
      ru: 'Библиотекарь забрал стремянку и выключил свет — читальный зал до завтра. С Plus у тебя свой ключ от читалки 🔦',
      uk: 'Бібліотекар забрав драбинку й вимкнув світло — читальний зал до завтра. З Plus у тебе свій ключ від читальні 🔦',
      es: 'El bibliotecario se llevó la escalera y apagó la luz — la sala de lectura hasta mañana. Con Plus tienes tu propia llave 🔦',
      'pt-BR': 'O bibliotecário levou a escada e apagou a luz — a sala de leitura até amanhã. Com Plus você tem sua própria chave 🔦',
      vi: 'Thủ thư đã cất thang và tắt đèn — phòng đọc đợi tới mai. Với Plus bạn có chìa khóa riêng của phòng đọc 🔦',
      id: 'Pustakawan mengambil tangganya dan mematikan lampu — ruang baca sampai besok. Dengan Plus kamu punya kunci sendiri 🔦',
      tr: 'Kütüphaneci merdiveni aldı ve ışığı söndürdü — okuma salonu yarına kadar kapalı. Plus ile kendi anahtarın olur 🔦',
      pl: 'Bibliotekarz zabrał drabinkę i zgasił światło — czytelnia do jutra. Z Plus masz własny klucz do czytelni 🔦',
    },
  },
];
