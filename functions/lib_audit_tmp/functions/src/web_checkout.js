...
exports.webOrderStatus = exports.webPrices = exports.paypalOrderCapture = exports.paypalOrderCreate = exports.stripeWebhook = exports.webCheckoutCreate = exports.adminSendPreparedGiftCertificate = exports.adminReplaceSyntheticGiftCertificate = exports.adminUpdateGiftCertificatePersonalization = exports.adminUpdateGiftCertificateRecipient = exports.adminGetGiftCertificateDownload = exports.adminDeleteGiftCertificate = exports.adminListGiftCertificates = exports.adminCreateGiftCertificateBatch = exports.GIFT_CERTIFICATE_READ_OPTIONS = exports.GIFT_CERTIFICATE_MUTATION_OPTIONS = exports.GIFT_CERTIFICATE_REPAIR_OLD_NOTE = exports.GIFT_CERTIFICATE_REPAIR_OLD_CODE = exports.GIFT_CERTIFICATE_PERSONALIZATION_UPDATE_AUTHORIZATION = exports.GIFT_CERTIFICATE_RECIPIENT_UPDATE_AUTHORIZATION = exports.GIFT_CERTIFICATE_BATCH_AUTHORIZATION = exports.GIFT_CERTIFICATE_SEND_AUTHORIZATION = exports.GIFT_CERTIFICATE_REPLACEMENT_AUTHORIZATION = exports.GIFT_CODE_TTL_DAYS = void 0;
exports.productNameForPlan = productNameForPlan;
exports.giftPlanTitle = giftPlanTitle;
exports.giftCodeExpiryMs = giftCodeExpiryMs;
exports.activationRewardForPlan = activationRewardForPlan;
exports.generateActivationCode = generateActivationCode;
exports.generateGiftCertificateCode = generateGiftCertificateCode;
exports.assertGiftCertificateAdminAccess = assertGiftCertificateAdminAccess;
exports.assertGiftCertificateAdminReadAccess = assertGiftCertificateAdminReadAccess;
exports.assertGiftCertificateSendAuthorization = assertGiftCertificateSendAuthorization;
exports.normalizeGiftCertificateBatchOperationId = normalizeGiftCertificateBatchOperationId;
exports.buildGiftCertificateBatchRequestKey = buildGiftCertificateBatchRequestKey;
exports.readGiftCertificateBatchReplay = readGiftCertificateBatchReplay;
exports.createGiftCertificateBatchPlan = createGiftCertificateBatchPlan;
exports.assertGiftCertificateRefsAvailable = assertGiftCertificateRefsAvailable;
exports.buildGiftCertificateDeletePlan = buildGiftCertificateDeletePlan;
exports.assertGiftCertificateAssetResponse = assertGiftCertificateAssetResponse;
exports.readBoundedGiftCertificateAssetBody = readBoundedGiftCertificateAssetBody;
exports.buildGiftCertificateRecipientUpdate = buildGiftCertificateRecipientUpdate;
exports.resolveCanonicalGiftCertificatePhrase = resolveCanonicalGiftCertificatePhrase;
exports.resolveGiftCertificatePresentation = resolveGiftCertificatePresentation;
exports.buildGiftCertificatePersonalizationUpdate = buildGiftCertificatePersonalizationUpdate;
exports.giftCertificateDisplayRecord = giftCertificateDisplayRecord;
exports.buildGiftCertificateDownloadDisplayRecord = buildGiftCertificateDownloadDisplayRecord;
exports.buildSyntheticGiftCertificateReplacement = buildSyntheticGiftCertificateReplacement;
exports.assertGiftCertificateSendCoherence = assertGiftCertificateSendCoherence;
exports.decideGiftCertificateDeliveryClaim = decideGiftCertificateDeliveryClaim;
exports.deliveryStatusForEmailOutcome = deliveryStatusForEmailOutcome;
exports.resendFailureOutcomeForHttpStatus = resendFailureOutcomeForHttpStatus;
exports.buildResendRequestHeaders = buildResendRequestHeaders;
exports.buildActivationEmail = buildActivationEmail;
// ============================================================================
...
const gift_certificate_phrases_1 = require("./gift_certificate_phrases");
...
function productNameForPlan(plan, gift) {
...
function giftPlanTitle(plan) {
    if (plan === 'lifetime')
        return 'Phraseman Pro — навсегда';
...
exports.GIFT_CODE_TTL_DAYS = 365;
exports.GIFT_CERTIFICATE_REPLACEMENT_AUTHORIZATION = 'REPLACE_VERIFIED_SYNTHETIC_NO_PAYMENT_GIFT_CERTIFICATE';
exports.GIFT_CERTIFICATE_SEND_AUTHORIZATION = 'SEND_PREPARED_GIFT_CERTIFICATE';
exports.GIFT_CERTIFICATE_BATCH_AUTHORIZATION = 'CREATE_GIFT_CERTIFICATES';
exports.GIFT_CERTIFICATE_RECIPIENT_UPDATE_AUTHORIZATION = 'UPDATE_GIFT_CERTIFICATE_RECIPIENT';
exports.GIFT_CERTIFICATE_PERSONALIZATION_UPDATE_AUTHORIZATION = 'UPDATE_GIFT_CERTIFICATE_PERSONALIZATION';
exports.GIFT_CERTIFICATE_REPAIR_OLD_CODE = 'GIFT-TEST-FRNRYV23VS';
exports.GIFT_CERTIFICATE_REPAIR_OLD_NOTE = 'Simulated gift purchase; no payment; requested 2026-07-29; recipient badloar@gmail.com';
exports.GIFT_CERTIFICATE_MUTATION_OPTIONS = { region: REGION, enforceAppCheck: true };
exports.GIFT_CERTIFICATE_READ_OPTIONS = { region: REGION, enforceAppCheck: true };
...
const giftCertificateAssetCache = new Map();
...
function giftCodeExpiryMs(nowMs, gift) {
    return gift ? nowMs + exports.GIFT_CODE_TTL_DAYS * 24 * 60 * 60 * 1000 : 0;
}
...
function assertGiftCertificateAdminAccess(auth) {
    if (!String(auth?.uid ?? '').trim() || auth?.token?.admin !== true) {
        throw new https_1.HttpsError('permission-denied', 'Admin only');
    }
    if (!(0, permissions_1.hasClaimedPermission)(auth.token, 'money.manual_access.write')) {
        throw new https_1.HttpsError('permission-denied', 'Role cannot replace gift certificates');
    }
}
function assertGiftCertificateAdminReadAccess(auth) {
    if (!String(auth?.uid ?? '').trim() || auth?.token?.admin !== true) {
        throw new https_1.HttpsError('permission-denied', 'Admin only');
    }
    if (!(0, permissions_1.hasClaimedPermission)(auth.token, 'money.read')) {
        throw new https_1.HttpsError('permission-denied', 'Role cannot read gift certificates');
    }
}
function assertGiftCertificateSendAuthorization(value) {
    if (value !== exports.GIFT_CERTIFICATE_SEND_AUTHORIZATION) {
        throw new https_1.HttpsError('failed-precondition', 'delivery_not_authorized');
    }
}
function normalizeGiftCertificateBatchOperationId(value) {
    if (typeof value !== 'string'
        || !/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.test(value)) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_operation_id');
    }
    return value;
}
function buildGiftCertificateBatchRequestKey(items) {
    if (items.length < 1 || items.length > 200) {
        throw new https_1.HttpsError('internal', 'gift_certificate_batch_request_key_invalid');
    }
    ...
    return (0, crypto_1.createHash)('sha256').update(canonicalRequest, 'utf8').digest('hex');
}
function readGiftCertificateBatchReplay(persisted, expected) {
    if (!persisted)
        return null;
    if (persisted.schemaVersion !== 'gift-certificate-batch-operation.v1'
        ...
        throw new https_1.HttpsError('already-exists', 'gift_certificate_operation_conflict');
    }
    ...
    if (response?.ok !== true
        ...
        throw new https_1.HttpsError('internal', 'gift_certificate_operation_corrupt');
    }
    return response;
}
/** Pure validation/planning boundary shared by the callable and focused tests. */
function createGiftCertificateBatchPlan(params) {
    const { input } = params;
    if (input.authorization !== exports.GIFT_CERTIFICATE_BATCH_AUTHORIZATION) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_batch_not_authorized');
    }
    if (input.source !== 'admin_gift_certificates') {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_source');
    }
    if (!isWebPlan(input.product))
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_product');
    const count = Number(input.count);
    if (!Number.isInteger(count) || count < 1 || count > 200) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_count');
    }
    if (!Array.isArray(input.recipientNames) || input.recipientNames.length !== count) {
        throw new https_1.HttpsError('invalid-argument', 'recipient_names_count_mismatch');
    }
    ...
    if (showRecipientName && recipientNames.some((value) => !value)) {
        throw new https_1.HttpsError('invalid-argument', 'recipient_name_missing');
    }
    const normalizedNames = recipientNames.filter(Boolean).map((value) => value.toLocaleLowerCase('ru-RU'));
    if (new Set(normalizedNames).size !== normalizedNames.length) {
        throw new https_1.HttpsError('invalid-argument', 'duplicate_recipient_name');
    }
    ...
    if (!Array.isArray(rawSenderNames) || rawSenderNames.length !== count) {
        throw new https_1.HttpsError('invalid-argument', 'sender_names_count_mismatch');
    }
    ...
    if (showSenderName && senderNames.some((value) => !value)) {
        throw new https_1.HttpsError('invalid-argument', 'sender_name_missing');
    }
    const rawEmails = input.recipientEmails == null ? [] : input.recipientEmails;
    if (!Array.isArray(rawEmails) || rawEmails.length > count) {
        throw new https_1.HttpsError('invalid-argument', 'recipient_emails_count_mismatch');
    }
    const recipientEmails = Array.from({ length: count }, (_unused, index) => {
        ...
        if (!email)
            throw new https_1.HttpsError('invalid-argument', 'invalid_recipient_email');
        return email;
    });
    if (!Array.isArray(params.codes) || params.codes.length !== count) {
        throw new https_1.HttpsError('internal', 'gift_certificate_codes_count_mismatch');
    }
    ...
    if (codes.some((value) => !/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(value))) {
        throw new https_1.HttpsError('internal', 'invalid_generated_gift_certificate_code');
    }
    if (new Set(codes).size !== codes.length) {
        throw new https_1.HttpsError('already-exists', 'gift_certificate_code_collision');
    }
    const batchId = cleanShortText(params.batchId, 120);
    if (!batchId)
        throw new https_1.HttpsError('internal', 'gift_certificate_batch_id_missing');
    if (!Number.isSafeInteger(params.nowMs) || params.nowMs <= 0) {
        throw new https_1.HttpsError('internal', 'gift_certificate_issue_time_invalid');
    }
    const reward = activationRewardForPlan(input.product);
    const expiresAtMs = giftCodeExpiryMs(params.nowMs, true);
    const items = codes.map((activationCode, index) => {
        const common = {
            ...
            expiresAtMs,
            assetUrl: GIFT_CERTIFICATE_ART[input.product],
...
function assertGiftCertificateRefsAvailable(exists) {
    if (exists.some(Boolean))
        throw new https_1.HttpsError('already-exists', 'gift_certificate_code_collision');
}
/** Fail-closed deletion plan for the certificate and its linked one-time promo. */
function buildGiftCertificateDeletePlan(params) {
    ...
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)
        ...
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_identity_mismatch');
    }
    ...
    if (!Number.isSafeInteger(currentUpdatedAtMs)
        ...
        throw new https_1.HttpsError('aborted', 'gift_certificate_delete_conflict');
    }
    ...
    if (hasRedemptionEvidence) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_already_redeemed');
    }
    if (String(params.promo.certificateId ?? '') !== certificateId
        ...
        || usedCount !== 0) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_promo_invalid');
    }
    return {
        certificateId,
        auditDoc: {
...
function assertGiftCertificateAssetResponse(input) {
    if (!input.ok)
        throw new https_1.HttpsError('unavailable', 'gift_certificate_asset_fetch_failed');
    if (input.contentType.split(';', 1)[0].trim().toLowerCase() !== 'image/webp') {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_asset_type_invalid');
    }
    if (!Number.isSafeInteger(input.byteLength) || input.byteLength < 1 || input.byteLength > GIFT_CERTIFICATE_ASSET_MAX_BYTES) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_asset_size_invalid');
    }
}
async function readBoundedGiftCertificateAssetBody(body) {
    if (!body)
        throw new https_1.HttpsError('unavailable', 'gift_certificate_asset_fetch_failed');
...
async function readGiftCertificateAssetBase64(product, nowMs) {
    for (const [key, cached] of giftCertificateAssetCache.entries()) {
        if (nowMs - cached.fetchedAtMs > GIFT_CERTIFICATE_ASSET_CACHE_TTL_MS)
            giftCertificateAssetCache.delete(key);
    }
    ...
    if (giftCertificateAssetCache.size >= 3) {
        ...
        if (oldest)
            giftCertificateAssetCache.delete(oldest);
    }
    const base64 = bytes.toString('base64');
    giftCertificateAssetCache.set(product, { base64, fetchedAtMs: nowMs });
    return base64;
}
function buildGiftCertificateRecipientUpdate(params) {
    const { input, current, promo } = params;
    if (input.authorization !== exports.GIFT_CERTIFICATE_RECIPIENT_UPDATE_AUTHORIZATION) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_recipient_update_not_authorized');
    }
    ...
    if (current.gift !== true || current.testIssue === true || !isWebPlan(current.product)) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_record_invalid');
    }
    if (current.assetUrl !== GIFT_CERTIFICATE_ART[current.product]) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_asset_mismatch');
    }
    if (current.status === 'sent'
        || current.status === 'sending'
        || current.status === 'delivery_unknown'
        || current.status === 'reconciliation_required') {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_recipient_locked');
    }
    ...
    if (!Number.isSafeInteger(currentUpdatedAtMs)
        ...
        throw new https_1.HttpsError('aborted', 'gift_certificate_edit_conflict');
    }
...
function strictGiftCertificateName(value, field) {
    const name = typeof value === 'string' ? value.trim() : '';
    if (Array.from(name).length > 60) {
        throw new https_1.HttpsError('invalid-argument', `gift_certificate_${field}_name_too_long`);
    }
    return name;
}
function giftCertificatePersonalizationMode(value) {
    if (value === undefined || value === null || value === '')
        return 'named';
    if (value === 'named' || value === 'anonymous')
        return value;
    throw new https_1.HttpsError('failed-precondition', 'gift_certificate_personalization_mode_invalid');
}
function resolveGiftCertificateVisibility(input, saved) {
    const hasExplicitVisibility = typeof input.showRecipientName === 'boolean'
        || typeof input.showSenderName === 'boolean';
...
function resolveCanonicalGiftCertificatePhrase(product, savedPhraseId) {
    const phraseId = cleanShortText(savedPhraseId, 40);
    return gift_certificate_phrases_1.GIFT_CERTIFICATE_PHRASES[product].find(({ id }) => id === phraseId)
        ?? gift_certificate_phrases_1.GIFT_CERTIFICATE_PHRASES[product][0];
}
/**
 ...
 */
function resolveGiftCertificatePresentation(record, promo = {}, nowMs = Date.now(), _options = {}) {
    const product = isWebPlan(record.product) ? record.product : (isWebPlan(record.plan) ? record.plan : null);
    if (!product)
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_plan_invalid');
    const savedRecipientName = strictGiftCertificateName(record.displayRecipientName ?? record.recipientName ?? record.giftTo, 'recipient');
    const savedSenderName = strictGiftCertificateName(record.displaySenderName ?? record.giftFrom ?? 'Phraseman', 'sender') || 'Phraseman';
...
function buildGiftCertificatePersonalizationUpdate(params) {
    const { input, current, promo } = params;
    if (input.authorization !== exports.GIFT_CERTIFICATE_PERSONALIZATION_UPDATE_AUTHORIZATION) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_personalization_update_not_authorized');
    }
    const certificateId = cleanShortText(input.certificateId, 32).toUpperCase();
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)
        || certificateId !== String(current.certificateId ?? '')
    ...
    if ((current.plan !== undefined && current.plan !== current.product)
        ...
        throw new https_1.HttpsError('failed-precondition', current.plan !== undefined && current.plan !== current.product
    ...
    if (['sent', 'sending', 'delivery_unknown', 'reconciliation_required'].includes(String(current.status ?? ''))) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_personalization_locked');
    }
    const currentUpdatedAtMs = Number(current.updatedAtMs ?? current.createdAtMs ?? 0);
    ...
    if (!(Number.isSafeInteger(expiresAtMs) && expiresAtMs > params.nowMs)) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_expired');
    }
    ...
    const personalizationMode = showRecipientName || showSenderName
        ? 'named'
        : 'anonymous';
    ...
    if (showRecipientName && !displayRecipientName) {
        throw new https_1.HttpsError('invalid-argument', 'gift_certificate_recipient_name_missing');
    }
    if (showSenderName && !displaySenderName) {
        throw new https_1.HttpsError('invalid-argument', 'gift_certificate_sender_name_missing');
    }
    displayRecipientName || (displayRecipientName = String(currentPresentation.savedRecipientName ?? ''));
    displaySenderName || (displaySenderName = String(currentPresentation.savedSenderName ?? '') || 'Phraseman');
...
function giftCertificateDisplayRecord(certificateId, record, promo = {}, nowMs = Date.now()) {
 ...
 */
function buildGiftCertificateDownloadDisplayRecord(certificateId, record, promo = {}, nowMs = Date.now()) {
    const product = isWebPlan(record.product) ? record.product : null;
    ...
    const optionalMatches = (source, key, expected) => source[key] === undefined || source[key] === null || String(source[key]) === String(expected);
    const promoIsCoherent = promo.enabled === true
        && Number(promo.maxRedemptions) === 1
    ...
    if ((presentation.showRecipientName && !presentation.displayRecipientName)
        ...
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_recipient_name_missing');
    }
    return {
...
function buildSyntheticGiftCertificateReplacement(params) {
    const { input, oldDoc } = params;
    if (input.authorization !== exports.GIFT_CERTIFICATE_REPLACEMENT_AUTHORIZATION) {
        throw new https_1.HttpsError('failed-precondition', 'replacement_not_authorized');
    }
    ...
    if (!/^[A-Z0-9_-]{3,32}$/.test(oldCode) || !/^[A-Z0-9_-]{3,32}$/.test(newCode) || oldCode === newCode) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_replacement_code');
    }
    if (oldCode !== exports.GIFT_CERTIFICATE_REPAIR_OLD_CODE) {
        throw new https_1.HttpsError('failed-precondition', 'old_certificate_target_mismatch');
    }
    const storedNote = typeof oldDoc.note === 'string' ? oldDoc.note : '';
    if (storedNote !== exports.GIFT_CERTIFICATE_REPAIR_OLD_NOTE) {
        throw new https_1.HttpsError('failed-precondition', 'old_certificate_note_mismatch');
    }
    ...
    if (!oldUnused)
        throw new https_1.HttpsError('failed-precondition', 'old_certificate_not_replaceable');
    ...
    if (!giftTo)
        throw new https_1.HttpsError('invalid-argument', 'delivery_recipient_name_missing');
    if (!giftFrom)
        throw new https_1.HttpsError('invalid-argument', 'delivery_sender_name_missing');
    const giftPhraseId = cleanShortText(input.giftPhraseId, 40);
    if (!/^yearly-\d{2}$/.test(giftPhraseId))
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_phrase');
    const reason = cleanShortText(input.reason, 500);
    if (reason.length < 10)
        throw new https_1.HttpsError('invalid-argument', 'replacement_reason_required');
    const expiresAtMs = giftCodeExpiryMs(params.nowMs, true);
    const commonActor = {
        updatedAtMs: params.nowMs,
...
function assertGiftCertificateSendCoherence(delivery, code, context) {
    ...
    if (!coherent || !plan || !presentation) {
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_not_sendable');
    }
    return { plan, presentation };
}
function decideGiftCertificateDeliveryClaim(delivery, context) {
    if (delivery.gift !== true || delivery.testIssue === true) {
        throw new https_1.HttpsError('failed-precondition', 'test_delivery_forbidden');
    }
    if (!isWebPlan(delivery.plan))
        throw new https_1.HttpsError('failed-precondition', 'delivery_plan_invalid');
    ...
    if (presentation.personalizationMode === 'named' && !presentation.displayRecipientName) {
        throw new https_1.HttpsError('failed-precondition', 'delivery_recipient_name_missing');
    }
    if (presentation.personalizationMode === 'named' && !presentation.displaySenderName) {
        throw new https_1.HttpsError('failed-precondition', 'delivery_sender_name_missing');
    }
    const activationCode = typeof delivery.activationCode === 'string' ? delivery.activationCode : '';
    if (!activationCode)
        throw new https_1.HttpsError('failed-precondition', 'delivery_code_missing');
    if (activationCode !== context.deliveryId)
        throw new https_1.HttpsError('failed-precondition', 'delivery_code_mismatch');
    if (!(Number(delivery.codeExpiresAtMs) > 0))
        throw new https_1.HttpsError('failed-precondition', 'delivery_expiry_missing');
    const email = cleanEmail(delivery.recipientEmail);
    if (!email)
        throw new https_1.HttpsError('failed-precondition', 'delivery_email_invalid');
    const expectedRecipientEmail = cleanEmail(context.expectedRecipientEmail);
    if (!expectedRecipientEmail)
        throw new https_1.HttpsError('invalid-argument', 'expected_recipient_email_required');
    if (expectedRecipientEmail !== email)
        throw new https_1.HttpsError('failed-precondition', 'expected_recipient_email_mismatch');
    ...
    if (delivery.status !== 'sending' && delivery.status !== 'delivery_unknown') {
        throw new https_1.HttpsError('failed-precondition', 'delivery_not_prepared');
    }
    ...
    if (delivery.status === 'sending') {
        ...
        if (Number.isFinite(sendClaimedAtMs) && context.nowMs - sendClaimedAtMs < GIFT_CERTIFICATE_SEND_CLAIM_STALE_MS) {
            throw new https_1.HttpsError('aborted', 'delivery_in_progress');
        }
    }
    return { action: 'send', email };
}
...
async function markActivationEmailStatus(orderId, patch) {
    ...
    if (!id)
        return;
    await markActivationEmailStatusAt((0, firestore_1.getFirestore)().collection(ORDERS_COLLECTION).doc(id), patch);
}
async function markActivationEmailStatusAt(ref, patch, propagateFailure = false) {
    try {
        await ref.set({
            ...patch,
...
function deliveryStatusForEmailOutcome(customerEmailStatus) {
    if (customerEmailStatus === 'sent')
        return 'sent';
    if (customerEmailStatus === 'skipped_no_resend_key'
        || customerEmailStatus === 'skipped_no_resend_from'
        || customerEmailStatus === 'provider_rejected')
        return 'failed';
    return 'delivery_unknown';
}
function resendFailureOutcomeForHttpStatus(status) {
    return status >= 400 && status < 500 && status !== 408 && status !== 409
        ? 'provider_rejected'
        : 'transport_unknown';
}
function buildResendRequestHeaders(apiKey, idempotencyKey) {
    return {
...
async function markActivationEmailOutcome(orderId, statusRef, patch) {
    if (statusRef) {
 ...
 */
function buildActivationEmail(order, support) {
    ...
    const giftPresentation = isGift ? resolveGiftCertificatePresentation({ ...order, product: plan }, { enabled: true, usedCount: 0, expiresAtMs: order.codeExpiresAtMs }) : null;
...
async function sendActivationEmail(order, statusRef, idempotencyKey) {
...
exports.adminCreateGiftCertificateBatch = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    ...
    return db.runTransaction(async (tx) => {
        ...
        const response = {
            ...
            certificates: plan.items.map((item) => giftCertificateDisplayRecord(item.certificateId, item.certificateDoc, item.promoDoc, nowMs)),
        };
...
exports.adminListGiftCertificates = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_READ_OPTIONS, async (request) => {
    assertGiftCertificateAdminReadAccess(request.auth);
    const db = (0, firestore_1.getFirestore)();
    const pageSize = 100;
    ...
    const certificates = validCertificates.map((certificate, index) => giftCertificateDisplayRecord(certificate.id, certificate.data() ?? {}, promoSnapshots[index]?.data() ?? {}, statusEvaluatedAtMs));
...
exports.adminDeleteGiftCertificate = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    const certificateId = cleanShortText(request.data?.certificateId, 32).toUpperCase();
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_id');
    }
    const db = (0, firestore_1.getFirestore)();
    ...
    await db.runTransaction(async (tx) => {
        ...
        if (!certificateSnapshot.exists) {
            throw new https_1.HttpsError('not-found', 'gift_certificate_not_found');
        }
        if (!promoSnapshot.exists) {
            throw new https_1.HttpsError('failed-precondition', 'gift_certificate_promo_missing');
        }
...
exports.adminGetGiftCertificateDownload = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_READ_OPTIONS, async (request) => {
    assertGiftCertificateAdminReadAccess(request.auth);
    const certificateId = cleanShortText(request.data?.certificateId, 32).toUpperCase();
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_id');
    ...
    if (!Number.isSafeInteger(updatedAtMs) || Number(request.data?.expectedUpdatedAtMs) !== updatedAtMs) {
        throw new https_1.HttpsError('aborted', 'gift_certificate_download_conflict');
    }
    const nowMs = Date.now();
...
exports.adminUpdateGiftCertificateRecipient = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    const certificateId = cleanShortText(request.data?.certificateId, 32).toUpperCase();
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_id');
...
exports.adminUpdateGiftCertificatePersonalization = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    const certificateId = cleanShortText(request.data?.certificateId, 32).toUpperCase();
    if (!/^GIFT-[A-HJ-NP-Z2-9]{10}$/.test(certificateId)) {
        throw new https_1.HttpsError('invalid-argument', 'invalid_gift_certificate_id');
...
exports.adminReplaceSyntheticGiftCertificate = (0, https_1.onCall)(exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    const oldCode = exports.GIFT_CERTIFICATE_REPAIR_OLD_CODE;
    // Resolve once outside the transaction so a fallback stays stable across Firestore retries.
    const giftPhraseId = (0, gift_certificate_phrases_1.resolveGiftPhrase)('yearly', request.data?.giftPhraseId).id;
    const input = {
    ...
    const result = await db.runTransaction(async (tx) => {
        ...
        if (!oldSnap.exists)
            throw new https_1.HttpsError('not-found', 'old_certificate_not_found');
        if (newSnap.exists || deliverySnap.exists)
            throw new https_1.HttpsError('already-exists', 'replacement_code_collision');
...
exports.adminSendPreparedGiftCertificate = (0, https_1.onCall)({ ...exports.GIFT_CERTIFICATE_MUTATION_OPTIONS, secrets: [resend_secret_1.RESEND_API_KEY] }, async (request) => {
    assertGiftCertificateAdminAccess(request.auth);
    ...
    if (!/^[A-Z0-9_-]{3,32}$/.test(deliveryId))
        throw new https_1.HttpsError('invalid-argument', 'invalid_delivery_id');
    ...
    const claim = await db.runTransaction(async (tx) => {
        ...
        if (!deliverySnap.exists)
            throw new https_1.HttpsError('not-found', 'prepared_delivery_not_found');
        ...
        tx.update(deliveryRef, {
            ...
            sendAttemptCount: firestore_1.FieldValue.increment(1),
    ...
    if (claim.decision.action === 'already_sent')
        return { ok: true, deliveryId, alreadySent: true };
    if (claim.decision.action === 'reconciliation_required') {
        throw new https_1.HttpsError('failed-precondition', 'delivery_reconciliation_required');
    }
    ...
    if (!sent)
        throw new https_1.HttpsError('failed-precondition', 'gift_certificate_email_not_sent');
...
exports.webCheckoutCreate = (0, https_1.onRequest)({
    ...
    try {
        const orderId = await createOrderDoc(db, {
            ...
            giftPhraseId: gift ? (0, gift_certificate_phrases_1.resolveGiftPhrase)(plan, body.giftPhraseId).id : undefined,
        });
...
exports.paypalOrderCreate = (0, https_1.onRequest)({
    ...
    try {
        const orderId = await createOrderDoc(db, {
            ...
            giftTo: cleanShortText(body.giftTo, 60),
            giftFrom: cleanShortText(body.giftFrom, 60),
            giftPhraseId: body.gift === true ? (0, gift_certificate_phrases_1.resolveGiftPhrase)(plan, body.giftPhraseId).id : undefined,
        });
